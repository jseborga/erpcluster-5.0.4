...
/**
 * \file    finint/bankcateg.class.php
 * \ingroup finint
...
class Bankcateg extends CommonObject
{
	 ...
	 */
	public $element = 'bankcateg';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'bank_categ';

	/**
	 * @var BankcategLine[] Lines
	 */
	public $lines = array();
	 ...
	 */
	public function fetch($id, $label = null)
	{
		dol_syslog(__METHOD__, LOG_DEBUG);
