...
if(isset($_GET['ref']) && $_GET['ref'] != null || isset($_GET['idprod']) && $_GET['idprod'] >0|| isset($_GET['idprodfournprice']) && $_GET['idprodfourprice'] >0)
{
	$search = trim($_GET['ref']);
	$idprod = $_GET['idprod']?$_GET['idprod']:$_GET['idprodfournprice'];
