...
/**
 *   	\file       assets/assetscondition_card.php
 *		\ingroup    assets
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-05-25 13:14
 */
...
dol_include_once('/assets/class/assetscondition.class.php');
...
$hookmanager->initHooks(array('assetscondition'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('assetscondition'));
