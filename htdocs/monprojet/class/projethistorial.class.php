...
/**
 * \file    /projethistorial.class.php
 * \ingroup 
...
/**
 * Class Projethistorial
 *
 * Put here description of your class
 */
class Projethistorial extends CommonObject
{
	/**
	 * @var string Error code (or message)
	 * @deprecated
	 * @see Projethistorial::errors
	 */
	public $error;
	/**
	 ...
	 */
	public $element = 'projethistorial';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'projet_historial';

	/**
	 * @var ProjethistorialLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->email_send)) {
			 $this->email_send = trim($this->email_send);
		}
		...
		$sql .= ' '.(! isset($this->email_send)?'NULL':"'".$this->db->escape($this->email_send)."'").',';
		$sql .= ' '.(! isset($this->emails)?'NULL':"'".$this->db->escape($this->emails)."'").',';
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ProjethistorialLine();

				$line->id = $obj->rowid;
				
				$line->fk_projet = $obj->fk_projet;
				$line->fk_task = $obj->fk_task;
				$line->email_send = $obj->email_send;
				$line->emails = $obj->emails;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' email_send = '.(isset($this->email_send)?"'".$this->db->escape($this->email_send)."'":"null").',';
		$sql .= ' emails = '.(isset($this->emails)?"'".$this->db->escape($this->emails)."'":"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Projethistorial($this->db);
