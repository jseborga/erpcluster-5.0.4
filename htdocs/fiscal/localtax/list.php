...
require_once DOL_DOCUMENT_ROOT.'/fiscal/class/localtaxext.class.php';
...
llxHeader('', $langs->trans("TaxPayments"));

$form = new Form($db);
$formother=new FormOther($db);
$tva_static = new Localtaxext($db);
...
$sql.= " ba.rowid as bid, ba.ref as bref, ba.number as bnumber, ba.account_number, ba.label as blabel";
...
if ($result)
{
	...
	print_barre_liste($langs->trans("TaxPayments"),$page,$_SERVER["PHP_SELF"],$param,$sortfield,$sortorder,'',$num,$totalnboflines, 'title_accountancy', 0, '', '', $limit);
	...
	while ($i < min($num,$limit))
	{
		...
		print "<td>".$tva_static->getNomUrladd(1)."</td>\n";
