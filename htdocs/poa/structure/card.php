...
/**
 *   	\file       poa/poastructure_card.php
 *		\ingroup    poa
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-03-27 16:26
 */
...
if (empty($reshook))
{
	...
	if ($action == 'add')
	{
		...
		$object->fk_poa_objetive=GETPOST('fk_poa_objetive','int');
		$object->fk_father=GETPOST('fk_father','int');
		$object->fk_area=GETPOST('fk_area','int');
		$object->fk_area_ej=GETPOST('fk_area_ej','int');
...
if ($action == 'create')
{
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_objetive").'</td><td><input class="flat" type="text" name="fk_poa_objetive" value="'.GETPOST('fk_poa_objetive').'"></td></tr>';
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_area_ej").'</td><td><input class="flat" type="text" name="fk_area_ej" value="'.GETPOST('fk_area_ej').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_objetive").'</td><td><input class="flat" type="text" name="fk_poa_objetive" value="'.$object->fk_poa_objetive.'"></td></tr>';
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_area_ej").'</td><td><input class="flat" type="text" name="fk_area_ej" value="'.$object->fk_area_ej.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	print load_fiche_titre($langs->trans("Structure"));
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_objetive").'</td><td>'.$object->fk_poa_objetive.'</td></tr>';
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_area_ej").'</td><td>'.$object->fk_area_ej.'</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('poastructure'));
