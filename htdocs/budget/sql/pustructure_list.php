...
/**
 *   	\file       budget/pustructure_list.php
 *		\ingroup    budget
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-01-12 14:49
 */
...
$hookmanager->initHooks(array('pustructurelist'));
...
't.group_structure'=>array('label'=>$langs->trans("Fieldgroup_structure"), 'checked'=>1),
...
't.ordby'=>array('label'=>$langs->trans("Fieldordby"), 'checked'=>1),
...
if ($search_ordby) $sql.= natural_search("ordby",$search_ordby);
...
if ($search_group_structure != '') $params.= '&amp;search_group_structure='.urlencode($search_group_structure);
...
if (! empty($arrayfields['t.group_structure']['checked'])) print_liste_field_titre($arrayfields['t.group_structure']['label'],$_SERVER['PHP_SELF'],'t.group_structure','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.group_structure']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_group_structure" value="'.$search_group_structure.'" size="10"></td>';
