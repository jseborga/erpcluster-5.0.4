...
/**
 *      \file       poa/poapartidapre_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poapartidapre_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poapartidapre.class.php");
$myobject=new Poapartidapre($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poapartidapre";
