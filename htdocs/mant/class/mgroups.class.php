 ...
 * @see CommonObject
 */
class Mgroups extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'mgroups';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_groups';

	/**
	 * @var MgroupsLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_asset_group)) {
			 $this->fk_asset_group = trim($this->fk_asset_group);
		}
		if (isset($this->label)) {
		...
		$sql .= ' '.(! isset($this->fk_asset_group)?'NULL':$this->fk_asset_group).',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mgroups", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->ref = $obj->ref;
				$this->fk_asset_group = $obj->fk_asset_group;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new MgroupsLine();

				$line->id = $obj->rowid;
				
				$line->entity = $obj->entity;
				$line->ref = $obj->ref;
				$line->fk_asset_group = $obj->fk_asset_group;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' fk_asset_group = '.(isset($this->fk_asset_group)?$this->fk_asset_group:"null").',';
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Groups") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = DOL_URL_ROOT.'/mant/groups/'.'card.php?id='.$this->id;
