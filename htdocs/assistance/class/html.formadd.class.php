...
class Formadd extends Form
{
   ...
   */
  function select_member($selected='', $htmlname='fk_member', $filter='', $showempty=0, $showtype=0, $forcecombo=0, $events=array(), $limit=0,$autofocus='')
  {
    return $this->select_member_list($selected, $htmlname, $filter, $showempty, $showtype, $forcecombo, $events, '', 0, $limit,$autofocus);
  }
   ...
   * 	@return	string					HTML string with
   */
  function select_member_list($selected='',$htmlname='fk_member',$filter='',$showempty=0, $showtype=0, $forcecombo=0, $events=array(), $filterkey='', $outputmode=0, $limit=0,$autofocus='')
  {
    ...
    $outarray=array();
    //sql
    $sql = "SELECT d.rowid, d.ref_ext, d.civility as civility_id, d.firstname, d.lastname, d.societe as company, d.fk_soc, d.statut, d.public, d.address, d.zip, ";
	...
	$out.= '<select id="'.$htmlname.'" class="flat" name="'.$htmlname.'" '.(!empty($autofocus)?' autofocus="autofocus"':'').'>'."\n";
