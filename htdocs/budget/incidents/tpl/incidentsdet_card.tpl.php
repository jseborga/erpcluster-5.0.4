...
/**
 *   	\file       budget/incidentsdet_card.php
 *		\ingroup    budget
...
dol_include_once('/budget/class/incidentsdet.class.php');
...
$hookmanager->initHooks(array('incidentsdet'));
...
if (empty($reshook))
{
	...
	$object->fk_incident=GETPOST('fk_incident','int');
	$object->type=GETPOST('type','alpha');
	$object->fk_object=GETPOST('fk_object','int');
	$object->object=GETPOST('object','int');
	$object->ref=GETPOST('ref','alpha');
	$object->label=GETPOST('label','alpha');
	$object->sequen=GETPOST('sequen','int');
	$object->value_one=GETPOST('value_one','alpha');
	$object->value_two=GETPOST('value_two','alpha');
	$object->value_three=GETPOST('value_three','alpha');
	$object->value_four=GETPOST('value_four','alpha');
...
if ($action == 'create')
{
	...
	//
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_incident").'</td><td><input class="flat" type="text" name="fk_incident" value="'.GETPOST('fk_incident').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_one").'</td><td><input class="flat" type="text" name="value_one" value="'.GETPOST('value_one').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_two").'</td><td><input class="flat" type="text" name="value_two" value="'.GETPOST('value_two').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_three").'</td><td><input class="flat" type="text" name="value_three" value="'.GETPOST('value_three').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_four").'</td><td><input class="flat" type="text" name="value_four" value="'.GETPOST('value_four').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	//
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_incident").'</td><td><input class="flat" type="text" name="fk_incident" value="'.$object->fk_incident.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_one").'</td><td><input class="flat" type="text" name="value_one" value="'.$object->value_one.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_two").'</td><td><input class="flat" type="text" name="value_two" value="'.$object->value_two.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_three").'</td><td><input class="flat" type="text" name="value_three" value="'.$object->value_three.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_four").'</td><td><input class="flat" type="text" name="value_four" value="'.$object->value_four.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldquantity").'</td><td><input class="flat" type="text" name="quantity" value="'.$object->quantity.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	//
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_incident").'</td><td>'.$object->fk_incident.'</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_one").'</td><td>'.$object->value_one.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_two").'</td><td>'.$object->value_two.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_three").'</td><td>'.$object->value_three.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_four").'</td><td>'.$object->value_four.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldquantity").'</td><td>'.$object->quantity.'</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>'.$object->status.'</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('incidentsdet'));
