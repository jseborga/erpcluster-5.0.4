...
/**
 *  \file       dev/skeletons/mwcts.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2015-01-09 17:55
 */
 ...
 */
class Mwcts extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='mwcts';			//!< Id that identify managed objects
	var $table_element='mwcts';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->working_class)) $this->working_class=trim($this->working_class);
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."m_wcts(";
		...
		$sql.= " ".(! isset($this->working_class)?'NULL':"'".$this->db->escape($this->working_class)."'").",";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."m_wcts");
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."m_wcts SET";
        
		$sql.= " entity=".(isset($this->entity)?$this->entity:"null").",";
		$sql.= " working_class=".(isset($this->working_class)?"'".$this->db->escape($this->working_class)."'":"null").",";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."m_wcts";
    		$sql.= " WHERE rowid=".$this->id;
