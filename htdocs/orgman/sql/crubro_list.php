...
$search_active='';
    ...
    $permtoread = $user->rights->crubro->read;
    $permtodelete = $user->rights->crubro->delete;
    $uploaddir = $conf->crubro->dir_output;
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/crubro/card.php?id='.$id);
    exit;
}
