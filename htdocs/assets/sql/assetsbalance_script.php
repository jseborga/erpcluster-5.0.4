...
/**
 *      \file       assets/assetsbalance_script.php
 *		\ingroup    assets
...
// Examples for manipulating class assetsbalance_class
require_once(DOL_DOCUMENT_ROOT."/../assets/assetsbalance.class.php");
$myobject=new Assetsbalance($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assetsbalance";
