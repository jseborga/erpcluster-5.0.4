...
$hookmanager->initHooks(array('ctypemant'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."c_typemant as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."c_typemant_extrafields as ef on (u.rowid = ef.fk_object)";
//$sql.= " WHERE 1 = 1";
$sql.= " WHERE t.entity IN (".getEntity('ctypemant',1).")";
