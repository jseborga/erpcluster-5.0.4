 ...
 *				Initialy built by build_class_from_table on 2015-09-21 11:44
 */
	...
	function _create($user, $fk_product, $entrepot_id, $ref, $qty, $type, $price=0, $label='', $inventorycode='', $datem='',$eatby='',$sellby='',$batch='',$skip_batch=false)
	{
		...
		$this->type = $type;
	  	...
	  	if ($movestock && $entrepot_id > 0)	// Change stock for current product, change for subproduct is done after
	  	{
		  	...
		  	$sql.= " fk_entrepot, value, type_mouvement, fk_user_author, label, inventorycode, price, fk_origin, origintype, statut ";
		  	$sql.= ")";
