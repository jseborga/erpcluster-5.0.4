...
<tr>
<td class="nowrap center valignmiddle">
<?php if (! empty($conf->global->MAIN_OPTIMIZEFORTEXTBROWSER)) { ?><label for="closesess" class="hidden"><?php echo $langs->trans("Closesess"); ?></label><?php } ?>
<span class="span-icon-user">
<input type="text" id="closeuser" placeholder="<?php echo $langs->trans("Closeuser"); ?>" name="closeuser" class="flat input-icon-user" size="20" value="<?php echo dol_escape_htmltag($closeuser); ?>" tabindex="1" />
</span>
</td>
</tr>
...
<!-- Button Connection -->
<br><input type="submit" class="button" value="&nbsp; <?php echo $langs->trans('Connections'); ?> &nbsp;" tabindex="5" />
