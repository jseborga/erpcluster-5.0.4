...
/**
 *   	\file       assets/cassetsgroup_card.php
 *		\ingroup    assets
...
$hookmanager->initHooks(array('cassetsgroup'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldaccount_spending").'</td><td><input class="flat" type="text" name="account_spending" value="'.GETPOST('account_spending').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldaccount_spending").'</td><td><input class="flat" type="text" name="account_spending" value="'.$object->account_spending.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldaccount_spending").'</td><td>$object->account_spending</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldactive").'</td><td>$object->active</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('cassetsgroup'));
