...
/**
 * \file    monprojet/productprojet.class.php
 * \ingroup monprojet
 ...
 * @see CommonObject
 */
class Productprojet extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'productprojet';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'product_projet';

	/**
	 * @var ProductprojetLine[] Lines
	 */
	public $lines = array();
...
echo $sql;
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Productprojet($this->db);
