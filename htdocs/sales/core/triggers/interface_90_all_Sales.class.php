 ...
 */
class InterfaceSales extends DolibarrTriggers
{
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
		...
		switch ($action) {
			...
			{
				$now = dol_now();
				require_once DOL_DOCUMENT_ROOT.'/sales/class/expeditiondetadd.class.php';
				$obj = new Expeditiondetadd($this->db);
				$obj->fk_expeditiondet = $line->id;
				$obj->fk_facture = 0;
