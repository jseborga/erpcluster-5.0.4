 ...
 */
class Projettask extends CommonObject
{
	/**
	 * @var string Error code (or message)
	 * @deprecated
	 * @see Projettask::errors
	 */
	public $error;
	/**
