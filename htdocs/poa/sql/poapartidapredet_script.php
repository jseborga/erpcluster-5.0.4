...
/**
 *      \file       poa/poapartidapredet_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poapartidapredet_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poapartidapredet.class.php");
$myobject=new Poapartidapredet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poapartidapredet";
