...
/**
 *   	\file       finint/requestcashdet_card.php
 *		\ingroup    finint
...
$hookmanager->initHooks(array('requestcashdet'));
...
if (empty($reshook))
{
	...
	$object->fk_request=GETPOST('fk_request','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_request").'</td><td><input class="flat" type="text" name="fk_request" value="'.GETPOST('fk_request').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_request").'</td><td><input class="flat" type="text" name="fk_request" value="'.$object->fk_request.'"></td></tr>';
...
if ($id && (empty($action) || $action == 'view' || $action == 'delete'))
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_request").'</td><td>$object->fk_request</td></tr>';
