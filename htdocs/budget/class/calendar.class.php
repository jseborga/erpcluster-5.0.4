...
/**
 * \file    budget/calendar.class.php
 * \ingroup budget
...
class Calendar extends CommonObject
{
	 ...
	 */
	public $table_element = 'calendar';

	/**
	 * @var CalendarLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (null !== $ref) {
			$sql .= ' WHERE t.ref = ' . '\'' . $ref . '\'';
			$sql.= " AND t.entity IN (".getEntity('calendar', 1).")";
		} else {
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Calendar") . '</u>';
        $label.= '<div width="100%">';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $link = '<a href="'.DOL_URL_ROOT.'/budget/calendar/card.php?id='.$this->id.'"';
