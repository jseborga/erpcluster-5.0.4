...
/**
 *      \file       monprojet/projetpaiementdet_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projetpaiementdet_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projetpaiementdet.class.php");
$myobject=new Projetpaiementdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projetpaiementdet";
