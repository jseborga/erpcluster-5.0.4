 ...
 *					Initialy built by build_class_from_table on 2017-04-04 10:35
 */
...
$search_statut_ref='';
    ...
    $permtoread = $user->rights->poapoa->read;
    $permtodelete = $user->rights->poapoa->delete;
    $uploaddir = $conf->poapoa->dir_output;
...
if (! empty($arrayfields['t.m_jan']['checked'])) print_liste_field_titre($arrayfields['t.m_jan']['label'],$_SERVER['PHP_SELF'],'t.m_jan','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_feb']['checked'])) print_liste_field_titre($arrayfields['t.m_feb']['label'],$_SERVER['PHP_SELF'],'t.m_feb','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_mar']['checked'])) print_liste_field_titre($arrayfields['t.m_mar']['label'],$_SERVER['PHP_SELF'],'t.m_mar','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_apr']['checked'])) print_liste_field_titre($arrayfields['t.m_apr']['label'],$_SERVER['PHP_SELF'],'t.m_apr','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_may']['checked'])) print_liste_field_titre($arrayfields['t.m_may']['label'],$_SERVER['PHP_SELF'],'t.m_may','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_jun']['checked'])) print_liste_field_titre($arrayfields['t.m_jun']['label'],$_SERVER['PHP_SELF'],'t.m_jun','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_jul']['checked'])) print_liste_field_titre($arrayfields['t.m_jul']['label'],$_SERVER['PHP_SELF'],'t.m_jul','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_aug']['checked'])) print_liste_field_titre($arrayfields['t.m_aug']['label'],$_SERVER['PHP_SELF'],'t.m_aug','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_sep']['checked'])) print_liste_field_titre($arrayfields['t.m_sep']['label'],$_SERVER['PHP_SELF'],'t.m_sep','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_oct']['checked'])) print_liste_field_titre($arrayfields['t.m_oct']['label'],$_SERVER['PHP_SELF'],'t.m_oct','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_nov']['checked'])) print_liste_field_titre($arrayfields['t.m_nov']['label'],$_SERVER['PHP_SELF'],'t.m_nov','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.m_dec']['checked'])) print_liste_field_titre($arrayfields['t.m_dec']['label'],$_SERVER['PHP_SELF'],'t.m_dec','',$params,'',$sortfield,$sortorder);
