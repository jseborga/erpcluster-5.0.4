...
/**
 *      \file       assets/assetsassignment_script.php
 *		\ingroup    assets
...
// Examples for manipulating class assetsassignment_class
require_once(DOL_DOCUMENT_ROOT."/../assets/assetsassignment.class.php");
$myobject=new Assetsassignment($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assetsassignment";
