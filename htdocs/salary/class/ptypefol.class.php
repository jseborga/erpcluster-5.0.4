...
/**
 * \file    salary/ptypefol.class.php
 * \ingroup salary
 ...
 * @see CommonObject
 */
class Ptypefol extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'ptypefol';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'p_type_fol';

	/**
	 * @var PtypefolLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->name_report)) {
			 $this->name_report = trim($this->name_report);
		}
		if (isset($this->state)) {
		...
		$sql .= ' '.(! isset($this->name_report)?'NULL':"'".$this->db->escape($this->name_report)."'").',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("ptypefol", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->name_report = $obj->name_report;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				...
				$line->name_report = $obj->name_report;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' name_report = '.(isset($this->name_report)?"'".$this->db->escape($this->name_report)."'":"null").',';
