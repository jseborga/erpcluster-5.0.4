...
/**
 *      \file       almacen/stockmouvementtemp_script.php
 *		\ingroup    almacen
...
// Examples for manipulating class stockmouvementtemp_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/stockmouvementtemp.class.php");
$myobject=new Stockmouvementtemp($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."stockmouvementtemp";
