...
/**
 *   	\file       monprojet/projetpaiement_card.php
 *		\ingroup    monprojet
...
$hookmanager->initHooks(array('projetpaiement'));
...
if (empty($reshook))
{
	...
	$object->fk_fourn_facture=GETPOST('fk_fourn_facture','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_fourn_facture").'</td><td><input class="flat" type="text" name="fk_fourn_facture" value="'.GETPOST('fk_fourn_facture').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_fourn_facture").'</td><td><input class="flat" type="text" name="fk_fourn_facture" value="'.$object->fk_fourn_facture.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_fourn_facture").'</td><td>$object->fk_fourn_facture</td></tr>';
