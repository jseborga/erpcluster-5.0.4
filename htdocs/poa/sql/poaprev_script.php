...
// Examples for manipulating class poaprev_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poaprev.class.php");
$myobject=new Poaprev($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poaprev";
