...
/**
 *      \file       priceunits/itemsformula_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class itemsformula_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/itemsformula.class.php");
$myobject=new Itemsformula($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."itemsformula";
