...
/**
 *  \file			./almacen/core/modules/modules_almacen.php
 *  \ingroup		Almacenes
 *  \brief			Fichier contenant la classe mere de generation des commandes en PDF
 *  				et la classe mere de numerotation des almacen
 */
require_once DOL_DOCUMENT_ROOT.'/core/class/commondocgenerator.class.php';
require_once DOL_DOCUMENT_ROOT.'/compta/bank/class/account.class.php';
	// requis car utilise par les classes qui heritent
 ...
 */
abstract class ModelePDFSales extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleSales extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleNumRefSales
{
	var $error='';
 ...
 */
function sales_pdf_create($db, $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0, $hookmanager=false)
{
	...
	{
	    if (! empty($conf->global->SALES_ADDON_PDF))
	    {
	        $modele = $conf->global->SALES_ADDON_PDF;
	    }
	    else
	    {
	        $modele = 'crabe';
	...
	foreach($dirmodels as $reldir)
	{
    	foreach(array('doc','pdf') as $prefix)
    	{
	        ...
	        $file=dol_buildpath($reldir."sales/core/modules/doc/".$file,0);
    		if (file_exists($file))
    		{
    			$filefound=1;
