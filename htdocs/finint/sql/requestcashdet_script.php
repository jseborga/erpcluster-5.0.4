...
/**
 *      \file       finint/requestcashdet_script.php
 *		\ingroup    finint
...
// Examples for manipulating class requestcashdet_class
require_once(DOL_DOCUMENT_ROOT."/../finint/requestcashdet.class.php");
$myobject=new Requestcashdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."requestcashdet";
