...
/**
 *      \file       priceunits/puformulasdet_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class puformulasdet_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/puformulasdet.class.php");
$myobject=new Puformulasdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."puformulasdet";
