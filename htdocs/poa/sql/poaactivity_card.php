...
$hookmanager->initHooks(array('poaactivity'));
...
if (empty($reshook))
{
	...
	$object->fk_pac=GETPOST('fk_pac','int');
	$object->fk_prev_ant=GETPOST('fk_prev_ant','int');
	$object->fk_prev=GETPOST('fk_prev','int');
	$object->fk_area=GETPOST('fk_area','int');
	$object->code_requirement=GETPOST('code_requirement','alpha');
	$object->label=GETPOST('label','alpha');
	$object->pseudonym=GETPOST('pseudonym','alpha');
	$object->nro_activity=GETPOST('nro_activity','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_pac").'</td><td><input class="flat" type="text" name="fk_pac" value="'.GETPOST('fk_pac').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_prev_ant").'</td><td><input class="flat" type="text" name="fk_prev_ant" value="'.GETPOST('fk_prev_ant').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_prev").'</td><td><input class="flat" type="text" name="fk_prev" value="'.GETPOST('fk_prev').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_requirement").'</td><td><input class="flat" type="text" name="code_requirement" value="'.GETPOST('code_requirement').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnro_activity").'</td><td><input class="flat" type="text" name="nro_activity" value="'.GETPOST('nro_activity').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_pac").'</td><td><input class="flat" type="text" name="fk_pac" value="'.$object->fk_pac.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_prev_ant").'</td><td><input class="flat" type="text" name="fk_prev_ant" value="'.$object->fk_prev_ant.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_prev").'</td><td><input class="flat" type="text" name="fk_prev" value="'.$object->fk_prev.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_requirement").'</td><td><input class="flat" type="text" name="code_requirement" value="'.$object->code_requirement.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnro_activity").'</td><td><input class="flat" type="text" name="nro_activity" value="'.$object->nro_activity.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_pac").'</td><td>$object->fk_pac</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_prev_ant").'</td><td>$object->fk_prev_ant</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_prev").'</td><td>$object->fk_prev</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_area").'</td><td>$object->fk_area</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_requirement").'</td><td>$object->code_requirement</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnro_activity").'</td><td>$object->nro_activity</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldactive").'</td><td>$object->active</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('poaactivity'));
