...
<tr class="liste_titre nodrag nodrop">
	...
	<?php } else {  ?>
	<td align="right"><span id="<?php echo ($conf->global->PRICE_TAXES_INCLUDED?'title_up_ttcx':'title_up_ttc'); ?>"><?php echo $langs->trans('PriceUTTC'); ?></span></td>
	<?php } ?>
...
?>
	...
	<?php if (!$conf->global->PRICE_TAXES_INCLUDED) { ?>
	<td align="right">
	<input type="text" size="5" name="price_ht" id="<?php echo ($conf->global->PRICE_TAXES_INCLUDED?'price_htx':'price_ht'); ?>" class="flat" value="<?php echo (isset($_POST["price_ht"])?$_POST["price_ht"]:''); ?>">
	</td>
	<?php } else { ?>
	
	<td align="right">
	<input type="text" size="5" name="price_ttc" id="<?php echo ($conf->global->PRICE_TAXES_INCLUDED?'price_ttcx':'price_ttc'); ?>" class="flat" value="<?php echo (isset($_POST["price_ttc"])?$_POST["price_ttc"]:''); ?>">
	</td>
	<?php }?>
