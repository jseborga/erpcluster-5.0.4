...
/**
 *      \file       purchase/facturefournadd_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class facturefournadd_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/facturefournadd.class.php");
$myobject=new Facturefournadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."facturefournadd";
