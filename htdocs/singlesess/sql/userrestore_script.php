...
/**
 *      \file       singlesess/userrestore_script.php
 *		\ingroup    singlesess
...
// Examples for manipulating class userrestore_class
require_once(DOL_DOCUMENT_ROOT."/../singlesess/userrestore.class.php");
$myobject=new Userrestore($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."userrestore";
