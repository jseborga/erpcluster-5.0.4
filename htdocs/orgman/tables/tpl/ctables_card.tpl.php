...
if ($action == 'create')
{
	...
	//print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtabledb").'</td><td><input class="flat" type="text" name="tabledb" value="'.GETPOST('tabledb').'"></td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcodetable").'</td><td><input class="flat" type="text" name="codetable" value="'.GETPOST('codetable').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtabledb").'</td><td><input class="flat" type="text" name="tabledb" value="'.$object->tabledb.'"></td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcodetable").'</td><td><input class="flat" type="text" name="codetable" value="'.$object->codetable.'"></td></tr>';
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldrange_ini").'</td><td><input class="flat" type="text" name="range_ini" value="'.$object->range_ini.'"></td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldrange_fin").'</td><td><input class="flat" type="text" name="range_fin" value="'.$object->range_fin.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtabledb").'</td><td>'.$object->tabledb.'</td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcodetable").'</td><td>'.$object->codetable.'</td></tr>';
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldrange_ini").'</td><td>'.$object->range_ini.'</td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldrange_fin").'</td><td>'.$object->range_fin.'</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('ctables'));
