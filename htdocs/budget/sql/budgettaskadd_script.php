...
/**
 *      \file       budget/budgettaskadd_script.php
 *		\ingroup    budget
...
// Examples for manipulating class budgettaskadd_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budgettaskadd.class.php");
$myobject=new Budgettaskadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgettaskadd";
