...
/**
 *   	\file       budget/city_list.php
 *		\ingroup    budget
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-01-19 13:52
 */
...
$hookmanager->initHooks(array('citylist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."city as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."city_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
