...
/**
 *   	\file       priceunits/itemsinsumos_list.php
 *		\ingroup    priceunits
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-09-13 15:38
 */
...
dol_include_once('/priceunits/class/itemsinsumos.class.php');
...
$search_gestion=GETPOST('search_gestion','alpha');
...
$hookmanager->initHooks(array('itemsinsumoslist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."items_insumos as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."items_insumos_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
