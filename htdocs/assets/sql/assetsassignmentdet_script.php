...
/**
 *      \file       assets/assetsassignmentdet_script.php
 *		\ingroup    assets
...
// Examples for manipulating class assetsassignmentdet_class
require_once(DOL_DOCUMENT_ROOT."/../assets/assetsassignmentdet.class.php");
$myobject=new Assetsassignmentdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assetsassignmentdet";
