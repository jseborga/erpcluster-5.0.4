...
/**
 *      \file       sales/bankstatus_script.php
 *		\ingroup    sales
...
// Examples for manipulating class bankstatus_class
require_once(DOL_DOCUMENT_ROOT."/../sales/bankstatus.class.php");
$myobject=new Bankstatus($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."bankstatus";
