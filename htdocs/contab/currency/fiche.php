...
dol_include_once('/contab/currency/class/cscurrencytype.class.php');
...
llxHeader("",$langs->trans("Liquidationwages"),$help_url);
	 ...
	 if ($action <> 'edit' && $action <> 're-edit')
	   {
		 ...
		 elseif($user->rights->contab->currency->crear && $object->state == 1)
