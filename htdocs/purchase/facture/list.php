...
if ($day > 0)
{
	...
	$sql.= " AND date_format(fac.datef, '%d') = '$day'";
}
if ($month > 0)
{
	if ($year > 0)
...
if ($resql)
{
	...
	$liststatus=array('paye:0'=>$langs->trans("Pte. pago"), 'paye:1'=>$langs->trans("Paid"),'fk_statut:0'=>$langs->trans('Draft'));
	...
	while ($i < min($num,$limit))
	{
		...
		print '<a href="'.DOL_URL_ROOT.'/purchase/facture/card.php?id='.$obj->facid.'"">'.$obj->ref.'</a>';
		print "</td>\n";
