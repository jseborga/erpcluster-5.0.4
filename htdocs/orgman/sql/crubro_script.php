...
// Examples for manipulating class crubro_class
require_once(DOL_DOCUMENT_ROOT."/../orgman/crubro.class.php");
$myobject=new Crubro($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."crubro";
