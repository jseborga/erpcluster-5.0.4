...
class Poaactivity extends CommonObject
{
	...
	var $element='poaactivity';			//!< Id that identify managed objects
	var $table_element='poaactivity';		//!< Name of table without prefix where object is stored
