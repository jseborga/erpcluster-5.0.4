...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldordby").'</td><td><input class="flat" type="text" name="ordby" value="'.GETPOST('ordby').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldordby").'</td><td>$object->ordby</td></tr>';
