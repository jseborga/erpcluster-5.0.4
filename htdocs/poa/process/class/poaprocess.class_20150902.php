 ...
 *				Initialy built by build_class_from_table on 2015-03-18 16:26
 */
...
class Poaprocess extends CommonObject
{
	...
	var $element='poa_process';			//!< Id that identify managed objects
	var $table_element='poa_process';		//!< Name of table without prefix where object is stored
