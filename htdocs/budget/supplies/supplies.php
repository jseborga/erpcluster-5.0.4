...
/**
 *   	\file       dev/Suppliess/Supplies_page.php
 *		\ingroup    mymodule othermodule1 othermodule2
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2015-10-05 10:08
 */
...
dol_include_once('/module/class/supplies.class.php');
...
if ($action == 'list' || empty($id))
{
    ...
    $sql.= " FROM ".MAIN_DB_PREFIX."supplies as t";
