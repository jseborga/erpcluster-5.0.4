...
/**
 *      \file       salary/psalarypresent_script.php
 *		\ingroup    salary
...
// Examples for manipulating class psalarypresent_class
require_once(DOL_DOCUMENT_ROOT."/../salary/psalarypresent.class.php");
...
$sql.= " FROM ".MAIN_DB_PREFIX."psalarypresent";
