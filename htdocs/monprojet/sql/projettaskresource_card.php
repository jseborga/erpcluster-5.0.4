...
/**
 *   	\file       monprojet/projettaskresource_card.php
 *		\ingroup    monprojet
...
$hookmanager->initHooks(array('projettaskresource'));
...
if (empty($reshook))
{
	...
	$object->fk_objectdet=GETPOST('fk_objectdet','int');
	$object->objectdet=GETPOST('objectdet','alpha');
	$object->fk_stock_mouvement=GETPOST('fk_stock_mouvement','int');
	$object->fk_user_create=GETPOST('fk_user_create','int');
	$object->fk_user_mod=GETPOST('fk_user_mod','int');
	$object->group_resource=GETPOST('group_resource','alpha');
	$object->type_resource=GETPOST('type_resource','alpha');
	$object->code_structure=GETPOST('code_structure','alpha');
	$object->fk_product=GETPOST('fk_product','int');
	$object->fk_product_projet=GETPOST('fk_product_projet','int');
	$object->fk_product_budget=GETPOST('fk_product_budget','int');
	$object->fk_facture_fourn=GETPOST('fk_facture_fourn','int');
	$object->fk_projet_paiement=GETPOST('fk_projet_paiement','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_objectdet").'</td><td><input class="flat" type="text" name="fk_objectdet" value="'.GETPOST('fk_objectdet').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldobjectdet").'</td><td><input class="flat" type="text" name="objectdet" value="'.GETPOST('objectdet').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_stock_mouvement").'</td><td><input class="flat" type="text" name="fk_stock_mouvement" value="'.GETPOST('fk_stock_mouvement').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldgroup_resource").'</td><td><input class="flat" type="text" name="group_resource" value="'.GETPOST('group_resource').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_resource").'</td><td><input class="flat" type="text" name="type_resource" value="'.GETPOST('type_resource').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_product_projet").'</td><td><input class="flat" type="text" name="fk_product_projet" value="'.GETPOST('fk_product_projet').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_paiement").'</td><td><input class="flat" type="text" name="fk_projet_paiement" value="'.GETPOST('fk_projet_paiement').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_objectdet").'</td><td><input class="flat" type="text" name="fk_objectdet" value="'.$object->fk_objectdet.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldobjectdet").'</td><td><input class="flat" type="text" name="objectdet" value="'.$object->objectdet.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_stock_mouvement").'</td><td><input class="flat" type="text" name="fk_stock_mouvement" value="'.$object->fk_stock_mouvement.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldgroup_resource").'</td><td><input class="flat" type="text" name="group_resource" value="'.$object->group_resource.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_resource").'</td><td><input class="flat" type="text" name="type_resource" value="'.$object->type_resource.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_product_projet").'</td><td><input class="flat" type="text" name="fk_product_projet" value="'.$object->fk_product_projet.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_paiement").'</td><td><input class="flat" type="text" name="fk_projet_paiement" value="'.$object->fk_projet_paiement.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_objectdet").'</td><td>$object->fk_objectdet</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldobjectdet").'</td><td>$object->objectdet</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_stock_mouvement").'</td><td>$object->fk_stock_mouvement</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldgroup_resource").'</td><td>$object->group_resource</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_resource").'</td><td>$object->type_resource</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_product_projet").'</td><td>$object->fk_product_projet</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_paiement").'</td><td>$object->fk_projet_paiement</td></tr>';
