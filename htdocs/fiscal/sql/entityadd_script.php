...
/**
 *      \file       fiscal/entityadd_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class entityadd_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/entityadd.class.php");
$myobject=new Entityadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."entityadd";
