...
/**
 * \file    fiscal/ctypetva.class.php
 * \ingroup fiscal
 ...
 * @see CommonObject
 */
class Ctypetva extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'ctypetva';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'c_type_tva';
	public $table_name = 'ctypetva';
	/**
	 * @var CtypetvaLine[] Lines
	 */
	public $lines = array();
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("ctypetva", 1) . ")";
		}
		if (count($sqlwhere) > 0) {
