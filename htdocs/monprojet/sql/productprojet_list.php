...
/**
 *   	\file       monprojet/productprojet_list.php
 *		\ingroup    monprojet
...
$hookmanager->initHooks(array('productprojetlist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."product_projet as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."product_projet_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
