...
$hookmanager->initHooks(array('tvadet'));
...
if (empty($reshook))
{
	...
	$object->fk_tva=GETPOST('fk_tva','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_tva").'</td><td><input class="flat" type="text" name="fk_tva" value="'.GETPOST('fk_tva').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_tva").'</td><td><input class="flat" type="text" name="fk_tva" value="'.$object->fk_tva.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_tva").'</td><td>$object->fk_tva</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('tvadet'));
