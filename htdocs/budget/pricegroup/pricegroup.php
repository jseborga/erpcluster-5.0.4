...
/**
 *   	\file       dev/Pricegroups/Pricegroup_page.php
...
dol_include_once('/budget/pricegroup/class/pricegroup.class.php');
...
if ($action == 'list' || empty($id))
  {
    ...
    $sql.= " FROM ".MAIN_DB_PREFIX."price_group as t";
    ...
    print_liste_field_titre($langs->trans('Detailtitle'),$_SERVER['PHP_SELF'],'t.detail_title','',$param,'',$sortfield,$sortorder);
    print_liste_field_titre($langs->trans('Category'),$_SERVER['PHP_SELF'],'t.fk_category','',$param,'',$sortfield,$sortorder);
    print_liste_field_titre($langs->trans('Percentage'),$_SERVER['PHP_SELF'],'t.detail','',$param,'',$sortfield,$sortorder);
    print_liste_field_titre($langs->trans('Operations'),$_SERVER['PHP_SELF'],'t.detail','',$param,'',$sortfield,$sortorder);
    print '</tr>';
	...
	$var = true;
        while ($i < $num)
        {
	      ...
	      print $obj->detail;
	      print '</td><td>';
	      print $obj->detail_title;
	      print '</td><td>';
	      if ($obj->fk_category == $objcat->id)
		print $objcat->label;
	      else
		print '&nbsp;';
	      print '</td><td align="right">';
	      print price($obj->percentage);
	      print '</td><td>';
	      print $obj->operations;
	      print '</td></tr>';
            }
            $i++;
        }
