 ...
 */
class modSales extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 591000;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'sales';
		...
		$this->description = "Módulo Comercial para Bolivia";
		...
		//                        );
		$this->module_parts = array('triggers'=>1,'hooks'=>array('propalcard','globalcard','commonobject'));
		...
		$this->config_page_url = array("sales.php@sales");
		...
		$this->langfiles = array("sales@sales");
        ...
        $this->tabs = array('intervention:-card',
        	'intervention:+card:Card:sales@sales:$user->rights->sales->int->lire:/sales/fichinter/card.php?id=__ID__',
);

		if (! isset($conf->sales) || ! isset($conf->sales->enabled))
        {
        	$conf->sales=new stdClass();
        	$conf->sales->enabled=0;
        }
        ...
        */
		...
		$r++;
		$this->rights[$r][0] = $this->numero+$r;
		$this->rights[$r][1] = 'Createcontract';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'con';
		$this->rights[$r][5] = 'creer';
		...
		$r++;
		$this->rights[$r][0] = $this->numero+$r;
		$this->rights[$r][1] = 'CreateinvoicePDF';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'pdf';
		...
		$r++;
		$this->rights[$r][0] = $this->numero+$r;
		$this->rights[$r][1] = 'DeleteinvoicePDF';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'pdf';
		$this->rights[$r][5] = 'del';
		...
		$r++;
		$this->rights[$r][0] = $this->numero+$r;
		$this->rights[$r][1] = 'Readintervention';
		$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'int';
		$this->rights[$r][5] = 'lire';
		...
		$this->menu[$r]=array('fk_menu'=>0,			// Put 0 if this is a top menu
				      ...
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->lire',
				      'target'=>'',
				      'user'=>0);
		...
		$this->menu[$r]=array('fk_menu'=>'r=0',
				      ...
				      'mainmenu'=>'sales',
				      'leftmenu'=>'bud',
				      'url'=>'/sales/propal/list.php',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->pro->lire',
				      'target'=>'',
				      'user'=>0);
		$r++;
		$this->menu[$r]=array('fk_menu'=>'fk_mainmenu=sales,fk_leftmenu=bud',
				      'type'=>'left',
				      'titre'=>'New budget',
				      'mainmenu'=>'sales',
				      'url'=>'/sales/propal/card.php?action=create',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->pro->creer',
				      'target'=>'',
				      'user'=>0);
		$r++;
		$this->menu[$r]=array('fk_menu'=>'r=0',
				      ...
				      'mainmenu'=>'sales',
				      'leftmenu'=>'com',
				      'url'=>'/sales/commande/list.php',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->ord->lire',
				      'target'=>'',
				      'user'=>0);
		$r++;
		$this->menu[$r]=array('fk_menu'=>'fk_mainmenu=sales,fk_leftmenu=com',
				      'type'=>'left',
				      'titre'=>'New order',
				      'mainmenu'=>'sales',
				      'url'=>'/sales/commande/card.php?action=create',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->ord->creer',
				      'target'=>'',
				      'user'=>0);
		$r++;
		$this->menu[$r]=array('fk_menu'=>'r=0',
				      ...
				      'mainmenu'=>'sales',
				      'leftmenu'=>'con',
				      'url'=>'/sales/contrat/list.php',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->con->lire',
				      'target'=>'',
				      'user'=>0);
		$r++;
		$this->menu[$r]=array('fk_menu'=>'fk_mainmenu=sales,fk_leftmenu=con',
				      'type'=>'left',
				      'titre'=>'Newcontract',
				      'mainmenu'=>'sales',
				      'url'=>'/sales/contrat/card.php?action=create',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->con->creer',
				      'target'=>'',
				      'user'=>0);
		...
		$this->menu[$r]=array('fk_menu'=>'r=0',
				      ...
				      'mainmenu'=>'sales',
				      'leftmenu'=>'fac',
				      'url'=>'/sales/compta/facture/list.php',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->fac->lire',
				      'target'=>'',
				      'user'=>0);
		$r++;
		$this->menu[$r]=array('fk_menu'=>'fk_mainmenu=sales,fk_leftmenu=fac',
				      'type'=>'left',
				      'titre'=>'Newinvoice',
				      'mainmenu'=>'sales',
				      'url'=>'/sales/compta/facture.php?action=create',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->fac->creer',
				      'target'=>'',
				      'user'=>0);
		$r++;
		$this->menu[$r]=array('fk_menu'=>'r=0',
				      'type'=>'left',
				      'titre'=>'Invoicesfiscal',
				      'mainmenu'=>'sales',
				      'leftmenu'=>'fac',
				      'url'=>'/fiscal/list.php',
				      'langs'=>'sales@sales',
		...
		$this->menu[$r]=array('fk_menu'=>'r=0',
				      ...
				      'mainmenu'=>'sales',
				      'leftmenu'=>'book',
				      'url'=>'/sales/booksales.php?action=create',
				      'langs'=>'sales@sales',
				      'position'=>100,
				      'enabled'=>'$conf->sales->enabled',
				      'perms'=>'$user->rights->sales->book->lire',
				      'target'=>'',
				      'user'=>0);
