...
/**
 *   	\file       finint/requestcash_list.php
 *		\ingroup    finint
...
$hookmanager->initHooks(array('requestcashlist'));
...
't.fk_user_assigned'=>array('label'=>$langs->trans("Fieldfk_user_assigned"), 'checked'=>1),
't.fk_user_authorized'=>array('label'=>$langs->trans("Fieldfk_user_authorized"), 'checked'=>1),
...
't.fk_type_cash'=>array('label'=>$langs->trans("Fieldfk_type_cash"), 'checked'=>1),
...
't.document_discharg'=>array('label'=>$langs->trans("Fielddocument_discharg"), 'checked'=>1),
't.amount'=>array('label'=>$langs->trans("Fieldamount"), 'checked'=>1),
't.amount_approved'=>array('label'=>$langs->trans("Fieldamount_approved"), 'checked'=>1),
't.amount_authorized'=>array('label'=>$langs->trans("Fieldamount_authorized"), 'checked'=>1),
't.amount_out'=>array('label'=>$langs->trans("Fieldamount_out"), 'checked'=>1),
...
$search_fk_user_assigned='';
$search_fk_user_authorized='';
...
$search_description='';
$search_document='';
$search_document_discharg='';
$search_amount='';
$search_amount_approved='';
$search_amount_authorized='';
$search_amount_out='';
$search_amount_close='';
$search_model_pdf='';
$search_nro_chq='';
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."request_cash_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_fk_user_assigned) $sql.= natural_search("fk_user_assigned",$search_fk_user_assigned);
if ($search_fk_user_authorized) $sql.= natural_search("fk_user_authorized",$search_fk_user_authorized);
...
if ($search_fk_type_cash) $sql.= natural_search("fk_type_cash",$search_fk_type_cash);
...
if ($search_document_discharg) $sql.= natural_search("document_discharg",$search_document_discharg);
if ($search_amount) $sql.= natural_search("amount",$search_amount);
if ($search_amount_approved) $sql.= natural_search("amount_approved",$search_amount_approved);
if ($search_amount_authorized) $sql.= natural_search("amount_authorized",$search_amount_authorized);
if ($search_amount_out) $sql.= natural_search("amount_out",$search_amount_out);
...
if ($search_fk_user_assigned != '') $params.= '&amp;search_fk_user_assigned='.urlencode($search_fk_user_assigned);
if ($search_fk_user_authorized != '') $params.= '&amp;search_fk_user_authorized='.urlencode($search_fk_user_authorized);
...
if ($search_fk_type_cash != '') $params.= '&amp;search_fk_type_cash='.urlencode($search_fk_type_cash);
...
if ($search_document != '') $params.= '&amp;search_document='.urlencode($search_document);
if ($search_document_discharg != '') $params.= '&amp;search_document_discharg='.urlencode($search_document_discharg);
if ($search_amount != '') $params.= '&amp;search_amount='.urlencode($search_amount);
if ($search_amount_approved != '') $params.= '&amp;search_amount_approved='.urlencode($search_amount_approved);
if ($search_amount_authorized != '') $params.= '&amp;search_amount_authorized='.urlencode($search_amount_authorized);
if ($search_amount_out != '') $params.= '&amp;search_amount_out='.urlencode($search_amount_out);
...
if (! empty($arrayfields['t.fk_user_assigned']['checked'])) print_liste_field_titre($arrayfields['t.fk_user_assigned']['label'],$_SERVER['PHP_SELF'],'t.fk_user_assigned','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_user_authorized']['checked'])) print_liste_field_titre($arrayfields['t.fk_user_authorized']['label'],$_SERVER['PHP_SELF'],'t.fk_user_authorized','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_type_cash']['checked'])) print_liste_field_titre($arrayfields['t.fk_type_cash']['label'],$_SERVER['PHP_SELF'],'t.fk_type_cash','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.document_discharg']['checked'])) print_liste_field_titre($arrayfields['t.document_discharg']['label'],$_SERVER['PHP_SELF'],'t.document_discharg','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.amount_approved']['checked'])) print_liste_field_titre($arrayfields['t.amount_approved']['label'],$_SERVER['PHP_SELF'],'t.amount_approved','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.amount_authorized']['checked'])) print_liste_field_titre($arrayfields['t.amount_authorized']['label'],$_SERVER['PHP_SELF'],'t.amount_authorized','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.amount_out']['checked'])) print_liste_field_titre($arrayfields['t.amount_out']['label'],$_SERVER['PHP_SELF'],'t.amount_out','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_user_assigned']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_user_assigned" value="'.$search_fk_user_assigned.'" size="10"></td>';
if (! empty($arrayfields['t.fk_user_authorized']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_user_authorized" value="'.$search_fk_user_authorized.'" size="10"></td>';
...
if (! empty($arrayfields['t.fk_type_cash']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_type_cash" value="'.$search_fk_type_cash.'" size="10"></td>';
...
if (! empty($arrayfields['t.document_discharg']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_document_discharg" value="'.$search_document_discharg.'" size="10"></td>';
...
if (! empty($arrayfields['t.amount_approved']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_amount_approved" value="'.$search_amount_approved.'" size="10"></td>';
if (! empty($arrayfields['t.amount_authorized']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_amount_authorized" value="'.$search_amount_authorized.'" size="10"></td>';
if (! empty($arrayfields['t.amount_out']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_amount_out" value="'.$search_amount_out.'" size="10"></td>';
