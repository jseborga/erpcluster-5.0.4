...
/**
 *   	\file       assets/cassetsmethod_list.php
 *		\ingroup    assets
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-05-22 14:23
 */
...
$search_active='';
    ...
    $permtoread = $user->rights->cassetsmethod->read;
    $permtodelete = $user->rights->cassetsmethod->delete;
    $uploaddir = $conf->cassetsmethod->dir_output;
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."c_assets_method_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/cassetsmethod/card.php?id='.$id);
    exit;
}
