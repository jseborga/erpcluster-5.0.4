...
/**
 *      \file       htdocs/assistance/liste.php
 *      \ingroup    Control asistencia
 *      \brief      Page liste marcaciones
 */
...
if (!$user->rights->assistance->leer)
  accessforbidden();
...
if (! $sortfield) $sortfield="p.date_ass";
if (! $sortorder) $sortorder="ASC";
$page = $_GET["page"];
if ($page < 0) $page = 0;
$limit = $conf->liste_limit;
$offset = $limit * $page;
$sql  = "SELECT p.rowid AS id, p.fk_member, p.date_ass ";
$sql.= " FROM ".MAIN_DB_PREFIX."assistance as p ";
...
if ($result)
  {
    ...
    print_barre_liste($langs->trans("Liste assistance"), $page, "liste.php", "", $sortfield, $sortorder,'',$num);
