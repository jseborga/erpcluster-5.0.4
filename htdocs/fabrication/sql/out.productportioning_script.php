...
/**
 *      \file       dev/skeletons/productportioning_script.php
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/productportioning.class.php");
$myobject=new Productportioning($db);
