...
/**
 *      \file       almacen/entrepotrelation_script.php
 *		\ingroup    almacen
...
// Examples for manipulating class entrepotrelation_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/entrepotrelation.class.php");
$myobject=new Entrepotrelation($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."entrepotrelation";
