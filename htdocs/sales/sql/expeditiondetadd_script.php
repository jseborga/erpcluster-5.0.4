...
/**
 *      \file       sales/expeditiondetadd_script.php
 *		\ingroup    sales
...
// Examples for manipulating class expeditiondetadd_class
require_once(DOL_DOCUMENT_ROOT."/../sales/expeditiondetadd.class.php");
$myobject=new Expeditiondetadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."expeditiondetadd";
