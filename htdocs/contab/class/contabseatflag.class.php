...
/**
 * \file    contab/contabseatflag.class.php
 * \ingroup contab
...
class Contabseatflag extends CommonObject
{
	 ...
	 */
	public $element = 'contabseatflag';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'contab_seat_flag';

	/**
	 * @var ContabseatflagLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_seat)) {
			 $this->fk_seat = trim($this->fk_seat);
		}
		if (isset($this->table_nom)) {
			 $this->table_nom = trim($this->table_nom);
		}
		if (isset($this->table_id)) {
			 $this->table_id = trim($this->table_id);
		}
		if (isset($this->state)) {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ContabseatflagLine();

				$line->id = $obj->rowid;
				
				$line->entity = $obj->entity;
				$line->fk_seat = $obj->fk_seat;
				$line->table_nom = $obj->table_nom;
				$line->table_id = $obj->table_id;
