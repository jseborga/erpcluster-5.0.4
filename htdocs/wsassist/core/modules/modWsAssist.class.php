 ...
 */
class modWsAssist extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 604000;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'wsassist';
		...
		$this->description = "Description of module Wsassist";
		...
		$this->config_page_url = array("mysetuppage.php@wsassist");
		...
		$this->langfiles = array("wsassist@wsassist");
		...
		if (! isset($conf->wsassist) || ! isset($conf->wsassist->enabled))
        {
        	$conf->wsassist=new stdClass();
        	$conf->wsassist->enabled=0;
        }
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/wsassist/sql/');
