...
/**
 *      \file       dev/skeletons/poaactivityworkflow_script.php
 *		\ingroup    mymodule
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/poaactivityworkflow.class.php");
$myobject=new Poaactivityworkflow($db);
