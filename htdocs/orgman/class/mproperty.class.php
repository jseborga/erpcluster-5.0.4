...
/**
 * \file    orgman/mproperty.class.php
 * \ingroup orgman
...
class Mproperty extends CommonObject
{
	 ...
	 */
	public $element = 'mproperty';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_property';

	/**
	 * @var MpropertyLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_state)) {
			 $this->fk_state = trim($this->fk_state);
		}
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mproperty", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
