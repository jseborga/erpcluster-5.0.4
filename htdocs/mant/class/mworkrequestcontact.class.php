...
/**
 * \file    mant/mworkrequestcontact.class.php
 * \ingroup mant
...
class Mworkrequestcontact extends CommonObject
{
	 ...
	 */
	public $element = 'mworkrequestcontact';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_work_request_contact';

	/**
	 * @var MworkrequestcontactLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mworkrequestcontact", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new MworkrequestcontactLine();
