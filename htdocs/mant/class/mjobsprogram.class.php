...
/**
 * \file    mant/mjobsprogram.class.php
 * \ingroup mant
 ...
 * @see CommonObject
 */
class Mjobsprogram extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'mjobsprogram';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_jobs_program';

	/**
	 * @var MjobsprogramLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->image_req)) {
			 $this->image_req = trim($this->image_req);
		}
		...
		$sql .= ' '.(! isset($this->image_req)?'NULL':$this->image_req).',';
	...
	public function fetch($id, $ref = null,$fk=0)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mjobsprogram", 1) . ")";
		}
		if (null !== $ref && $fk>0) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' image_req = '.(isset($this->image_req)?$this->image_req:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Mjobsprogram($this->db);
