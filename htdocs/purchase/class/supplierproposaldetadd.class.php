...
/**
 * \file    purchase/supplierproposaldetadd.class.php
 * \ingroup purchase
...
/**
 * Class Supplierproposaldetadd
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Supplierproposaldetadd extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'supplierproposaldetadd';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'supplier_proposaldet_add';

	/**
	 * @var SupplierproposaldetaddLine[] Lines
	 */
	public $lines = array();
	...
	public $fk_supplier_proposaldet;
	public $fk_object;
	public $object;
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_supplier_proposaldet)) {
			 $this->fk_supplier_proposaldet = trim($this->fk_supplier_proposaldet);
		}
		...
		$sql .= ' '.(! isset($this->fk_supplier_proposaldet)?'NULL':$this->fk_supplier_proposaldet).',';
	...
	public function fetch($id, $fk=0)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("supplierproposaldetadd", 1) . ")";
		}
		if ($fk>0) {
			$sql .= ' AND t.fk_supplier_proposaldet = ' . $fk;
		} else {
			$sql .= ' AND t.rowid = ' . $id;
		}
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->fk_supplier_proposaldet = $obj->fk_supplier_proposaldet;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new SupplierproposaldetaddLine();

				$line->id = $obj->rowid;

				$line->fk_supplier_proposaldet = $obj->fk_supplier_proposaldet;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' fk_supplier_proposaldet = '.(isset($this->fk_supplier_proposaldet)?$this->fk_supplier_proposaldet:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Supplierproposaldetadd($this->db);
...
/**
 * Class SupplierproposaldetaddLine
 */
class SupplierproposaldetaddLine
{
	/**
