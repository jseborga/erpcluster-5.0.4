...
/**
 *      \file       priceunits/productpricebudget_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class productpricebudget_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/productpricebudget.class.php");
$myobject=new Productpricebudget($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."productpricebudget";
