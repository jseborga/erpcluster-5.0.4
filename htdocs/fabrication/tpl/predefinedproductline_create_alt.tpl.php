...
echo $langs->trans('Productfather');
	?>
	</td>
	<td align="right"><?php echo $langs->trans('Unitfather'); ?></td>
	...
	<td align="right"><?php echo $langs->trans('Unitson'); ?></td>
	<td align="right"><?php echo $langs->trans('Qty'); ?></td>
...
<td<?php  echo (! empty($conf->global->MAIN_VIEW_LINE_NUMBER) ? ' colspan="4"' : ' colspan="3"'); ?>>
	<?php
	echo $object->productNome;
	echo '<span>';
	$filtertype='';
	if (! empty($object->element) && $object->element == 'contrat') $filtertype='1';
$form->select_produits('','idprod',$filtertype,$conf->product->limit_size,$buyer->price_level,-1);
	echo '</span>';
	...
	<td align="right">
	  ...
	  print $form->selectarray('fk_unit_father',$liste,$conf->global->COMMANDE_ADDON_PDF);
?>
	</td>
	<td align="right"><input type="text" size="2" name="qty_father" value="1"></td>
	...
	$filtertype='';
	if (! empty($object->element) && $object->element == 'contrat') $filtertype='1';
$form->select_produits('','idprod1',$filtertype,$conf->product->limit_size,$buyer->price_level,-1);
	echo '</span>';
...
?>
	...
	<td align="right"><input type="text" size="2" name="qty_son" value="1"></td>
	<?php
	$colspan = 4;
	if (! empty($usemargins)) 
	{
