...
<tr <?php echo $bcnd[$var]; ?>>
	...
	print $form->selectarray('fk_fabricationdet',$aItemf,$_SESSION['fk_fabricationdet'][$object->fk_fabrication],(count($objFabrication->lines)>1?1:0));
	$filtertype='';
	...
	$form->select_produits_v('','idprod',$filtertype,$conf->product->limit_size,0,-1,2,'',1,'','',$action);
