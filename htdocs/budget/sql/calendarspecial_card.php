...
/**
 *   	\file       budget/calendarspecial_card.php
 *		\ingroup    budget
...
$hookmanager->initHooks(array('calendarspecial'));
...
if (empty($reshook))
{
	...
	$object->type_date=GETPOST('type_date','int');
	$object->working_day_hour=GETPOST('working_day_hour','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_date").'</td><td><input class="flat" type="text" name="type_date" value="'.GETPOST('type_date').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldworking_day_hour").'</td><td><input class="flat" type="text" name="working_day_hour" value="'.GETPOST('working_day_hour').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_date").'</td><td><input class="flat" type="text" name="type_date" value="'.$object->type_date.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldworking_day_hour").'</td><td><input class="flat" type="text" name="working_day_hour" value="'.$object->working_day_hour.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_date").'</td><td>$object->type_date</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldworking_day_hour").'</td><td>$object->working_day_hour</td></tr>';
