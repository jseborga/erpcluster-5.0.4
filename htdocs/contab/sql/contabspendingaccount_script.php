...
/**
 *      \file       contab/contabspendingaccount_script.php
 *		\ingroup    contab
...
// Examples for manipulating class contabspendingaccount_class
require_once(DOL_DOCUMENT_ROOT."/../contab/contabspendingaccount.class.php");
$myobject=new Contabspendingaccount($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."contabspendingaccount";
