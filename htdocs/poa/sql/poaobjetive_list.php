 ...
 *					Initialy built by build_class_from_table on 2017-03-27 09:29
 */
...
't.fk_poa_strategic'=>array('label'=>$langs->trans("Fieldfk_poa_strategic"), 'checked'=>1),
...
't.expected_result'=>array('label'=>$langs->trans("Fieldexpected_result"), 'checked'=>1),
...
$search_status='';
    ...
    $uploaddir = $conf->poaobjetive->dir_output;
