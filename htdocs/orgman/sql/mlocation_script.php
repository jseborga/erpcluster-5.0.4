...
/**
 *      \file       orgman/mlocation_script.php
 *		\ingroup    orgman
...
// Examples for manipulating class mlocation_class
require_once(DOL_DOCUMENT_ROOT."/../orgman/mlocation.class.php");
$myobject=new Mlocation($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."mlocation";
