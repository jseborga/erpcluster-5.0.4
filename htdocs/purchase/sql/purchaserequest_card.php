 ...
 *					Initialy built by build_class_from_table on 2017-04-28 15:10
 */
...
if (empty($reshook))
{
	...
	$object->fk_user_cloture=GETPOST('fk_user_cloture','int');
	...
	$object->status_process=GETPOST('status_process','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_int").'</td><td><input class="flat" type="text" name="ref_int" value="'.GETPOST('ref_int').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_cloture").'</td><td><input class="flat" type="text" name="fk_user_cloture" value="'.GETPOST('fk_user_cloture').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_shipping_method").'</td><td><input class="flat" type="text" name="fk_shipping_method" value="'.GETPOST('fk_shipping_method').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldextraparams").'</td><td><input class="flat" type="text" name="extraparams" value="'.GETPOST('extraparams').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus_process").'</td><td><input class="flat" type="text" name="status_process" value="'.GETPOST('status_process').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_int").'</td><td><input class="flat" type="text" name="ref_int" value="'.$object->ref_int.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_cloture").'</td><td><input class="flat" type="text" name="fk_user_cloture" value="'.$object->fk_user_cloture.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_shipping_method").'</td><td><input class="flat" type="text" name="fk_shipping_method" value="'.$object->fk_shipping_method.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldextraparams").'</td><td><input class="flat" type="text" name="extraparams" value="'.$object->extraparams.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus_process").'</td><td><input class="flat" type="text" name="status_process" value="'.$object->status_process.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_int").'</td><td>$object->ref_int</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus_process").'</td><td>$object->status_process</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('purchaserequest'));
