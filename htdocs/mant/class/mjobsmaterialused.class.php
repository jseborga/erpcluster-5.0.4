...
/**
 * \file    mant/mjobsmaterialused.class.php
 * \ingroup mant
...
/**
 * Class Mjobsmaterialused
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Mjobsmaterialused extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'mjobsmaterialused';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_jobs_material_used';

	/**
	 * @var MjobsmaterialusedLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		$sql .= ' '.(! isset($this->date_return) || dol_strlen($this->date_return)==0?'NULL':"'".$this->db->idate($this->date_return)."'").',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mjobsmaterialused", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new MjobsmaterialusedLine();

				$line->id = $obj->rowid;
				
				$line->fk_jobs = $obj->fk_jobs;
				$line->ref = $obj->ref;
				$line->date_return = $this->db->jdate($obj->date_return);
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' date_return = '.(! isset($this->date_return) || dol_strlen($this->date_return) != 0 ? "'".$this->db->idate($this->date_return)."'" : 'null').',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Mjobsmaterialused($this->db);
