...
/**
 *      \file       budget/itemsproduct_script.php
 *		\ingroup    budget
 *      \brief      This file is an example for a command line script
 *					Initialy built by build_class_from_table on 2018-04-27 18:22
 */
...
// Examples for manipulating class itemsproduct_class
require_once(DOL_DOCUMENT_ROOT."/../budget/itemsproduct.class.php");
$myobject=new Itemsproduct($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."itemsproduct";
