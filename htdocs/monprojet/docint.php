...
require_once DOL_DOCUMENT_ROOT.'/monprojet/class/html.formfileadd.class.php';
...
if (! $user->rights->monprojet->docint->leer) accessforbidden();
...
if ($id > 0 || ! empty($ref)) {
    $upload_dir = $conf->monprojet->dir_output . "/" . dol_sanitizeFileName($object->ref);
}
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'docint', $langs->trans("Project"), 0, ($object->public?'projectpub':'project'));
	...
	include_once DOL_DOCUMENT_ROOT . '/monprojet/tpl/document_actions_post_headers.tpl.php';
