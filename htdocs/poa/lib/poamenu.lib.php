...
function print_eldy_menu($db,$atarget,$type_user,&$tabMenu,&$menu,$noout=0)
{
	...
	// Poa liste
	$tmpentry=array('enabled'=>(! empty($conf->poa->enabled)),
			'perms'=>(! empty($user->rights->poa->poa->leer)),
			'module'=>'poa');
	$showmode=dol_eldy_showmenu($type_user, $tmpentry, $listofmodulesforexternal);
	if ($showmode)
	  {
		$classname="";
		if ($_SESSION["mainmenu"] && $_SESSION["mainmenu"] == "poa" && $_SESSION['mr1'] == 1) { $classname='class="tmenusel"'; $_SESSION['idmenu']=''; }
		else $classname = 'class="tmenu"';
		$idsel='standard2';

		if (empty($noout)) print_start_menu_entry($idsel,$classname,$showmode);
		if (empty($noout)) print_text_menu_entry($langs->trans("Poa"), $showmode, DOL_URL_ROOT.'/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=1&m1=1', $id, $idsel, $classname, $atarget);
		if (empty($noout)) print_end_menu_entry($showmode);
		$menu->add('/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr=1&m1=1', $langs->trans("Standard"), 0, $showmode, $atarget, "poa", '');
	  }
	...
	if ($showmode)
	  {
		$classname="";
		if ($_SESSION["mainmenu"] && $_SESSION["mainmenu"] == "poa" && $_SESSION['mr1'] == 2) { $classname='class="tmenusel"'; $_SESSION['idmenu']=''; }
		else $classname = 'class="tmenu"';
		$idsel='vista';

		if (empty($noout)) print_start_menu_entry($idsel,$classname,$showmode);
		if (empty($noout)) print_text_menu_entry($langs->trans("Vista"), $showmode, DOL_URL_ROOT.'/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=2&m1=2', $id, $idsel, $classname, $atarget);
		if (empty($noout)) print_end_menu_entry($showmode);
		$menu->add('/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=2&m1=2', $langs->trans("Vista"), 0, $showmode, $atarget, "poa", '');
	  }
	...
	if ($showmode)
	  {
		$classname="";
		if ($_SESSION["mainmenu"] && $_SESSION["mainmenu"] == "poa" && $_SESSION['mr1'] == 3) { $classname='class="tmenusel"'; $_SESSION['idmenu']=''; }
		else $classname = 'class="tmenu"';
		$idsel='filter';

		if (empty($noout)) print_start_menu_entry($idsel,$classname,$showmode);
		if (empty($noout)) print_text_menu_entry($langs->trans("Filter"), $showmode, DOL_URL_ROOT.'/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=3&m1=3', $id, $idsel, $classname, $atarget);
		if (empty($noout)) print_end_menu_entry($showmode);
		$menu->add('/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&m1=3', $langs->trans("Filter"), 0, $showmode, $atarget, "poa", '');
	  }
	...
	if ($showmode)
	  {
		$classname="";
		if ($_SESSION["mainmenu"] && $_SESSION["mainmenu"] == "poa" && $_SESSION['mr1'] == 4) { $classname='class="tmenusel"'; $_SESSION['idmenu']=''; }
		else $classname = 'class="tmenu"';
		$idsel='review';

		if (empty($noout)) print_start_menu_entry($idsel,$classname,$showmode);
		if (empty($noout)) print_text_menu_entry($langs->trans("Review"), $showmode, DOL_URL_ROOT.'/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=4&m1=4', $id, $idsel, $classname, $atarget);
		if (empty($noout)) print_end_menu_entry($showmode);
		$menu->add('/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=4&m1=4', $langs->trans("Review"), 0, $showmode, $atarget, "poa", '');
	  }
	...
	if ($showmode)
	  {
		$classname="";
		if ($_SESSION["mainmenu"] && $_SESSION["mainmenu"] == "poa" && $_SESSION['mr1'] == 5) { $classname='class="tmenusel"'; $_SESSION['idmenu']=''; }
		else $classname = 'class="tmenu"';
		$idsel='program';

		if (empty($noout)) print_start_menu_entry($idsel,$classname,$showmode);
		if (empty($noout)) print_text_menu_entry($langs->trans("Programador"), $showmode, DOL_URL_ROOT.'/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=5&m1=5', $id, $idsel, $classname, $atarget);
		if (empty($noout)) print_end_menu_entry($showmode);
		$menu->add('/poa/poa/liste.php?dol_hide_leftmenu=1&mainmenu=poa&amp;leftmenu='.'&action=menu2&mr1=5&m1=5', $langs->trans("Programador"), 0, $showmode, $atarget, "poa", '');
	  }
