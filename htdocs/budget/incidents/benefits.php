...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'benefits', $langs->trans("Incidents"),0,'incidents');
	...
	print '<td align="right">'.$object->day_efective.'</td>';
	print '</tr>';
	...
	$incident = 0;
	if ($object->day_efective > 0)
		$incident = $aTotal['value_two'] / $object->day_efective * 100;
