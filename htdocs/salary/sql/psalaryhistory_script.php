...
/**
 *      \file       salary/psalaryhistory_script.php
 *		\ingroup    salary
...
// Examples for manipulating class psalaryhistory_class
require_once(DOL_DOCUMENT_ROOT."/../salary/psalaryhistory.class.php");
$myobject=new Psalaryhistory($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."psalaryhistory";
