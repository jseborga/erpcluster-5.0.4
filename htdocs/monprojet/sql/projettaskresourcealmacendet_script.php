...
/**
 *      \file       monprojet/projettaskresourcealmacendet_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projettaskresourcealmacendet_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projettaskresourcealmacendet.class.php");
$myobject=new Projettaskresourcealmacendet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projettaskresourcealmacendet";
