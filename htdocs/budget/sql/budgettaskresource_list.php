...
$hookmanager->initHooks(array('budgettaskresourcelist'));
...
't.fk_budget_task'=>array('label'=>$langs->trans("Fieldfk_budget_task"), 'checked'=>1),
...
't.fk_budget_task_comple'=>array('label'=>$langs->trans("Fieldfk_budget_task_comple"), 'checked'=>1),
...
't.formula'=>array('label'=>$langs->trans("Fieldformula"), 'checked'=>1),
't.formula_res'=>array('label'=>$langs->trans("Fieldformula_res"), 'checked'=>1),
't.formula_quant'=>array('label'=>$langs->trans("Fieldformula_quant"), 'checked'=>1),
't.formula_factor'=>array('label'=>$langs->trans("Fieldformula_factor"), 'checked'=>1),
't.formula_prod'=>array('label'=>$langs->trans("Fieldformula_prod"), 'checked'=>1),
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."budget_task_resource_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_fk_budget_task != '') $params.= '&amp;search_fk_budget_task='.urlencode($search_fk_budget_task);
...
if ($search_fk_budget_task_comple != '') $params.= '&amp;search_fk_budget_task_comple='.urlencode($search_fk_budget_task_comple);
...
if ($search_formula != '') $params.= '&amp;search_formula='.urlencode($search_formula);
if ($search_formula_res != '') $params.= '&amp;search_formula_res='.urlencode($search_formula_res);
if ($search_formula_quant != '') $params.= '&amp;search_formula_quant='.urlencode($search_formula_quant);
if ($search_formula_factor != '') $params.= '&amp;search_formula_factor='.urlencode($search_formula_factor);
if ($search_formula_prod != '') $params.= '&amp;search_formula_prod='.urlencode($search_formula_prod);
if ($search_status != '') $params.= '&amp;search_status='.urlencode($search_status);
    ...
    // 
if (! empty($arrayfields['t.fk_budget_task']['checked'])) print_liste_field_titre($arrayfields['t.fk_budget_task']['label'],$_SERVER['PHP_SELF'],'t.fk_budget_task','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_budget_task_comple']['checked'])) print_liste_field_titre($arrayfields['t.fk_budget_task_comple']['label'],$_SERVER['PHP_SELF'],'t.fk_budget_task_comple','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.formula']['checked'])) print_liste_field_titre($arrayfields['t.formula']['label'],$_SERVER['PHP_SELF'],'t.formula','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.formula_res']['checked'])) print_liste_field_titre($arrayfields['t.formula_res']['label'],$_SERVER['PHP_SELF'],'t.formula_res','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.formula_quant']['checked'])) print_liste_field_titre($arrayfields['t.formula_quant']['label'],$_SERVER['PHP_SELF'],'t.formula_quant','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.formula_factor']['checked'])) print_liste_field_titre($arrayfields['t.formula_factor']['label'],$_SERVER['PHP_SELF'],'t.formula_factor','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.formula_prod']['checked'])) print_liste_field_titre($arrayfields['t.formula_prod']['label'],$_SERVER['PHP_SELF'],'t.formula_prod','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.status']['checked'])) print_liste_field_titre($arrayfields['t.status']['label'],$_SERVER['PHP_SELF'],'t.status','',$params,'',$sortfield,$sortorder);
	...
	print '<tr class="liste_titre">';
	// 
if (! empty($arrayfields['t.fk_budget_task']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_budget_task" value="'.$search_fk_budget_task.'" size="10"></td>';
...
if (! empty($arrayfields['t.fk_budget_task_comple']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_budget_task_comple" value="'.$search_fk_budget_task_comple.'" size="10"></td>';
...
if (! empty($arrayfields['t.formula']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_formula" value="'.$search_formula.'" size="10"></td>';
if (! empty($arrayfields['t.formula_res']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_formula_res" value="'.$search_formula_res.'" size="10"></td>';
if (! empty($arrayfields['t.formula_quant']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_formula_quant" value="'.$search_formula_quant.'" size="10"></td>';
if (! empty($arrayfields['t.formula_factor']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_formula_factor" value="'.$search_formula_factor.'" size="10"></td>';
if (! empty($arrayfields['t.formula_prod']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_formula_prod" value="'.$search_formula_prod.'" size="10"></td>';
