...
{
	print load_fiche_titre($langs->trans("Nuevo Plan"));
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldyear_ini").'</td><td><input class="flat" type="text" name="year_ini" value="'.GETPOST('year_ini').'"></td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldyear_fin").'</td><td><input class="flat" type="text" name="year_fin" value="'.GETPOST('year_fin').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	print load_fiche_titre($langs->trans("Objetivo Institucional"));
	...
	print '<table class="border centpercent">'."\n";
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldrefpoa").'</td><td><input class="flat" type="text" name="ref" value="'.$object->ref.'"></td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldyear_ini").'</td><td><input class="flat" type="number" min="0" name="year_ini" value="'.$object->year_ini.'"></td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldyear_fin").'</td><td><input class="flat" type="number" min="0" name="year_fin" value="'.$object->year_fin.'"></td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Plan").'</td><td>';
    $doleditor = new DolEditor('label', $object->label, '', 160, 'dolibarr_details', '', false, true, $conf->global->FCKEDITOR_ENABLE_PRODUCTDESC, ROWS_4, '90%');
    $doleditor->Create();
	print '</td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpseudonym").'</td><td>';
    $doleditor = new DolEditor('pseudonym', $object->pseudonym, '', 160, 'dolibarr_details', '', false, true, $conf->global->FCKEDITOR_ENABLE_PRODUCTDESC, ROWS_4, '90%');
    $doleditor->Create();
	print '</td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	dol_fiche_head($head, 'card', $langs->trans("Planstrategic"), 0, 'poa_plan');

	//print load_fiche_titre($langs->trans("Planstrategic"));
	...
	// 
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldrefpoa").'</td><td>'.str_pad($object->ref, $conf->global->POA_CODE_SIZE_PLAN_STRATEGIC, "0", STR_PAD_LEFT).'</td></tr>';
	print '<tr><td class="fieldrequired">'.$langs->trans("Year").'</td><td>'.$object->year_ini.'-'.$object->year_fin.'</td></tr>';
