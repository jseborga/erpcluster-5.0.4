...
/**
 *   	\file       budget/puprocedure_list.php
 *		\ingroup    budget
...
dol_include_once('/budget/class/puprocedure.class.php');
...
$hookmanager->initHooks(array('puprocedurelist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."pu_procedure as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."pu_procedure_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
