...
/**
 *   	\file       codprueba/licenceslog_card.php
 *		\ingroup    codprueba
...
//$result = restrictedArea($user, 'codprueba', $id);
...
$hookmanager->initHooks(array('licenceslog'));
...
if (empty($reshook))
{
	if ($cancel) 
	{
		if ($action != 'addlink')
		{
			$urltogo=$backtopage?$backtopage:dol_buildpath('/codprueba/list.php',1);
	...
	$object->fk_licence=GETPOST('fk_licence','int');
	...
	if ($action == 'confirm_delete')
	{
		...
		if ($result > 0)
		{
			...
			header("Location: ".dol_buildpath('/codprueba/list.php',1));
			exit;
		}
		else
		{
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_licence").'</td><td><input class="flat" type="text" name="fk_licence" value="'.GETPOST('fk_licence').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_licence").'</td><td><input class="flat" type="text" name="fk_licence" value="'.$object->fk_licence.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_licence").'</td><td>$object->fk_licence</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	if (empty($reshook))
	{
		if ($user->rights->codprueba->write)
		{
			print '<div class="inline-block divButAction"><a class="butAction" href="'.$_SERVER["PHP_SELF"].'?id='.$object->id.'&amp;action=edit">'.$langs->trans("Modify").'</a></div>'."\n";
		}

		if ($user->rights->codprueba->delete)
		{
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('licenceslog'));
