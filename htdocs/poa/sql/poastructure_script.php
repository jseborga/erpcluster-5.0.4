...
/**
 *      \file       poa/poastructure_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poastructure_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poastructure.class.php");
$myobject=new Poastructure($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poastructure";
