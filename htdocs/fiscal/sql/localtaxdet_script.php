...
/**
 *      \file       fiscal/localtaxdet_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class localtaxdet_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/localtaxdet.class.php");
$myobject=new Localtaxdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."localtaxdet";
