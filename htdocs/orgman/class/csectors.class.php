...
/**
 * \file    orgman/csectors.class.php
 * \ingroup orgman
 ...
 * @see CommonObject
 */
class Csectors extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'csectors';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'c_sectors';

	/**
	 * @var CsectorsLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null,$period_year = 0)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("csectors", 1) . ")";
		}
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Clasificador Sector Económico") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Label') . ':</b> ' . $this->label;

        $url = DOL_URL_ROOT.'/orgman/sectors/'.'list.php?id='.$this->id;
