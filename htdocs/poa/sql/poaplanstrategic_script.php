...
/**
 *      \file       poa/poaplanstrategic_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poaplanstrategic_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poaplanstrategic.class.php");
$myobject=new Poaplanstrategic($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poaplanstrategic";
