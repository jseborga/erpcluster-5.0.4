		...
		if ($conf->budget->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				for ($i = 0; $i < $nblignes; $i++)
				{
					...
					pdf_writelinetask($pdf,$object,$i,$outputlangs,$this->posxpicture-$curX,3,$curX,$curY,$hideref,$hidedesc);
...
//					$objbt->fetch($object->lines[$i]->id);
//					$unit = $langs->trans($objbt->getLabelOfUnit());
