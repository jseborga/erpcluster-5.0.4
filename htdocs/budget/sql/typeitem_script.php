...
/**
 *      \file       priceunits/typeitem_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class typeitem_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/typeitem.class.php");
$myobject=new Typeitem($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."typeitem";
