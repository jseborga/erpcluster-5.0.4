 ...
 * @see CommonObject
 */
class Entity extends CommonObject
{
	/**
	 ...
	 */
	public $table_element = 'entity';

	/**
	 * @var EntityLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->visible)) {
			 $this->visible = trim($this->visible);
		}
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Company") . '</u>';
        $label.= '<div width="100%">';
        $label.= '<b>' . $langs->trans('Label') . ':</b> ' . $this->label;

        $link = '<a href="'.DOL_URL_ROOT.'/fiscal/company/card.php?id='.$this->id.'"';
