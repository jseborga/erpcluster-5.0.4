...
/**
 *  \file       dev/skeletons/projettasktimedoc.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2015-09-23 22:01
 */
...
class Projettasktimedoc extends CommonObject
{
	...
	var $element='projet_task_time_doc';			//!< Id that identify managed objects
	var $table_element='projet_task_time_doc';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->fk_task_time)) $this->fk_task_time=trim($this->fk_task_time);
		if (isset($this->document)) $this->document=trim($this->document);
		if (isset($this->unit_declared)) $this->unit_declared=trim($this->unit_declared);
    ...
    function fetch($id,$ref='')
    {
        ...
        if ($ref) $sql.= " WHERE t.fk_task_time = ".$ref;
