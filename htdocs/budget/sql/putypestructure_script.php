...
/**
 *      \file       priceunits/putypestructure_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class putypestructure_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/putypestructure.class.php");
$myobject=new Putypestructure($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."putypestructure";
