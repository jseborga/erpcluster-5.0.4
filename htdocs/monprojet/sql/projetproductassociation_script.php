...
/**
 *      \file       monprojet/projetproductassociation_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projetproductassociation_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projetproductassociation.class.php");
$myobject=new Projetproductassociation($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projetproductassociation";
