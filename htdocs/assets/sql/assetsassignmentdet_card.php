...
/**
 *   	\file       assets/assetsassignmentdet_card.php
 *		\ingroup    assets
...
$hookmanager->initHooks(array('assetsassignmentdet'));
...
if (empty($reshook))
{
	...
	$object->fk_asset_assignment=GETPOST('fk_asset_assignment','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_asset_assignment").'</td><td><input class="flat" type="text" name="fk_asset_assignment" value="'.GETPOST('fk_asset_assignment').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_asset_assignment").'</td><td><input class="flat" type="text" name="fk_asset_assignment" value="'.$object->fk_asset_assignment.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_asset_assignment").'</td><td>$object->fk_asset_assignment</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('assetsassignmentdet'));
