...
/**
 *      \file       dev/skeletons/poaactivitychecklist_script.php
 *		\ingroup    mymodule
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/poaactivitychecklist.class.php");
$myobject=new Poaactivitychecklist($db);
