...
/**
 * \file    assets/assetsmov.class.php
 * \ingroup assets
 ...
 * @see CommonObject
 */
class Assetsmov extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'assetsmov';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'assets_mov';

	/**
	 * @var AssetsmovLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null, $fk=0)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("assetsmov", 1) . ")";
		}
		if (null !== $ref && $fk>0) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
