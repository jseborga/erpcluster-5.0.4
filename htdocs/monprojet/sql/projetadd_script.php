...
/**
 *      \file       monprojet/projetadd_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projetadd_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projetadd.class.php");
$myobject=new Projetadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projetadd";
