...
if (isset($modal) && $modal == 'fichepoa')
{
	...
	$(window).load(function(){
		$("#fichepoa'.$obj->id.'").modal("show");
	});
</script>';
}
//$display = 'block';
print '<div id="fichepoa'.$obj->id.'" class="modal modal-info fade in" tabindex="-1" role="dialog" style="display: '.$display.'; margin-top:0px;" data-width="760;" aria-hidden="false">';
print '<div class="poa-modal">';
print '<div class="modal-dialog modal-lg">';
print '<div class="modal-content">';

if ($user->rights->poa->poa->mod)
{
	...
	print $objstr->select_structure($objectpoa->fk_structure,'fk_structure','',0,1);
	print '</div>';
	print '</div>';
	...
	print '<div class=" col-sm-10">';
	print '<input class="form-control" type="text" name="label" value="'.$objectpoa->label.'" >';
	print '</div>';
	print '</div>';
	...
	print '<div class=" col-sm-10">';
	print '<input class="form-control" type="text" name="pseudonym" value="'.$objectpoa->pseudonym.'">';
	print '</div>';
	print '</div>';
	...
	print '<div class=" col-sm-10">';
	print '<input class="form-control" type="text" name="partida" value="'.$objectpoa->partida.'">';
	print '</div>';
	print '</div>';
	...
	print '<div class=" col-sm-10">';
	print '<input class="form-control" type="number" min="0" step="any" name="amount" value="'.$objectpoa->amount.'">';
	print '</div>';
	print '</div>';
	...
	print '<div class=" col-sm-10">';
	print '<input class="form-control" type="text" name="version" value="'.$objectpoa->version.'">';
	print '</div>';
	print '</div>';
	...
	print '<center><input type="submit" class="btn btn-primary btn-flat" value="'.$langs->trans("Save").'"></center>';
	print '</div>';
