...
/**
 *      \file       salary/pdepartament_script.php
 *		\ingroup    salary
...
// Examples for manipulating class pdepartament_class
require_once(DOL_DOCUMENT_ROOT."/../salary/pdepartament.class.php");
$myobject=new Pdepartament($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."pdepartament";
