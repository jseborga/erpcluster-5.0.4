 ...
 */
class modSinglesess extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "Modulo de inicio de session unica";
		...
		$this->langfiles = array("singlesess@singlesess");
		...
		if (! isset($conf->singlesess) || ! isset($conf->singlesess->enabled))
        {
        	$conf->singlesess=new stdClass();
        	$conf->singlesess->enabled=0;
        }
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/singlesess/sql/');
