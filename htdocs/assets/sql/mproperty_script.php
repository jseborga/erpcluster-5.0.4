...
/**
 *      \file       assets/mproperty_script.php
 *		\ingroup    assets
...
// Examples for manipulating class mproperty_class
require_once(DOL_DOCUMENT_ROOT."/../assets/mproperty.class.php");
$myobject=new Mproperty($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."mproperty";
