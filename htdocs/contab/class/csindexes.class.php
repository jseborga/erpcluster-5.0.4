...
/**
 * \file    contab/csindexes.class.php
 * \ingroup contab
...
class Csindexes extends CommonObject
{
	 ...
	 */
	public $element = 'csindexes';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'cs_indexes';

	/**
	 * @var CsindexesLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->currency1)) {
			 $this->currency1 = trim($this->currency1);
		}
		if (isset($this->currency2)) {
			 $this->currency2 = trim($this->currency2);
		}
		if (isset($this->currency3)) {
			 $this->currency3 = trim($this->currency3);
		}
		if (isset($this->currency4)) {
			 $this->currency4 = trim($this->currency4);
		}
		if (isset($this->currency5)) {
			 $this->currency5 = trim($this->currency5);
		}
		if (isset($this->currency6)) {
			 $this->currency6 = trim($this->currency6);
		}
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new CsindexesLine();

				$line->id = $obj->rowid;
				
				$line->country = $obj->country;
				$line->date_ind = $this->db->jdate($obj->date_ind);
				$line->currency1 = $obj->currency1;
				$line->currency2 = $obj->currency2;
				$line->currency3 = $obj->currency3;
				$line->currency4 = $obj->currency4;
				$line->currency5 = $obj->currency5;
				$line->currency6 = $obj->currency6;
