...
/**
 *	\file       htdocs/fabrication/core/modules/doc/pdf_ubuntubo.modules.php
 *	\ingroup    commande
 *	\brief      Fichier de la classe permettant de generer les commandes au modele Ubuntubo
 */
 ...
 */
class pdf_ubuntubo extends ModelePDFFabrications
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "ubuntubo";
		$this->description = $langs->trans('PDFUbuntuboDescription');
