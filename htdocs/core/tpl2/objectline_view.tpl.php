...
<tr <?php echo 'id="row-'.$line->id.'" '.$bcdd[$var]; ?>>
	...
	<?php } ?>
	<?php if ($line->element != 'propaldet' && $line->element != 'supplier_proposaldet') { ?>
	...
	<td align="right" class="linecoluttc nowrap"><?php $coldisplay++; ?><?php echo price($line->pu_ttc); ?></td>
	<?php } else { ?>
	<td align="right" class="linecoluttc nowrap"><?php $coldisplay++; ?><?php echo price($line->subprice); ?></td>
	<?php } ?>
    ...
    <?php }
  	...
  	?>
  	<?php if ($this->element != 'order_supplier') { ?>
  	<?php if ($line->element != 'propaldet') { ?>
  	<?php if ($line->element != 'commandedet') { ?>
  	<?php if ($line->element != 'supplier_proposaldet') { ?>
	<td align="right" class="linecoloption nowrap"><?php $coldisplay++; ?><?php echo price($line->amount_ice); ?></td>
	<?php }}}} ?>
