...
/**
 *      \file       assets/assetscondition_script.php
 *		\ingroup    assets
...
// Examples for manipulating class assetscondition_class
require_once(DOL_DOCUMENT_ROOT."/../assets/assetscondition.class.php");
$myobject=new Assetscondition($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assetscondition";
