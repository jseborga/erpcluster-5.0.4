...
$arrayfields=array(
	...
	'p.ref'=>array('label'=>$langs->trans("Fieldrefpoa"), 'checked'=>1),
...
$objectdet=new Partidaproduct($db);
...
while ($i < min($num, $limit))
{
	...
	if ($obj)
	{
		...
		{
			print '<a href="'.$_SERVER['PHP_SELF'].'?id='.$id.'&idr='.$obj->rowid.'&action=deleteprod">'.img_picto('','delete').'</a>';
		}
		print '</td>';
		if (! $i) $totalarray['nbfield']++;
