...
/**
 * \file    assets/mpropertyuser.class.php
 * \ingroup assets
 ...
 * @see CommonObject
 */
class Mpropertyuser extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'mpropertyuser';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_property_user';

	/**
	 * @var MpropertyuserLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Mpropertyuser($this->db);
