...
/**
 *   	\file       assets/mproperty_list.php
 *		\ingroup    assets
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-09-20 10:11
 */
...
dol_include_once('/assets/class/mproperty.class.php');
...
$hookmanager->initHooks(array('mpropertylist'));
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."m_property_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_fk_state != '') $params.= '&amp;search_fk_state='.urlencode($search_fk_state);
