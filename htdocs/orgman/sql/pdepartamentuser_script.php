...
/**
 *      \file       orgman/pdepartamentuser_script.php
 *		\ingroup    orgman
...
// Examples for manipulating class pdepartamentuser_class
require_once(DOL_DOCUMENT_ROOT."/../orgman/pdepartamentuser.class.php");
$myobject=new Pdepartamentuser($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."pdepartamentuser";
