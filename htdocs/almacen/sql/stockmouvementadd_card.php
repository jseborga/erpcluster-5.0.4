...
/**
 *   	\file       almacen/stockmouvementadd_card.php
 *		\ingroup    almacen
...
$hookmanager->initHooks(array('stockmouvementadd'));
...
if (empty($reshook))
{
	...
	$object->fk_stock_mouvement_doc=GETPOST('fk_stock_mouvement_doc','int');
	...
	$object->value_peps=GETPOST('value_peps','alpha');
	$object->value_ueps=GETPOST('value_ueps','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_stock_mouvement_doc").'</td><td><input class="flat" type="text" name="fk_stock_mouvement_doc" value="'.GETPOST('fk_stock_mouvement_doc').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_peps").'</td><td><input class="flat" type="text" name="value_peps" value="'.GETPOST('value_peps').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_ueps").'</td><td><input class="flat" type="text" name="value_ueps" value="'.GETPOST('value_ueps').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_stock_mouvement_doc").'</td><td><input class="flat" type="text" name="fk_stock_mouvement_doc" value="'.$object->fk_stock_mouvement_doc.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_peps").'</td><td><input class="flat" type="text" name="value_peps" value="'.$object->value_peps.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_ueps").'</td><td><input class="flat" type="text" name="value_ueps" value="'.$object->value_ueps.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_stock_mouvement_doc").'</td><td>$object->fk_stock_mouvement_doc</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_peps").'</td><td>$object->value_peps</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldvalue_ueps").'</td><td>$object->value_ueps</td></tr>';
