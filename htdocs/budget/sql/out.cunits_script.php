...
/**
 *      \file       dev/skeletons/cunits_script.php
 *		\ingroup    mymodule
 *      \brief      This file is an example for a command line script
 *					Initialy built by build_class_from_table on 2015-11-03 11:50
 */
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/cunits.class.php");
$myobject=new Cunits($db);
