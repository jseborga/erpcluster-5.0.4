...
/**
 *      \file       fiscal/vdosing_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class vdosing_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/vdosing.class.php");
$myobject=new Vdosing($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."vdosing";
