...
$fk_budget = GETPOST('fk_budget', 'int');
...
$filterstatic = GETPOST('filterstatic', 'alpha');
...
else 
{
	...
	$arrayresult = $form->select_produits_list_projet($fk_budget,"", $htmlname, $type, "", $price_level, $searchkey, $status, 2, $outjson, $socid,$filterstatic,$fk_entrepot);
	//} elseif ($mode == 2) {
