...
/**
 *      \file       monprojet/projettaskresource_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projettaskresource_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projettaskresource.class.php");
$myobject=new Projettaskresource($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projettaskresource";
