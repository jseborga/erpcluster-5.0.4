...
if (!$user->rights->salary->formula->lire)
  accessforbidden();
...
$sql.= " FROM ".MAIN_DB_PREFIX."p_formulas as p ";
...
if ($result)
{
	...
	print_barre_liste($langs->trans("Liste formulas"), $page, "liste.php", "", $sortfield, $sortorder,'',$num);
	  ...
	  while ($i < min($num,$limit))
	    {
	      ...
	      $var=!$var;
	      print "<tr $bc[$var]>";
	      print '<td><a href="fiche.php?id='.$obj->id.'">'.img_picto($langs->trans("Ref"),DOL_URL_ROOT.'/salary/img/formula','',1).' '.$obj->ref.'</a></td>';
