...
$WS_DOL_URL = DOL_MAIN_URL_ROOT.'/wsfractal/server_userlog.php';
...
if ($res==1) $nameservice = 'createUserlog';
if ($nameservice == 'createUserlog') $WS_METHOD0 = 'createUserlog';
