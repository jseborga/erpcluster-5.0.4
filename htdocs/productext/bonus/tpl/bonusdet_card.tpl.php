...
/**
 *   	\file       productext/bonusdet_card.php
 *		\ingroup    productext
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2018-03-21 17:43
 */
...
dol_include_once('/productext/class/bonusdet.class.php');
...
$search_fk_bonus=GETPOST('search_fk_bonus','int');
...
$hookmanager->initHooks(array('bonusdet'));
...
if (empty($reshook))
{
	...
	$object->fk_bonus=GETPOST('fk_bonus','int');
	$object->fk_product=GETPOST('fk_product','int');
	$object->saleprice=GETPOST('saleprice','alpha');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_bonus").'</td><td><input class="flat" type="text" name="fk_bonus" value="'.GETPOST('fk_bonus').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsaleprice").'</td><td><input class="flat" type="text" name="saleprice" value="'.GETPOST('saleprice').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_bonus").'</td><td><input class="flat" type="text" name="fk_bonus" value="'.$object->fk_bonus.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsaleprice").'</td><td><input class="flat" type="text" name="saleprice" value="'.$object->saleprice.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_bonus").'</td><td>'.$object->fk_bonus.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_product").'</td><td>'.$object->fk_product.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsaleprice").'</td><td>'.$object->saleprice.'</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>'.$object->status.'</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('bonusdet'));
