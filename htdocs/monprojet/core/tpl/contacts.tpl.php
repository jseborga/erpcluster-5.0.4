...
elseif ($module == 'project')		{ $permission=$user->rights->monprojet->proc->crear; }
elseif ($module == 'action')		{ $permission=$user->rights->agenda->myactions->create; }
elseif ($module == 'shipping')		{ $permission=$user->rights->expedition->creer; }
elseif ($module == 'project_task')	{ $permission=$user->rights->monprojet->prot->crear; }
...
<?php
	if (is_object($hookmanager))
	{
		...
		$parameters=array('permission'=>$permission,'hideaddcontactforuser'=>$hideaddcontactforuser,'hideaddcontactforthirdparty'=>$hideaddcontactforthirdparty,'objectelement'=>'resource');
