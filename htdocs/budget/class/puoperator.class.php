...
/**
 * \file    budget/puoperator.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Puoperator extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'puoperator';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'pu_operator';

	/**
	 * @var PuoperatorLine[] Lines
	 */
	public $lines = array();
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new PuoperatorLine();

				$line->id = $obj->rowid;
				
				$line->detail = $obj->detail;
				$line->operator = $obj->operator;
				$line->type = $obj->type;
