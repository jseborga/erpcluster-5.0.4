...
't.code_partida'=>array('label'=>$langs->trans("Fieldcode_partida"), 'checked'=>1),
...
$search_active='';
    ...
    $permtoread = $user->rights->partidaproduct->read;
    $permtodelete = $user->rights->partidaproduct->delete;
    $uploaddir = $conf->partidaproduct->dir_output;
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/partidaproduct/card.php?id='.$id);
    exit;
}
