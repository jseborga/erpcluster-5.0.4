 ...
 */
class Guarantees extends CommonObject
{
	/**
	 * @var string Error code (or message)
	 * @deprecated
	 * @see Guarantees::errors
	 */
	public $error;
	/**
	 ...
	 */
	public $element = 'guarantees';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'guarantees';

	/**
	 * @var GuaranteesLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->code_guarantee)) {
			 $this->code_guarantee = trim($this->code_guarantee);
		}
		if (isset($this->ref)) {
			 $this->ref = trim($this->ref);
		}
		if (isset($this->issuer)) {
			 $this->issuer = trim($this->issuer);
		}
