...
/**
 *      \file       fiscal/ctypetvadet_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class ctypetvadet_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/ctypetvadet.class.php");
$myobject=new Ctypetvadet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."ctypetvadet";
