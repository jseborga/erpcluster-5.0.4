...
/**
 *   	\file       poa/poapartidapredet_card.php
 *		\ingroup    poa
...
$hookmanager->initHooks(array('poapartidapredet'));
...
if (empty($reshook))
{
	...
	$object->fk_poa_partida_pre=GETPOST('fk_poa_partida_pre','int');
	...
	$object->quant_adj=GETPOST('quant_adj','alpha');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_partida_pre").'</td><td><input class="flat" type="text" name="fk_poa_partida_pre" value="'.GETPOST('fk_poa_partida_pre').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldquant_adj").'</td><td><input class="flat" type="text" name="quant_adj" value="'.GETPOST('quant_adj').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_partida_pre").'</td><td><input class="flat" type="text" name="fk_poa_partida_pre" value="'.$object->fk_poa_partida_pre.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldquant_adj").'</td><td><input class="flat" type="text" name="quant_adj" value="'.$object->quant_adj.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_partida_pre").'</td><td>$object->fk_poa_partida_pre</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldquant_adj").'</td><td>$object->quant_adj</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('poapartidapredet'));
