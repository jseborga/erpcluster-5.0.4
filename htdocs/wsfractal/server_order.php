...
function createOrder($authentication,$order)
{
	...
	if (! $error)
	{
		...
		$newobject->statut=Commandeext::STATUS_DRAFT;	// We start with status draft
		...
		$result=$newobject->createadd($fuser);
