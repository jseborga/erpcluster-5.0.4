...
/**
 * \file    budget/puprocedure.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Puprocedure extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'puprocedure';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'pu_procedure';

	/**
	 * @var PuprocedureLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Puprocedure($this->db);
