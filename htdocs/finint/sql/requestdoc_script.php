...
/**
 *      \file       finint/requestdoc_script.php
 *		\ingroup    finint
...
// Examples for manipulating class requestdoc_class
require_once(DOL_DOCUMENT_ROOT."/../finint/requestdoc.class.php");
$myobject=new Requestdoc($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."requestdoc";
