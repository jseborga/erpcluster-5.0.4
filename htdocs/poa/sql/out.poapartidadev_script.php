...
/**
 *      \file       poa/poapartidadev_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poapartidadev_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poapartidadev.class.php");
$myobject=new Poapartidadev($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poapartidadev";
