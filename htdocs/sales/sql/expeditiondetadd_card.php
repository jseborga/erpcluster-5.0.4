...
/**
 *   	\file       sales/expeditiondetadd_card.php
 *		\ingroup    sales
...
$hookmanager->initHooks(array('expeditiondetadd'));
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_expeditiondet").'</td><td><input class="flat" type="text" name="fk_expeditiondet" value="'.GETPOST('fk_expeditiondet').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_expeditiondet").'</td><td><input class="flat" type="text" name="fk_expeditiondet" value="'.$object->fk_expeditiondet.'"></td></tr>';
...
if ($id && (empty($action) || $action == 'view' || $action == 'delete'))
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_expeditiondet").'</td><td>$object->fk_expeditiondet</td></tr>';
