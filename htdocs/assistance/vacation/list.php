 ...
 *					Initialy built by build_class_from_table on 2017-09-19 10:29
 */
...
$search_status='';
    ...
    $permtoread = $user->rights->membervacation->read;
    $permtodelete = $user->rights->membervacation->delete;
    $uploaddir = $conf->membervacation->dir_output;
