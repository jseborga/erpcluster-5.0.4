...
if (!$user->admin)
  {
    $arrayroles = $taskstatic->getUserRolesForProjectsOrTasks('',$user,'',0);
    foreach((array) $arrayroles AS $fk_task => $ob)
      {
	if ($idtask) $idtask.= ',';
	$idtask.= $fk_task;
      }
...
$tasksarray=$taskadd->getTasksArray(0, $user, $projectstatic->id, $socid, 0, $search_project, $search_status, $morewherefilter, $search_project_user, $search_task_user);
