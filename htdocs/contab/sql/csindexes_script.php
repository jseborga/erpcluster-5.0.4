...
/**
 *      \file       contab/csindexes_script.php
 *		\ingroup    contab
...
// Examples for manipulating class csindexes_class
require_once(DOL_DOCUMENT_ROOT."/../contab/csindexes.class.php");
$myobject=new Csindexes($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."csindexes";
