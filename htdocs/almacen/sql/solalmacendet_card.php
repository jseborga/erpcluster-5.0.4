...
/**
 *   	\file       almacen/solalmacendet_card.php
 *		\ingroup    almacen
...
$hookmanager->initHooks(array('solalmacendet'));
...
if (empty($reshook))
{
	...
	$object->fk_almacen=GETPOST('fk_almacen','int');
	...
	$object->qty_livree=GETPOST('qty_livree','alpha');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_almacen").'</td><td><input class="flat" type="text" name="fk_almacen" value="'.GETPOST('fk_almacen').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldqty_livree").'</td><td><input class="flat" type="text" name="qty_livree" value="'.GETPOST('qty_livree').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_almacen").'</td><td><input class="flat" type="text" name="fk_almacen" value="'.$object->fk_almacen.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldqty_livree").'</td><td><input class="flat" type="text" name="qty_livree" value="'.$object->qty_livree.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_almacen").'</td><td>$object->fk_almacen</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldqty_livree").'</td><td>$object->qty_livree</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('solalmacendet'));
