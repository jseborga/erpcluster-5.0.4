...
$contextpage=GETPOST('contextpage','aZ')?GETPOST('contextpage','aZ'):'productbudgetlist';
...
$arrayfields=array(
	...
	't.units'=>array('label'=>$langs->trans("Fieldunits"), 'align'=>'align="left"', 'checked'=>1),
	't.commander'=>array('label'=>$langs->trans("Fieldcommander"), 'align'=>'align="left"', 'checked'=>1),
	't.price_productive'=>array('label'=>$langs->trans("Fieldprice_productive"), 'align'=>'align="left"', 'checked'=>1),
	't.price_improductive'=>array('label'=>$langs->trans("Fieldprice_improductive"), 'align'=>'align="left"', 'checked'=>1),
	...
	't.percent_prod'=>array('label'=>$langs->trans("Fieldpercent_prod"), 'align'=>'align="left"', 'checked'=>1),
	't.amount_noprod'=>array('label'=>$langs->trans("Fieldamount_noprod"), 'align'=>'align="left"', 'checked'=>1),
...
$head = productbudget_prepare_head($objectdet, $user, $array);
$titre=$langs->trans("Productbudget");
$picto='budget';
$getcard='supplies';
		...
		foreach ($arrayfields as $key => $value) {
			if (!empty($arrayfields[$key]['checked'])) {
				...
				if ($key2 == 'status')
				{
					...
					$obj->$key2 = $objProductbudget->getLibStatut(3);
				}
