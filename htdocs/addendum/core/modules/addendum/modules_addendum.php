...
/**
 *  \file			./contratadd/core/modules/modules_fabrication.php
 *  \ingroup		fabrication
 ...
 */
abstract class ModelePDFAddendum extends CommonDocGenerator
{
	var $error='';
 ...
 *	Classe mere des modeles de commandes
 */
abstract class ModeleAddendum extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleNumRefAddendum
{
	var $error='';
