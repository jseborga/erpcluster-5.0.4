...
/**
 *      \file       codprueba/licenceslog_script.php
 *		\ingroup    codprueba
...
// Examples for manipulating class licenceslog_class
require_once(DOL_DOCUMENT_ROOT."/../codprueba/licenceslog.class.php");
$myobject=new Licenceslog($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."licenceslog";
