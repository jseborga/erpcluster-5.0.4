...
/**
 *   	\file       monprojet/projettaskresourcealmacendet_card.php
 *		\ingroup    monprojet
...
$hookmanager->initHooks(array('projettaskresourcealmacendet'));
...
if (empty($reshook))
{
	...
	$object->fk_projet_task_resource=GETPOST('fk_projet_task_resource','int');
	$object->fk_sol_almacen_det=GETPOST('fk_sol_almacen_det','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_task_resource").'</td><td><input class="flat" type="text" name="fk_projet_task_resource" value="'.GETPOST('fk_projet_task_resource').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_sol_almacen_det").'</td><td><input class="flat" type="text" name="fk_sol_almacen_det" value="'.GETPOST('fk_sol_almacen_det').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_task_resource").'</td><td><input class="flat" type="text" name="fk_projet_task_resource" value="'.$object->fk_projet_task_resource.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_sol_almacen_det").'</td><td><input class="flat" type="text" name="fk_sol_almacen_det" value="'.$object->fk_sol_almacen_det.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_task_resource").'</td><td>$object->fk_projet_task_resource</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_sol_almacen_det").'</td><td>$object->fk_sol_almacen_det</td></tr>';
