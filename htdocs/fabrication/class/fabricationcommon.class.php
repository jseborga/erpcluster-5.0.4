...
class FabricationCommon extends Fabrication
{
   ...
   *  Sin DESCUENTO
	*/
	function formAddPredefinedProduct_sd($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
	{
		...
		include(DOL_DOCUMENT_ROOT.'/fabrication/tpl/predefinedproductline_create_sd.tpl.php');
	}
	...
	function formAddPredefinedProductSon($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
	{
		...
		if (!empty($id))
			$this->id = $id;
	// Use global variables + $dateSelector + $seller and $buyer
		include(DOL_DOCUMENT_ROOT.'/fabrication/tpl/predefinedproductline_create_son.tpl.php');
	}
	/* This is to show add lines */
	...
	function formAddPredefinedProduct_lm($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
	{
		...
		if (!empty($id))
			$this->id = $id;
	// Use global variables + $dateSelector + $seller and $buyer
		include(DOL_DOCUMENT_ROOT.'/fabrication/tpl/predefinedproductline_create_lm.tpl.php');
	}
  ...
  function formAddPredefinedProductAlt($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
  {
  	...
  	if (!empty($id))
  		$this->id = $id;
	// Use global variables + $dateSelector + $seller and $buyer
  	include(DOL_DOCUMENT_ROOT.'/fabrication/tpl/predefinedproductline_create_alt.tpl.php');
  }
