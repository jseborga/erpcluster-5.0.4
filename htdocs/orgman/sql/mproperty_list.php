...
't.fk_state'=>array('label'=>$langs->trans("Fieldfk_state"), 'checked'=>1),
...
if (! empty($arrayfields['t.fk_state']['checked'])) print_liste_field_titre($arrayfields['t.fk_state']['label'],$_SERVER['PHP_SELF'],'t.fk_state','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_state']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_state" value="'.$search_fk_state.'" size="10"></td>';
