...
/**
 *      \file       purchase/supplierproposaladd_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class supplierproposaladd_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/supplierproposaladd.class.php");
$myobject=new Supplierproposaladd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."supplierproposaladd";
