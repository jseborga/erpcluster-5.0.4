...
/**
 *      \file       poa/cnameobjetive_script.php
 *		\ingroup    poa
...
// Examples for manipulating class cnameobjetive_class
require_once(DOL_DOCUMENT_ROOT."/../poa/cnameobjetive.class.php");
$myobject=new Cnameobjetive($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cnameobjetive";
