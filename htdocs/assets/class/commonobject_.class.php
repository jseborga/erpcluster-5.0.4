...
abstract class CommonObject_
{
     ...
     *  Sin DESCUENTO
     */
function formAddPredefinedAsset($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
{
  ...
  include(DOL_DOCUMENT_ROOT.'/assets/core/tpl/predefinedassetline_create.tpl.php');
}
