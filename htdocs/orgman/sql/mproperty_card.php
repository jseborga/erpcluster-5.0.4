...
/**
 *   	\file       orgman/mproperty_card.php
 *		\ingroup    orgman
...
$hookmanager->initHooks(array('mproperty'));
...
if (empty($reshook))
{
	...
	$object->fk_state=GETPOST('fk_state','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_state").'</td><td><input class="flat" type="text" name="fk_state" value="'.GETPOST('fk_state').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_state").'</td><td><input class="flat" type="text" name="fk_state" value="'.$object->fk_state.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_state").'</td><td>$object->fk_state</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('mproperty'));
