...
/**
 *   	\file       poa/poapartidapre_list.php
 *		\ingroup    poa
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-04-04 09:24
 */
...
dol_include_once('/poa/class/poapartidapre.class.php');
...
$search_active='';
    ...
    $permtoread = $user->rights->poapartidapre->read;
    $permtodelete = $user->rights->poapartidapre->delete;
    $uploaddir = $conf->poapartidapre->dir_output;
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."poa_partida_pre_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/poapartidapre/card.php?id='.$id);
    exit;
}
