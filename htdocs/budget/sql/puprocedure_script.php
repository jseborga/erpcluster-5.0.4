...
/**
 *      \file       priceunits/puprocedure_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class puprocedure_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/puprocedure.class.php");
$myobject=new Puprocedure($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."puprocedure";
