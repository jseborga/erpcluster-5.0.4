...
/**
 *   	\file       contab/contabspendingaccount_list.php
 *		\ingroup    contab
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-11-04 15:05
 */
...
dol_include_once('/contab/class/contabspendingaccount.class.php');
...
$hookmanager->initHooks(array('contabspendingaccountlist'));
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."contab_spending_account_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
