 ...
 *				Initialy built by build_class_from_table on 2014-07-21 10:17
 */
...
class Mworkrequest extends CommonObject
{
	...
	var $element='mworkrequest';			//!< Id that identify managed objects
	var $table_element='mworkrequest';		//!< Name of table without prefix where object is stored
