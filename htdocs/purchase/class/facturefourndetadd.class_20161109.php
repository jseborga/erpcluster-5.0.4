...
/**
 * \file    purchase/facturefourndetadd.class.php
 * \ingroup purchase
...
/**
 * Class Facturefourndetadd
 *
 * Put here description of your class
 * @see CommonObject
 */
class Facturefourndetadd extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'facturefourndetadd';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'facture_fourn_det_add';

	/**
	 * @var FacturefourndetaddLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (null !== $ref) {
			$sql .= ' WHERE t.fk_facture_fourn_det = ' . $ref;
		} else {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new FacturefourndetaddLine();
				...
				if ($lView)
				{
					...
					{
						$this->errors[] = 'Error ' . $langs->trans('Existe varios registros');
						dol_syslog(__METHOD__ . ' ' . join(',', $this->errors), LOG_ERR);
						return ($num * -1);
					}
				}
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Facturefourndetadd($this->db);
