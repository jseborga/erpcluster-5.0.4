...
/**
 * \file    salary/cregions.class.php
 * \ingroup salary
 ...
 * @see CommonObject
 */
class Cregions extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'cregions';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'c_regions';

	/**
	 * @var CregionsLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		$sql .= ' '.(! isset($this->code_region)?'NULL':$this->code_region).',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("cregions", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.code_region = ' . $ref;
		} else {
			$sql .= ' AND t.rowid = ' . $id;
		}
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND', $filterstatic='', $lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new CregionsLine();

				$line->id = $obj->rowid;

				$line->code_region = $obj->code_region;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' code_region = '.(isset($this->code_region)?$this->code_region:"null").',';
