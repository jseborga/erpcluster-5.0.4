 ...
 */
class modWsFractal extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 603000;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'wsfractal';
		...
		$this->description = "Web service Fractal";
		...
		$this->config_page_url = array("mysetuppage.php@wsfractal");
		...
		$this->langfiles = array("mylangfile@wsfractal");
		...
		if (! isset($conf->wsfractal) || ! isset($conf->wsfractal->enabled))
        {
        	$conf->wsfractal=new stdClass();
        	$conf->wsfractal->enabled=0;
        }
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/wsfractal/sql/');
