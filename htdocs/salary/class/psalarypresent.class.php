...
/**
 * \file    salary/psalarypresent.class.php
 * \ingroup salary
...
class Psalarypresent extends CommonObject
{
	 ...
	 */
	public $element = 'psalarypresent';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'p_salary_present';

	/**
	 * @var PsalarypresentLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("psalarypresent", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
