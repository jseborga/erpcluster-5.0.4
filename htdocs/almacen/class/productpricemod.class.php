...
/**
 * \file    almacen/productpricemod.class.php
 * \ingroup almacen
...
/**
 * Class Productpricemod
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Productpricemod extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'productpricemod';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'product_pricemod';

	/**
	 * @var ProductpricemodLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->price_new)) {
			 $this->price_new = trim($this->price_new);
		}
		...
		$sql .= ' '.(! isset($this->price_new)?'NULL':"'".$this->price_new."'").',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("productpricemod", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' price_new = '.(isset($this->price_new)?$this->price_new:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Productpricemod($this->db);
