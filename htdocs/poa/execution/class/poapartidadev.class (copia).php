 ...
 *				Initialy built by build_class_from_table on 2014-04-14 10:38
 */
...
class Poapartidadev extends CommonObject
{
	...
	var $element='poapartidadev';			//!< Id that identify managed objects
	var $table_element='poapartidadev';		//!< Name of table without prefix where object is stored
