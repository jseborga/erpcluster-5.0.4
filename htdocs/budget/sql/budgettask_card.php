...
/**
 *   	\file       priceunits/budgettask_card.php
 *		\ingroup    priceunits
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_task_parent").'</td><td>$object->fk_task_parent</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldduration_effective").'</td><td>$object->duration_effective</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldplanned_workload").'</td><td>$object->planned_workload</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprogress").'</td><td>$object->progress</td></tr>';
