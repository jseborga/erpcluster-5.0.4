 ...
 *				Initialy built by build_class_from_table on 2014-03-31 15:38
 */
  /*
   Modificacion al standard
   Se modifico la funcion FETCH para busqueda por campo REF
   */
...
class Poaarea extends CommonObject
{
	...
	if (empty($id) && empty($ref))
	  {
      	    $this->error="Error ".$langs->trans('Variablenotdefined');
     ...
     */
	function select_area($selected='',$htmlname='fk_father',$htmloption='',$maxlength=0,$showempty=0,$id=0,$required='',$filterarray='')
    {
        global $conf,$langs;
