...
if (empty($reshook))
{
	if ($cancel) 
	{
		if ($action != 'addlink')
		{
			$urltogo=$backtopage?$backtopage:dol_buildpath('/poa/config/listobj.php',1);
	...
	if ($action == 'confirm_delete')
	{
		...
		if ($result > 0)
		{
			...
			header("Location: ".dol_buildpath('/poa/config/listobj.php',1));
			exit;
		}
		else
		{
...
$help_url='';
$title = $langs->trans('Nameobjetive');
...
$sql.= " FROM ".MAIN_DB_PREFIX."c_name_objetive as t";
