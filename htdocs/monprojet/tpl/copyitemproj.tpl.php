...
//grupos del proyecto
//armamos los grupos del presupuesto segun permisos del usuario

$head = monprojetgroup_prepare_head($object,1);
...
//{
	...
	print '<input type="hidden" name="action" value="copyitem">';
...
if ($tag == '1' && $seltype)
{
	...
	if ($tag == 1)
	{
		...
		print '<input type="hidden" name="action" value="selitem">';
		print '<input type="hidden" name="tag" value="1">';
		print '<input type="hidden" name="backtopage" value="'.$backtopage.'">';
		print '<input type="hidden" name="id" value="'.$object->id.'">';
		print '<input type="hidden" name="seltype" value="'.$seltype.'">';
	...
	*/
	...
	$idscat = $conf->global->PRICEUNITS_CODE_ITEM_DEF;
	if ($seltype == 1)
	{
		if ($search)
		{
	...
	{
		print '<form method="POST" id="FrmSelectAllChecbox" name="FrmSelectAllChecbox" action="'.$_SERVER["PHP_SELF"].'">';
		print '<input type="hidden" name="action" value="delitem">';
		print '<input type="hidden" name="tag" value="1">';
		print '<input type="hidden" name="backtopage" value="'.$backtopage.'">';
		print '<input type="hidden" name="id" value="'.$object->id.'">';
		print '<input type="hidden" name="seltype" value="'.$seltype.'">';
	...
	{
		print '<div>';
		print '<center><br><input type="submit" class="button" name="delitem" value="'.$langs->trans("Delete").'">&nbsp;<input type="submit" class="button" name="saveitem" value="'.$langs->trans("Save").'"></center>';
		print '</div>';
		print '</form>';
	}
	print '</div>';
