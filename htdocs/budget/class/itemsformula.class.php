...
/**
 * \file    budget/itemsformula.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Itemsformula extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'itemsformula';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'items_formula';

	/**
	 * @var ItemsformulaLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_pu_structure)) {
			 $this->fk_pu_structure = trim($this->fk_pu_structure);
		}
		...
		if (isset($this->date_create)) {
			 $this->date_create = trim($this->date_create);
		}
		if (isset($this->date_mod)) {
			 $this->date_mod = trim($this->date_mod);
		}
		...
		$sql .= ' '.(! isset($this->fk_pu_structure)?'NULL':$this->fk_pu_structure).',';
		...
		$sql .= ' '.$user->id.',';
		$sql .= ' '.(! isset($this->date_create)?'NULL':$this->date_create).',';
		$sql .= ' '.(! isset($this->date_mod)?'NULL':$this->date_mod).',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->fk_pu_structure = $obj->fk_pu_structure;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ItemsformulaLine();

				$line->id = $obj->rowid;
				
				$line->fk_budget = $obj->fk_budget;
				$line->fk_pu_structure = $obj->fk_pu_structure;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' fk_pu_structure = '.(isset($this->fk_pu_structure)?$this->fk_pu_structure:"null").',';
		...
		$sql .= ' date_create = '.(isset($this->date_create)?$this->date_create:"null").',';
		$sql .= ' date_mod = '.(isset($this->date_mod)?$this->date_mod:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Itemsformula($this->db);
