...
/**
 *      \file       advancepayment/paiementfournadvance_script.php
...
// Examples for manipulating class paiementfournadvance_class
require_once(DOL_DOCUMENT_ROOT."/../advancepayment/paiementfournadvance.class.php");
$myobject=new Paiementfournadvance($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."paiementfournadvance";
