...
/**
 *   	\file       almacen/entrepotrelation_card.php
 *		\ingroup    almacen
...
$hookmanager->initHooks(array('entrepotrelation'));
...
if (empty($reshook))
{
	...
	$object->fk_entrepot_father=GETPOST('fk_entrepot_father','int');
	$object->fk_projet=GETPOST('fk_projet','int');
	$object->tipo=GETPOST('tipo','alpha');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepot_father").'</td><td><input class="flat" type="text" name="fk_entrepot_father" value="'.GETPOST('fk_entrepot_father').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtipo").'</td><td><input class="flat" type="text" name="tipo" value="'.GETPOST('tipo').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepot_father").'</td><td><input class="flat" type="text" name="fk_entrepot_father" value="'.$object->fk_entrepot_father.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtipo").'</td><td><input class="flat" type="text" name="tipo" value="'.$object->tipo.'"></td></tr>';
...
if ($id && (empty($action) || $action == 'view' || $action == 'delete'))
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepot_father").'</td><td>$object->fk_entrepot_father</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet").'</td><td>$object->fk_projet</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtipo").'</td><td>$object->tipo</td></tr>';
