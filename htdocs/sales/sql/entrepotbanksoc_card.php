...
/**
 *   	\file       sales/entrepotbanksoc_card.php
 *		\ingroup    sales
...
$hookmanager->initHooks(array('entrepotbanksoc'));
...
if (empty($reshook))
{
	...
	$object->numero_ip=GETPOST('numero_ip','alpha');
	...
	$object->fk_bankid=GETPOST('fk_bankid','int');
	$object->fk_banktcid=GETPOST('fk_banktcid','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnumero_ip").'</td><td><input class="flat" type="text" name="numero_ip" value="'.GETPOST('numero_ip').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepotid").'</td><td><input class="flat" type="text" name="fk_entrepotid" value="'.GETPOST('fk_entrepotid').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_socid").'</td><td><input class="flat" type="text" name="fk_socid" value="'.GETPOST('fk_socid').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_cajaid").'</td><td><input class="flat" type="text" name="fk_cajaid" value="'.GETPOST('fk_cajaid').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_bankid").'</td><td><input class="flat" type="text" name="fk_bankid" value="'.GETPOST('fk_bankid').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_banktcid").'</td><td><input class="flat" type="text" name="fk_banktcid" value="'.GETPOST('fk_banktcid').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnumero_ip").'</td><td><input class="flat" type="text" name="numero_ip" value="'.$object->numero_ip.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepotid").'</td><td><input class="flat" type="text" name="fk_entrepotid" value="'.$object->fk_entrepotid.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_socid").'</td><td><input class="flat" type="text" name="fk_socid" value="'.$object->fk_socid.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_cajaid").'</td><td><input class="flat" type="text" name="fk_cajaid" value="'.$object->fk_cajaid.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_bankid").'</td><td><input class="flat" type="text" name="fk_bankid" value="'.$object->fk_bankid.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_banktcid").'</td><td><input class="flat" type="text" name="fk_banktcid" value="'.$object->fk_banktcid.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnumero_ip").'</td><td>$object->numero_ip</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user").'</td><td>$object->fk_user</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepotid").'</td><td>$object->fk_entrepotid</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_socid").'</td><td>$object->fk_socid</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_cajaid").'</td><td>$object->fk_cajaid</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_bankid").'</td><td>$object->fk_bankid</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_banktcid").'</td><td>$object->fk_banktcid</td></tr>';
