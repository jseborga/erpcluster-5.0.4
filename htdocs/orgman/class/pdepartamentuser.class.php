...
/**
 * \file    orgman/pdepartamentuser.class.php
 * \ingroup orgman
...
/**
 * Class Pdepartamentuser
 *
 * Put here description of your class
 * @see CommonObject
 */
class Pdepartamentuser extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'pdepartamentuser';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'p_departament_user';

	/**
	 * @var PdepartamentuserLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Pdepartamentuser($this->db);
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $link = '<a href="'.DOL_URL_ROOT.'/orgman/card.php?id='.$this->id.'"';
