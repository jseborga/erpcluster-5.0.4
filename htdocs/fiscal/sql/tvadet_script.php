...
// Examples for manipulating class tvadet_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/tvadet.class.php");
$myobject=new Tvadet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."tvadet";
