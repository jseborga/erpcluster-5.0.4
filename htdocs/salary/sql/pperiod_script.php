...
/**
 *      \file       salary/pperiod_script.php
 *		\ingroup    salary
...
// Examples for manipulating class pperiod_class
require_once(DOL_DOCUMENT_ROOT."/../salary/pperiod.class.php");
$myobject=new Pperiod($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."pperiod";
