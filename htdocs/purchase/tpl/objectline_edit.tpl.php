...
<tr <?php echo $bc[$var]; ?>>
	...
	<td align="right"><?php $coldisplay++; ?><input type="number"  min="0.00001" step="any" class="flat len80" size="8" id="price_ttc" name="price_ttc" value="<?php echo price2num($line->pu_ttc,'MS'); ?>"></td>
	<?php } ?>
	...
	<td align="right" nowrap><?php $coldisplay++; ?>
	<?php if (($line->info_bits & 2) != 2) { ?>
		<input size="1" type="text" class="flat" name="remise_percent" id="remise_percent" value="<?php echo $line->remise_percent; ?>">% <input size="5" type="text" class="flat" name="discount" id="discount" value="<?php echo $line->discount; ?>">
	<?php } else { ?>
		&nbsp;
	<?php } ?>
	</td>
	<?php if ($object->element == 'invoice_supplier') { ?>
