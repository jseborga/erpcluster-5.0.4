...
/**
 *   	\file       productext/bonusdet_list.php
 *		\ingroup    productext
...
't.fk_bonus'=>array('label'=>$langs->trans("Fieldfk_bonus"), 'align'=>'align="left"', 'checked'=>0),
't.fk_product'=>array('label'=>$langs->trans("Fieldfk_product"), 'align'=>'align="left"', 'checked'=>1),
't.saleprice'=>array('label'=>$langs->trans("Fieldsaleprice"), 'align'=>'align="left"', 'checked'=>1),
't.qty'=>array('label'=>$langs->trans("Fieldqty"), 'align'=>'align="left"', 'checked'=>1),
't.price'=>array('label'=>$langs->trans("Fieldprice"), 'align'=>'align="left"', 'checked'=>1),
't.subprice'=>array('label'=>$langs->trans("Fieldsubprice"), 'align'=>'align="left"', 'checked'=>1),
...
$sql.= " FROM ".MAIN_DB_PREFIX."bonus_det as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."bonus_det_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
$sql.= " AND t.fk_bonus = ".$idrd;
//$sql.= " WHERE u.entity IN (".getEntity('mytable',1).")";

if ($search_fk_bonus) $sql.= natural_search("fk_bonus",$search_fk_bonus);
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
	...
	$id = $obj->rowid;
	header("Location: ".DOL_URL_ROOT.'/bonusdet/card.php?id='.$id);
	exit;
}
...
//
if (! empty($arrayfields['t.fk_bonus']['checked'])) print_liste_field_titre($arrayfields['t.fk_bonus']['label'],$_SERVER['PHP_SELF'],'t.fk_bonus','',$params,$arrayfields['t.fk_bonus']['align'],$sortfield,$sortorder);
...
print '<tr class="liste_titre">';
//
if (! empty($arrayfields['t.fk_bonus']['checked'])) print '<td class="liste_titre" '.$arrayfields['t.fk_bonus']['align'].'><input type="text" class="flat" name="search_fk_bonus" value="'.$search_fk_bonus.'" size="10"></td>';
