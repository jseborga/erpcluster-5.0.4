...
/**
 *      \file       almacen/stockprogram_script.php
 *		\ingroup    almacen
 *      \brief      This file is an example for a command line script
 *					Initialy built by build_class_from_table on 2018-02-01 13:50
 */
...
// Examples for manipulating class stockprogram_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/stockprogram.class.php");
$myobject=new Stockprogram($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."stockprogram";
