...
/**
 * \file    /projetpaymentdeduction.class.php
 * \ingroup
...
/**
 * Class Projetpaymentdeduction
 *
 * Put here description of your class
 */
class Projetpaymentdeduction extends CommonObject
{
	/**
	 * @var string Error code (or message)
	 * @deprecated
	 * @see Projetpaymentdeduction::errors
	 */
	public $error;
	/**
	 ...
	 */
	public $element = 'projetpaymentdeduction';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'projet_payment_deduction';

	/**
	 * @var ProjetpaymentdeductionLine[] Lines
	 */
	public $lines = array();
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND', $filterstatic='',$lRow=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ProjetpaymentdeductionLine();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Projetpaymentdeduction($this->db);
...
/**
 * Class ProjetpaymentdeductionLine
 */
class ProjetpaymentdeductionLine
{
	/**
