...
/**
 *   	\file       orgman/mlocation_card.php
 *		\ingroup    orgman
...
$hookmanager->initHooks(array('mlocation'));
...
if (empty($reshook))
{
	...
	$object->safety=GETPOST('safety','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsafety").'</td><td><input class="flat" type="text" name="safety" value="'.GETPOST('safety').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsafety").'</td><td><input class="flat" type="text" name="safety" value="'.$object->safety.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsafety").'</td><td>$object->safety</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('mlocation'));
