...
/**
 *      \file       dev/skeletons/tvadef_script.php
 *		\ingroup    mymodule othermodule1 othermodule2
 *      \brief      This file is an example for a command line script
 *					Initialy built by build_class_from_table on 2016-10-12 12:52
 */
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/tvadef.class.php");
$myobject=new Tvadef($db);
