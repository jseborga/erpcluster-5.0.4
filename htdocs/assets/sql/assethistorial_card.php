...
/**
 *   	\file       assets/assethistorial_card.php
 *		\ingroup    assets
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-04-05 13:01
 */
...
dol_include_once('/assets/class/assethistorial.class.php');
...
$hookmanager->initHooks(array('assethistorial'));
...
if (empty($reshook))
{
	...
	$object->pc_ip=GETPOST('pc_ip','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpc_ip").'</td><td><input class="flat" type="text" name="pc_ip" value="'.GETPOST('pc_ip').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpc_ip").'</td><td><input class="flat" type="text" name="pc_ip" value="'.$object->pc_ip.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpc_ip").'</td><td>$object->pc_ip</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_mod").'</td><td>$object->fk_user_mod</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('assethistorial'));
