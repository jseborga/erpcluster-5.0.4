...
/**
 *  \file       dev/skeletons/puserbonus.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2013-08-01 19:54
 */
 ...
 */
class Puserbonus // extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	//var $element='puserbonus';			//!< Id that identify managed objects
	//var $table_element='puserbonus';	//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->fk_puser)) $this->fk_puser=trim($this->fk_puser);
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."p_user_bonus(";
		...
		$sql.= " ".(! isset($this->fk_puser)?'NULL':"'".$this->fk_puser."'").",";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."p_user_bonus");
    ...
    function fetch($id)
    {
        ...
        $sql.= " FROM ".MAIN_DB_PREFIX."p_user_bonus as t";
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."p_user_bonus SET";
        
		$sql.= " fk_puser=".(isset($this->fk_puser)?$this->fk_puser:"null").",";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."p_user_bonus";
    		$sql.= " WHERE rowid=".$this->id;
