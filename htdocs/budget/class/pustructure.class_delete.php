...
/**
 * \file    budget/pustructure.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Pustructure extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'pustructure';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'pu_structure';

	/**
	 * @var PustructureLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		$sql .= ' '.(! isset($this->ordby)?'NULL':$this->ordby).',';
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' ordby = '.(isset($this->ordby)?$this->ordby:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Pustructure($this->db);
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Structure") . '</u>';
        $label.= '<div width="100%">';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;
        $label.= '<br><b>' . $langs->trans('Label') . ':</b> ' . $this->detail;

        $link = '<a href="'.DOL_URL_ROOT.'/budget/structure/card.php?id='.$this->id.'"';
