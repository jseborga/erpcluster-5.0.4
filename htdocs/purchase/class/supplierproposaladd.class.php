...
/**
 * \file    purchase/supplierproposaladd.class.php
 * \ingroup purchase
...
/**
 * Class Supplierproposaladd
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Supplierproposaladd extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'supplierproposaladd';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'supplier_proposal_add';

	/**
	 * @var SupplierproposaladdLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_province)) {
			 $this->fk_province = trim($this->fk_province);
		}
		...
		$sql .= ' '.(! isset($this->fk_province)?'NULL':$this->fk_province).',';
	...
	public function fetch($id, $fk=0)
	{
		...
		$sql.= ' WHERE 1 = 1';
		if ($fk>0) {
			$sql .= ' AND t.fk_supplier_proposal = ' . $fk;
		} else {
			$sql .= ' AND t.rowid = ' . $id;
		}
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->fk_province = $obj->fk_province;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' fk_province = '.(isset($this->fk_province)?$this->fk_province:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Supplierproposaladd($this->db);
