...
/**
 *   	\file       monprojet/producttask_list.php
 *		\ingroup    monprojet
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-11-18 18:15
 */
...
dol_include_once('/monprojet/class/producttask.class.php');
...
$hookmanager->initHooks(array('producttasklist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."product_task as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."product_task_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
