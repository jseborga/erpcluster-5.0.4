...
/**
 *      \file       budget/budgettaskpredecessor_script.php
 *		\ingroup    budget
...
// Examples for manipulating class budgettaskpredecessor_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budgettaskpredecessor.class.php");
$myobject=new Budgettaskpredecessor($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgettaskpredecessor";
