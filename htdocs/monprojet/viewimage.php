...
//define ('DOL_DOCUMENT_ROOT','/var/www/html/final');
...
$entity=$_GET['entity']?$_GET['entity']:1;
...
//($modulepart,$original_file,$entity,$fuser='',$refname='',$direcc='')
...
else					// Open and return file
{
    ...
    $original_file_osencoded=dol_osencode_($original_file);
...
{
    $newpathoffile=dol_osencode_($pathoffile);
