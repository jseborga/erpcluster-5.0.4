...
/**
 *   	\file       salary/pdepartament_list.php
 *		\ingroup    salary
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-03-10 08:59
 */
...
dol_include_once('/salary/class/pdepartament.class.php');
...
$hookmanager->initHooks(array('pdepartamentlist'));
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."p_departament_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_fk_user_resp) $sql.= natural_search("fk_user_resp",$search_fk_user_resp);
...
if ($search_fk_user_resp != '') $params.= '&amp;search_fk_user_resp='.urlencode($search_fk_user_resp);
