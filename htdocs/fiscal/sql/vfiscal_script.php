...
/**
 *      \file       fiscal/vfiscal_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class vfiscal_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/vfiscal.class.php");
$myobject=new Vfiscal($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."vfiscal";
