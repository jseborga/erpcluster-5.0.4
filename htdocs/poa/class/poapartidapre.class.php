...
/**
 * \file    poa/poapartidapre.class.php
 * \ingroup poa
...
class Poapartidapre extends CommonObject
{
	 ...
	 */
	public $element = 'poapartidapre';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'poa_partida_pre';

	/**
	 * @var PoapartidapreLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("poapartidapre", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
