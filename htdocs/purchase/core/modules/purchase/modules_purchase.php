 ...
 */
abstract class ModelePDFPurchase extends CommonDocGenerator
{
	var $error='';
 ...
 */
abstract class ModeleNumRefPurchase
{
	var $error='';
 ...
 */
function purchase_pdf_create(DoliDB $db, CommandeFournisseur $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0)
{
