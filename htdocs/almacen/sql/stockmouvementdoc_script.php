...
/**
 *      \file       almacen/stockmouvementdoc_script.php
 *		\ingroup    almacen
...
// Examples for manipulating class stockmouvementdoc_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/stockmouvementdoc.class.php");
$myobject=new Stockmouvementdoc($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."stockmouvementdoc";
