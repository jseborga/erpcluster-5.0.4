...
require_once DOL_DOCUMENT_ROOT.'/salary/lib/departament.lib.php';
...
// Add
if ($action == 'add' && $user->rights->salary->dpto->creer)
{
...
// Delete period
if ($action == 'confirm_delete' && $_REQUEST["confirm"] == 'yes' && $user->rights->salary->dpto->del)
{
...
if ($action == 'create' && $user->rights->salary->dpto->creer)
{
...
else
{
	...
	dol_fiche_head($head, 'card', $langs->trans("Departament"), 0, 'deparament');
	...
	// Confirmation de la validation
	  ...
	  //respon
			...
			if ($action == '')
			{
				if ($user->rights->salary->dpto->creer)
				...
				if ($user->rights->salary->dpto->del)
