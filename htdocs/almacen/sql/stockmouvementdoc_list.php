...
/**
 *   	\file       almacen/stockmouvementdoc_list.php
 *		\ingroup    almacen
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-03-30 14:15
 */
...
dol_include_once('/almacen/class/stockmouvementdoc.class.php');
...
$hookmanager->initHooks(array('stockmouvementdoclist'));
...
$object=new Stockmouvementdoc($db);
...
't.fk_entrepot_from'=>array('label'=>$langs->trans("Fieldfk_entrepot_from"), 'checked'=>1),
't.fk_entrepot_to'=>array('label'=>$langs->trans("Fieldfk_entrepot_to"), 'checked'=>1),
...
't.fk_source'=>array('label'=>$langs->trans("Fieldfk_source"), 'checked'=>1),
...
$search_ref='';
$search_ref_ext='';
$search_fk_entrepot_from='';
$search_fk_entrepot_to='';
...
$sql.= " FROM ".MAIN_DB_PREFIX."stock_mouvement_doc as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."stock_mouvement_doc_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_fk_entrepot_from) $sql.= natural_search("fk_entrepot_from",$search_fk_entrepot_from);
if ($search_fk_entrepot_to) $sql.= natural_search("fk_entrepot_to",$search_fk_entrepot_to);
...
if ($search_fk_source) $sql.= natural_search("fk_source",$search_fk_source);
...
if ($search_fk_entrepot_from != '') $params.= '&amp;search_fk_entrepot_from='.urlencode($search_fk_entrepot_from);
if ($search_fk_entrepot_to != '') $params.= '&amp;search_fk_entrepot_to='.urlencode($search_fk_entrepot_to);
...
if ($search_fk_source != '') $params.= '&amp;search_fk_source='.urlencode($search_fk_source);
...
if (! empty($arrayfields['t.fk_entrepot_from']['checked'])) print_liste_field_titre($arrayfields['t.fk_entrepot_from']['label'],$_SERVER['PHP_SELF'],'t.fk_entrepot_from','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_entrepot_to']['checked'])) print_liste_field_titre($arrayfields['t.fk_entrepot_to']['label'],$_SERVER['PHP_SELF'],'t.fk_entrepot_to','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_source']['checked'])) print_liste_field_titre($arrayfields['t.fk_source']['label'],$_SERVER['PHP_SELF'],'t.fk_source','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_entrepot_from']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_entrepot_from" value="'.$search_fk_entrepot_from.'" size="10"></td>';
if (! empty($arrayfields['t.fk_entrepot_to']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_entrepot_to" value="'.$search_fk_entrepot_to.'" size="10"></td>';
...
if (! empty($arrayfields['t.fk_source']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_source" value="'.$search_fk_source.'" size="10"></td>';
