...
/**
 * \file    budget/originsupplies.class.php
 * \ingroup budget
...
/**
 * Class Originsupplies
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Originsupplies extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'originsupplies';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'origin_supplies';

	/**
	 * @var OriginsuppliesLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("originsupplies", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Originsupplies($this->db);
