 ...
 *				Initialy built by build_class_from_table on 2013-03-23 11:31
 */
...
class Units // extends CommonObject
{
    ...
    function create($user, $notrigger=0)
    {
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."units(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."units");
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."units SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."units";
    		$sql.= " WHERE rowid=".$this->id;
	...
	function liste_array($brouillon=0, $user='')
	{
	  ...
	  $sql = "SELECT u.rowid, u.ref, u.description";
