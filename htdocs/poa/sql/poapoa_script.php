...
// Examples for manipulating class poapoa_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poapoa.class.php");
$myobject=new Poapoa($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poapoa";
