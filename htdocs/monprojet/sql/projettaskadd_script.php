...
/**
 *      \file       monprojet/projettaskadd_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projettaskadd_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projettaskadd.class.php");
$myobject=new Projettaskadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projettaskadd";
