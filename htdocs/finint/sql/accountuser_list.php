...
/**
 *   	\file       finint/accountuser_list.php
 *		\ingroup    finint
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-11-15 09:42
 */
...
dol_include_once('/finint/class/accountuser.class.php');
...
$hookmanager->initHooks(array('accountuserlist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."account_user as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."account_user_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
