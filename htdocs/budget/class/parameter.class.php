 ...
 *				Initialy built by build_class_from_table on 2015-10-05 14:20
 */
...
class Parameter extends CommonObject
{
    ...
    function create($user, $notrigger=0)
    {
		...
		$sql.= " ".(! isset($this->global_item)?'NULL':"'".$this->db->escape($this->global_item)."'").",";
     ...
     */
    function fetch($id=0,$user='',$bydefault='')
    {
    	global $langs;
        $sql = "SELECT";
		$sql.= " t.rowid,";
    ...
    function update($user, $notrigger=0)
    {
		...
		$sql.= " global_item=".(isset($this->global_item)?"'".$this->db->escape($this->global_item)."'":"null").",";
