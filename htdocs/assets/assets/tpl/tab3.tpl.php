...
if ($user->rights->assets->ass->read)
{
	...
	//date revaluo
	print '<tr><td width="15%">'.$langs->trans('Daterevalued').'</td><td colspan="2">';
	print dol_print_date($object->date_reval,'day');
	print '</td></tr>';
	//value revalue
	print '<tr><td width="15%">'.$langs->trans('Costereval').'</td><td colspan="2">';
	print price($object->coste_reval);
	print '</td></tr>';
	//value revalue residual
	print '<tr><td width="15%">'.$langs->trans('Costeresidualreval').'</td><td colspan="2">';
	print price($object->coste_residual_reval);
	print '</td></tr>';
	//status reval
	print '<tr><td width="15%">'.$langs->trans('Statusreval').'</td><td colspan="2">';
	print $object->getLibStatutreval(6);
	print '</td></tr>';

	//date baja
	print '<tr><td width="15%">'.$langs->trans('Datebaja').'</td><td colspan="2">';
