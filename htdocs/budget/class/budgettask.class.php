...
/**
 * \file    budget/budgettask.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Budgettask extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'budgettask';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'budget_task';

	/**
	 * @var BudgettaskLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null, $fk=0)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("budgettask", 1) . ")";
		}
		if (null !== $ref && $fk>0) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $url = DOL_URL_ROOT.'/budget/budget/'.'fiche.php?id='.$this->id;
