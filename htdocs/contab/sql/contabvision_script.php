...
/**
 *      \file       contab/contabvision_script.php
 *		\ingroup    contab
...
// Examples for manipulating class contabvision_class
require_once(DOL_DOCUMENT_ROOT."/../contab/contabvision.class.php");
$myobject=new Contabvision($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."contabvision";
