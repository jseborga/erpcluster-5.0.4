...
/**
 *   	\file       contab/cscurrencytype_card.php
 *		\ingroup    contab
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldregistry").'</td><td><input class="flat" type="text" name="registry" value="'.GETPOST('registry').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldregistry").'</td><td><input class="flat" type="text" name="registry" value="'.$object->registry.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldregistry").'</td><td>$object->registry</td></tr>';
