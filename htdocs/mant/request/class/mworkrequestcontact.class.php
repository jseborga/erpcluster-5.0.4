...
/**
 *  \file       dev/skeletons/mworkrequestcontact.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2015-08-27 16:03
 */
 ...
 */
class Mworkrequestcontact extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='mworkrequestcontact';			//!< Id that identify managed objects
	var $table_element='mworkrequestcontact';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."m_work_request_contact(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."m_work_request_contact");
    ...
    function fetch($id)
    {
        ...
        $sql.= " FROM ".MAIN_DB_PREFIX."m_work_request_contact as t";
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."m_work_request_contact SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."m_work_request_contact";
    		$sql.= " WHERE rowid=".$this->id;
	...
	function createFromClone($fromid)
	{
		...
		$object=new Mworkrequestcontact($this->db);
	  ...
	  if ($resql)
	      ...
	      if ($num)
		{
		  ...
		  while($i < $num)
		    {
		      $obj = $this->db->fetch_object($resql);
		      $objcont = new Mworkrequestcontact($this->db);
		      
		      $objcont->id    = $obj->rowid;
		      
		      $objcont->fk_work_request = $obj->fk_work_request;
		      $objcont->fk_contact = $obj->fk_contact;
		      $objcont->fk_user_create = $obj->fk_user_create;
		      $objcont->date_create = $this->db->jdate($obj->date_create);
