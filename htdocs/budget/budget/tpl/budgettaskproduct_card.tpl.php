...
if (empty($reshook))
{
	...
	if ($action == 'add')
	{
		...
		$object->performance=GETPOST('performance','alpha');
...
if ($action == 'create')
{
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldperformance").'</td><td><input class="flat" type="text" name="performance" value="'.GETPOST('performance').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldperformance").'</td><td><input class="flat" type="text" name="performance" value="'.$object->performance.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	print '<tr><td class="fieldrequired">'.$langs->trans("Fieldperformance").'</td><td>'.$object->performance.'</td></tr>';
