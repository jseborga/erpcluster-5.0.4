...
/**
 *      \file       contab/contabseatflag_script.php
 *		\ingroup    contab
...
// Examples for manipulating class contabseatflag_class
require_once(DOL_DOCUMENT_ROOT."/../contab/contabseatflag.class.php");
$myobject=new Contabseatflag($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."contabseatflag";
