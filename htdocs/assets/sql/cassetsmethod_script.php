...
/**
 *      \file       assets/cassetsmethod_script.php
 *		\ingroup    assets
...
// Examples for manipulating class cassetsmethod_class
require_once(DOL_DOCUMENT_ROOT."/../assets/cassetsmethod.class.php");
$myobject=new Cassetsmethod($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cassetsmethod";
