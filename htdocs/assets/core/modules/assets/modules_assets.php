 ...
 */
abstract class ModelePDFAssets extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleAssets extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleNumRefAssets
{
	var $error='';
 ...
 */
function assets_pdf_create($db, $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0, $hookmanager=false)
{
	...
	foreach($dirmodels as $reldir)
	{
    	foreach(array('doc','pdf') as $prefix)
    	{
	        ...
	        $file=dol_buildpath($reldir."assets/core/modules/doc/".$file,0);
    		if (file_exists($file))
    		{
    			$filefound=1;
