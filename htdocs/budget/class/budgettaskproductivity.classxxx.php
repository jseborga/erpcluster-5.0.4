...
/**
 * \file    budget/budgettaskproductivity.class.php
 * \ingroup budget
...
/**
 * Class Budgettaskproductivity
 *
 * Put here description of your class
 * @see CommonObject
 */
class Budgettaskproductivity extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'budgettaskproductivity';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'budget_task_productivity';

	/**
	 * @var BudgettaskproductivityLine[] Lines
	 */
	public $lines = array();
	 ...
	 */
	public function fetch($id, $fk=0,$code = null)
	{
		dol_syslog(__METHOD__, LOG_DEBUG);
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new BudgettaskproductivityLine();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Budgettaskproductivity($this->db);
...
/**
 * Class BudgettaskproductivityLine
 */
class BudgettaskproductivityLine
{
	/**
