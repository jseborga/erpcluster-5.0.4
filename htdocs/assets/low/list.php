...
/**
 *   	\file       assets/clow_list.php
 *		\ingroup    assets
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-09-29 14:05
 */
...
dol_include_once('/assets/class/clow.class.php');
...
$contextpage=GETPOST('contextpage','aZ')?GETPOST('contextpage','aZ'):'assetslowlist';
...
$sql.= " FROM ".MAIN_DB_PREFIX."c_low as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."c_low_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
	...
	$id = $obj->rowid;
	header("Location: ".DOL_URL_ROOT.'/clow/card.php?id='.$id);
	exit;
}
