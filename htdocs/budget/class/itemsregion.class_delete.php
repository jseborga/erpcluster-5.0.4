...
/**
 * \file    budget/itemsregion.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Itemsregion extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'itemsregion';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'items_region';

	/**
	 * @var ItemsregionLine[] Lines
	 */
	public $lines = array();
	 ...
	 */
	public function fetch($id, $fk_item=0,$fk_region=0,$fk_sector=0)
	{
		dol_syslog(__METHOD__, LOG_DEBUG);
		...
		$sql.= ' WHERE 1 = 1';
		if ($fk_item>0 && $fk_region>0 && $fk_sector>0) {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("itemsregion", 1) . ")";
		}
		if (count($sqlwhere) > 0) {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Itemsregion($this->db);
