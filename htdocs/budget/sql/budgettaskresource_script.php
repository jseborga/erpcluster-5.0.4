...
/**
 *      \file       budget/budgettaskresource_script.php
 *		\ingroup    budget
...
// Examples for manipulating class budgettaskresource_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budgettaskresource.class.php");
$myobject=new Budgettaskresource($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgettaskresource";
