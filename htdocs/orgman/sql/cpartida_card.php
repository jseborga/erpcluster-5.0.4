...
/**
 *   	\file       orgman/cpartida_card.php
 *		\ingroup    orgman
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-04-20 10:55
 */
...
if (empty($reshook))
{
	...
	$object->code_father=GETPOST('code_father','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_father").'</td><td><input class="flat" type="text" name="code_father" value="'.$object->code_father.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_father").'</td><td>$object->code_father</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldactive").'</td><td>$object->active</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('cpartida'));
