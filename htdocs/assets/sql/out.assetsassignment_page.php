...
/**
 *   	\file       /assetsassignment_page.php
 *		\ingroup    
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2015-11-11 11:33
 */
...
dol_include_once('//class/assetsassignment.class.php');
...
if ($search_fk_adherent) $sql.= natural_search("fk_adherent",$search_fk_adherent);
...
print_liste_field_titre($langs->trans('fk_adherent'),$_SERVER['PHP_SELF'],'t.fk_adherent','',$param,'',$sortfield,$sortorder);
print_liste_field_titre($langs->trans('fk_projet'),$_SERVER['PHP_SELF'],'t.fk_projet','',$param,'',$sortfield,$sortorder);
print_liste_field_titre($langs->trans('fk_property'),$_SERVER['PHP_SELF'],'t.fk_property','',$param,'',$sortfield,$sortorder);
...
print_liste_field_titre($langs->trans('type_assignment'),$_SERVER['PHP_SELF'],'t.type_assignment','',$param,'',$sortfield,$sortorder);
...
print '<td>'.$obj->ref.'</td>';
print '<td>'.$obj->fk_adherent.'</td>';
print '<td>'.$obj->fk_projet.'</td>';
print '<td>'.$obj->fk_property.'</td>';
print '<td>'.$obj->fk_location.'</td>';
print '<td>'.$obj->detail.'</td>';
print '<td>'.$obj->type_assignment.'</td>';
