...
/**
 *   	\file       fiscal/facturedetfiscal_card.php
 *		\ingroup    fiscal
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-05-09 15:34
 */
...
dol_include_once('/fiscal/class/facturedetfiscal.class.php');
...
$search_fk_facturedet=GETPOST('search_fk_facturedet','int');
...
$object = new Facturedetfiscal($db);
...
$hookmanager->initHooks(array('facturedetfiscal'));
...
if (empty($reshook))
{
	...
	$object->fk_facturedet=GETPOST('fk_facturedet','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_facturedet").'</td><td><input class="flat" type="text" name="fk_facturedet" value="'.GETPOST('fk_facturedet').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_facturedet").'</td><td><input class="flat" type="text" name="fk_facturedet" value="'.$object->fk_facturedet.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_facturedet").'</td><td>$object->fk_facturedet</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('facturedetfiscal'));
