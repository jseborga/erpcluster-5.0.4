...
/**
 *      \file       dev/skeletons/poaprocesscontrat_script.php
 *		\ingroup    mymodule
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/poaprocesscontrat.class.php");
$myobject=new Poaprocesscontrat($db);
