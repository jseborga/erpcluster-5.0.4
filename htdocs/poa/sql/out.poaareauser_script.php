...
/**
 *      \file       poa/poaareauser_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poaareauser_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poaareauser.class.php");
$myobject=new Poaareauser($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poaareauser";
