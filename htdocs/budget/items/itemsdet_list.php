...
$hookmanager->initHooks(array('itemsdetlist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."items_det as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."items_det_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
