	...
	while ($i < min($num,$limit))
	  {
	    ...
	    if ($idFather>0)
	      $espacio = '&nbsp;&nbsp;&nbsp;&nbsp;';
	    print '<td><a href="liste.php?id='.$obj->id.'&action=sub&top=1&filtro='.$filtro.'&father='.$father.'">'.$espacio.img_picto($langs->trans("Ref"),'rightarrow').' '.$obj->ref.'</a></td>';
	    ...
	    print '<td><a href="fiche.php?id='.$obj->id.'">'.img_picto($langs->trans("Edit"),'edit').'</a></td>';
