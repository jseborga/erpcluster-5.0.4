	...
	$_GET['ref'] != null)
{
	...
	print ' window.parent.document.getElementById('."'txtRef'".').value = "'. $ref.'"';
	print '</script>';
	print '<script type="text/javascript">';
	print ' window.parent.document.getElementById('."'id'".').value = "'. $rowid.'"';
	print '</script>';
	print '<script type="text/javascript">';
	print ' window.parent.document.getElementById('."'price'".').value = "'. $price.'"';
	print '</script>';
	print '<script type="text/javascript">';
	print ' window.parent.document.getElementById('."'price1'".').innerHTML = "'. $price.'"';
	print '</script>';
	print '<script type="text/javascript">';
	print ' window.parent.document.getElementById('."'desc'".').value = "'. $desc.'"';
	print '</script>';
	print '<script type="text/javascript">';
	print ' window.parent.document.getElementById('."'label'".').innerHTML = "'. $label.'"';
	print '</script>';
	print '<script type="text/javascript">';
	print ' window.parent.document.getElementById('."'quant'".').value = "1"';
	print '</script>';
}
?>
