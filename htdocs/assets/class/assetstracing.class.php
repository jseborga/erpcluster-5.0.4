...
/**
 * \file    assets/assetstracing.class.php
 * \ingroup assets
 ...
 * @see CommonObject
 */
class Assetstracing extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'assetstracing';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'assets_tracing';

	/**
	 * @var AssetstracingLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("assetstracing", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Assetstracing($this->db);
