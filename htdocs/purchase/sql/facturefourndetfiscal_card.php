...
/**
 *   	\file       purchase/facturefourndetfiscal_card.php
 *		\ingroup    purchase
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-04-06 13:02
 */
...
dol_include_once('/purchase/class/facturefourndetfiscal.class.php');
...
$search_fk_facture_fourn_det=GETPOST('search_fk_facture_fourn_det','int');
...
$object = new Facturefourndetfiscal($db);
...
$hookmanager->initHooks(array('facturefourndetfiscal'));
...
if (empty($reshook))
{
	...
	$object->fk_facture_fourn_det=GETPOST('fk_facture_fourn_det','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_facture_fourn_det").'</td><td><input class="flat" type="text" name="fk_facture_fourn_det" value="'.GETPOST('fk_facture_fourn_det').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_tva").'</td><td><input class="flat" type="text" name="code_tva" value="'.GETPOST('code_tva').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_facture_fourn_det").'</td><td><input class="flat" type="text" name="fk_facture_fourn_det" value="'.$object->fk_facture_fourn_det.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_tva").'</td><td><input class="flat" type="text" name="code_tva" value="'.$object->code_tva.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_facture_fourn_det").'</td><td>$object->fk_facture_fourn_det</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_tva").'</td><td>$object->code_tva</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('facturefourndetfiscal'));
