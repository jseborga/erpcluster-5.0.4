...
/**
 *      \file       monprojet/projetproduct_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projetproduct_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projetproduct.class.php");
$myobject=new Projetproduct($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projetproduct";
