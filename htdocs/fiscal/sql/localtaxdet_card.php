...
/**
 *   	\file       fiscal/localtaxdet_card.php
 *		\ingroup    fiscal
...
$hookmanager->initHooks(array('localtaxdet'));
...
if (empty($reshook))
{
	...
	$object->fk_localtax=GETPOST('fk_localtax','int');
	$object->fk_typetvadet=GETPOST('fk_typetvadet','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_localtax").'</td><td><input class="flat" type="text" name="fk_localtax" value="'.GETPOST('fk_localtax').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_typetvadet").'</td><td><input class="flat" type="text" name="fk_typetvadet" value="'.GETPOST('fk_typetvadet').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_localtax").'</td><td><input class="flat" type="text" name="fk_localtax" value="'.$object->fk_localtax.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_typetvadet").'</td><td><input class="flat" type="text" name="fk_typetvadet" value="'.$object->fk_typetvadet.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_localtax").'</td><td>$object->fk_localtax</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_typetvadet").'</td><td>$object->fk_typetvadet</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('localtaxdet'));
