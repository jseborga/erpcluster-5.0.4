...
$contextpage=GETPOST('contextpage','aZ')?GETPOST('contextpage','aZ'):'budgetincidentsrestpllist';
...
't.fk_budget_incident'=>array('label'=>$langs->trans("Fieldfk_incident"), 'align'=>'align="left"', 'checked'=>0),
...
$sql.= " FROM ".MAIN_DB_PREFIX."budget_incidents_res as t";
...
if ($sumtotal>0)
{
	...
	if ($objBudgetincidents->status == 0)
	{
		//vamos a actualizar
		$objBudgetincidents->incident = $sumtotal;
