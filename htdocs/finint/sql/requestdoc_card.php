...
/**
 *   	\file       finint/requestdoc_card.php
 *		\ingroup    finint
...
$hookmanager->initHooks(array('requestdoc'));
...
if (empty($reshook))
{
	...
	$object->fk_request_item=GETPOST('fk_request_item','int');
	$object->code=GETPOST('code','alpha');
	$object->name_doc=GETPOST('name_doc','alpha');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_request_item").'</td><td><input class="flat" type="text" name="fk_request_item" value="'.GETPOST('fk_request_item').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldname_doc").'</td><td><input class="flat" type="text" name="name_doc" value="'.GETPOST('name_doc').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_request_item").'</td><td><input class="flat" type="text" name="fk_request_item" value="'.$object->fk_request_item.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode").'</td><td><input class="flat" type="text" name="code" value="'.$object->code.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldname_doc").'</td><td><input class="flat" type="text" name="name_doc" value="'.$object->name_doc.'"></td></tr>';
...
if ($id && (empty($action) || $action == 'view' || $action == 'delete'))
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_request_item").'</td><td>$object->fk_request_item</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode").'</td><td>$object->code</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldname_doc").'</td><td>$object->name_doc</td></tr>';
