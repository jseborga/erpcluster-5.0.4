...
/**
 * \file    monprojet/producttask.class.php
 * \ingroup monprojet
 ...
 * @see CommonObject
 */
class Producttask extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'producttask';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'product_task';

	/**
	 * @var ProducttaskLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Producttask($this->db);
