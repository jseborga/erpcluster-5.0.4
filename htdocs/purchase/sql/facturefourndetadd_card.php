...
/**
 *   	\file       purchase/facturefourndetadd_card.php
 *		\ingroup    purchase
...
$hookmanager->initHooks(array('facturefourndetadd'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('facturefourndetadd'));
