...
/**
 *      \file       asset/assetdepr_script.php
 *		\ingroup    asset
...
// Examples for manipulating class assetdepr_class
require_once(DOL_DOCUMENT_ROOT."/../asset/assetdepr.class.php");
$myobject=new Assetdepr($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assetdepr";
