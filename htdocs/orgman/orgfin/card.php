...
/**
 *   	\file       clientes/corgfin_card.php
 *		\ingroup    clientes
...
dol_include_once('/clientes/class/corgfin.class.php');
...
$hookmanager->initHooks(array('corgfin'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldactive").'</td><td>$object->active</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('corgfin'));
