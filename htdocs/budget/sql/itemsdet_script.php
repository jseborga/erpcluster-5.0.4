...
/**
 *      \file       priceunits/itemsdet_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class itemsdet_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/itemsdet.class.php");
$myobject=new Itemsdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."itemsdet";
