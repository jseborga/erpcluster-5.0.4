...
/**
 *      \file       assets/cassetsgroup_script.php
 *		\ingroup    assets
...
// Examples for manipulating class cassetsgroup_class
require_once(DOL_DOCUMENT_ROOT."/../assets/cassetsgroup.class.php");
$myobject=new Cassetsgroup($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cassetsgroup";
