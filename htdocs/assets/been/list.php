...
dol_include_once('/assets/class/cassetsbeen.class.php');
...
if (empty($reshook))
{
	...
	if ($action == 'add')
	{
		...
		if (! $error)
		{
			...
			{
				// Creation OK
				$urltogo=$backtopage?$backtopage:dol_buildpath('/assets/been/list.php',1);
				header("Location: ".$urltogo);
				exit;
			}
			{
	...
	if ($action == 'confirm_delete')
	{
		...
		if ($result > 0)
		{
			...
			header("Location: ".dol_buildpath('/assets/been/list.php',1));
			exit;
		}
		else
		{
...
$sql.= " FROM ".MAIN_DB_PREFIX."c_assets_been as t";
