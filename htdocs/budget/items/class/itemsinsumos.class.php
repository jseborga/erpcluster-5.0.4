...
/**
 * \file    priceunits/itemsinsumos.class.php
 * \ingroup priceunits
 ...
 * @see CommonObject
 */
class Itemsinsumos extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'itemsinsumos';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'items_insumos';

	/**
	 * @var ItemsinsumosLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Itemsinsumos($this->db);
