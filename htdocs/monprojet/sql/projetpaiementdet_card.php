...
/**
 *   	\file       monprojet/projetpaiementdet_card.php
 *		\ingroup    monprojet
...
$hookmanager->initHooks(array('projetpaiementdet'));
...
if (empty($reshook))
{
	...
	$object->qty_ant=GETPOST('qty_ant','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldqty_ant").'</td><td><input class="flat" type="text" name="qty_ant" value="'.GETPOST('qty_ant').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldqty_ant").'</td><td><input class="flat" type="text" name="qty_ant" value="'.$object->qty_ant.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldqty_ant").'</td><td>$object->qty_ant</td></tr>';
