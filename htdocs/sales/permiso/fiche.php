...
require_once(DOL_DOCUMENT_ROOT."/sales/class/entrepotbanksocext.class.php");
require_once(DOL_DOCUMENT_ROOT."/societe/class/societe.class.php");
require_once(DOL_DOCUMENT_ROOT."/product/stock/class/entrepot.class.php");
require_once(DOL_DOCUMENT_ROOT."/compta/bank/class/account.class.php");

require_once(DOL_DOCUMENT_ROOT."/sales/class/subsidiary.class.php");
require_once(DOL_DOCUMENT_ROOT."/sales/class/vdosing.class.php");
require_once(DOL_DOCUMENT_ROOT."/sales/class/Facturation.class.php");

require_once(DOL_DOCUMENT_ROOT."/core/class/html.form.class.php");

require_once(DOL_DOCUMENT_ROOT."/sales/lib/ventas.lib.php");
require_once(DOL_DOCUMENT_ROOT."/sales/permiso/lib/permiso.lib.php");
...
if ($action == 'add' && $user->rights->ventas->crearPermiso)
{
	...
	if ($modPermission)
	{
		$objnew = new Entrepotbanksocext($db);
...
{
	$object = new Entrepotbanksocext($db);
