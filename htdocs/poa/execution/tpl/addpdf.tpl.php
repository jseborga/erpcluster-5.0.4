...
print '<form  enctype="multipart/form-data" action="'.DOL_URL_ROOT.'/poa/execution/fiche.php'.'" method="POST">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="uppdf">';
print '<input type="hidden" name="id" value="'.$id.'">';
print '<input type="hidden" name="linklast" value="'.$linklast.'">';

print '<div class="col-sx-6">';
print '<input type="file" class="flat" name="docpdf" id="docpdf">';
print '</div>';
print '<div class="col-sx-3">';
