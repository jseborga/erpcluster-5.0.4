...
/**
 * \file    assets/assetscontador.class.php
 * \ingroup assets
...
/**
 * Class Assetscontador
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Assetscontador extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'assetscontador';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'assets_contador';

	/**
	 * @var AssetscontadorLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("assetscontador", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Assetscontador($this->db);
