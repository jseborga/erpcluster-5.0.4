...
abstract class CommonObject_
{
     ...
     *	@deprecated
     */
function formAddPredefinedProduct($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
{
  ...
  include(DOL_DOCUMENT_ROOT.'/almacen/core/tpl/predefinedproductline_create.tpl.php');
}
...
function formAddPredefinedProduct_lm($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
{
  ...
  if (!empty($id))
    $this->id = $id;
  // Use global variables + $dateSelector + $seller and $buyer
  include(DOL_DOCUMENT_ROOT.'/almacen/core/tpl/predefinedproductline_create_lm.tpl.php');
}
...
function formAddPredefinedProductAlt($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
{
  ...
  if (!empty($id))
    $this->id = $id;
  // Use global variables + $dateSelector + $seller and $buyer
  include(DOL_DOCUMENT_ROOT.'/almacen/core/tpl/predefinedproductline_create_alt.tpl.php');
}
...
function formAddPredefinedProductSon($dateSelector,$seller,$buyer,$hookmanager=false,$id='')
{
  ...
  if (!empty($id))
    $this->id = $id;
  // Use global variables + $dateSelector + $seller and $buyer
  include(DOL_DOCUMENT_ROOT.'/almacen/core/tpl/predefinedproductline_create_son.tpl.php');
}
