...
/**
 *      \file       purchase/commandefournisseuradd_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class commandefournisseuradd_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/commandefournisseuradd.class.php");
$myobject=new Commandefournisseuradd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."commandefournisseuradd";
