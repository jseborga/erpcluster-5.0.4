...
/**
 *      \file       orgman/csources_script.php
 *		\ingroup    orgman
...
// Examples for manipulating class csources_class
require_once(DOL_DOCUMENT_ROOT."/../orgman/csources.class.php");
$myobject=new Csources($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."csources";
