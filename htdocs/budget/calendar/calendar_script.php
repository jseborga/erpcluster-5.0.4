...
/**
 *      \file       budget/calendar_script.php
 *		\ingroup    budget
...
// Examples for manipulating class calendar_class
require_once(DOL_DOCUMENT_ROOT."/../budget/calendar.class.php");
$myobject=new Calendar($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."calendar";
