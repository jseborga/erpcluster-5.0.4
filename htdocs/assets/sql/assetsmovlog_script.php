...
/**
 *      \file       assets/assetsmovlog_script.php
 *		\ingroup    assets
...
// Examples for manipulating class assetsmovlog_class
require_once(DOL_DOCUMENT_ROOT."/../assets/assetsmovlog.class.php");
$myobject=new Assetsmovlog($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assetsmovlog";
