...
require_once DOL_DOCUMENT_ROOT.'/purchase/class/productadd.class.php';
require_once DOL_DOCUMENT_ROOT.'/purchase/class/fournisseurcommandeadd.class.php';
	...
	if ((GETPOST('prod_entry_mode') != 'free') && empty($error))	// With combolist mode idprodfournprice is > 0 or -1. With autocomplete, idprodfournprice is > 0 or ''
	{
		...
		if ($idprod > 0)
		{
		   ...
		   //inicio agregar precio al producto prooveedor
			...
			//exit;
				//}
			//fin agregar precio al producto proveedor            
			// Local Taxes
			$localtax1_tx= get_localtax($tva_tx, 1,$mysoc,$object->thirdparty);
			$localtax2_tx= get_localtax($tva_tx, 2,$mysoc,$object->thirdparty);
			//$idprodfournprice = GETPOST('idprodfournprice')+0;
