...
/**
 * \file    contab/contabaccounting.class.php
 * \ingroup contab
...
class Contabaccounting extends CommonObject
{
	 ...
	 */
	public $element = 'contabaccounting';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'contab_accounting';

	/**
	 * @var ContabaccountingLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->cta_top)) {
			 $this->cta_top = trim($this->cta_top);
		}
		if (isset($this->cta_name)) {
			 $this->cta_name = trim($this->cta_name);
		}
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				...
				$line->cta_top = $obj->cta_top;
				$line->cta_name = $obj->cta_name;
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Contabaccounting") . '</u>';
        $label.= '<div width="100%">';
