...
/**
 *      \file       purchase/facturefourndetfiscal_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class facturefourndetfiscal_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/facturefourndetfiscal.class.php");
$myobject=new Facturefourndetfiscal($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."facturefourndetfiscal";
