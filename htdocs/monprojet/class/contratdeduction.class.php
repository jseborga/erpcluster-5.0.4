...
/**
 * \file    /contratdeduction.class.php
 * \ingroup 
...
/**
 * Class Contratdeduction
 *
 * Put here description of your class
 */
class Contratdeduction extends CommonObject
{
	/**
	 * @var string Error code (or message)
	 * @deprecated
	 * @see Contratdeduction::errors
	 */
	public $error;
	/**
	 ...
	 */
	public $element = 'contratdeduction';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'contrat_deduction';

	/**
	 * @var ContratdeductionLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Contratdeduction($this->db);
