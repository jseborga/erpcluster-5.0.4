$(document).ready(function(){
    ...
    var Tabs = {
	'Inicio'	: 'tpl/init.tpl.php',
	'Vistas'	: 'tpl/vistas.tpl.php',
	'Datos'	        : 'tpl/datos.tpl.php',
	'Revisar'	: 'pages/page3.html',	    
	'Programador'	: 'pages/page4.html',
    }
    
    /* The available colors for the tabs: */
    var colors = ['blue','green','red','orange','fireBrick'];
	...
	var tmp = $('<li><a href="#" class="tab1 '+colors[(z++%5)]+'">'+i+' <span class="left" /><span class="right" /></a></li>');
	...
	var bg = element.attr('class').replace('tab1 ','');
