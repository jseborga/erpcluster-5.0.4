...
/**
 * \file    fiscal/vdosinglog.class.php
 * \ingroup fiscal
 ...
 * @see CommonObject
 */
class Vdosinglog extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'vdosinglog';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'v_dosing_log';

	/**
	 * @var VdosinglogLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("vdosinglog", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
