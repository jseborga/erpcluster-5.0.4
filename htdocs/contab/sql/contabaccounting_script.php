...
/**
 *      \file       contab/contabaccounting_script.php
 *		\ingroup    contab
...
// Examples for manipulating class contabaccounting_class
require_once(DOL_DOCUMENT_ROOT."/../contab/contabaccounting.class.php");
$myobject=new Contabaccounting($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."contabaccounting";
