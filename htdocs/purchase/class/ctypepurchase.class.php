...
/**
 * \file    purchase/ctypepurchase.class.php
 * \ingroup purchase
 ...
 * @see CommonObject
 */
class Ctypepurchase extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'ctypepurchase';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'c_type_purchase';

	/**
	 * @var CtypepurchaseLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Ctypepurchase($this->db);
