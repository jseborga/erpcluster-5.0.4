...
/**
 *      \file       monprojet/pustructure_script.php
 *		\ingroup    monprojet
 *      \brief      This file is an example for a command line script
 *					Initialy built by build_class_from_table on 2016-09-15 10:10
 */
...
// Examples for manipulating class pustructure_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/pustructure.class.php");
$myobject=new Pustructure($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."pustructure";
