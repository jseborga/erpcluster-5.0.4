...
/**
 *      \file       priceunits/puoperator_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class puoperator_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/puoperator.class.php");
$myobject=new Puoperator($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."puoperator";
