...
/**
 *      \file       poa/partidaproduct_script.php
 *		\ingroup    poa
...
// Examples for manipulating class partidaproduct_class
require_once(DOL_DOCUMENT_ROOT."/../poa/partidaproduct.class.php");
$myobject=new Partidaproduct($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."partidaproduct";
