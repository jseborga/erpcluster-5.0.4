 ...
 *				Initialy built by build_class_from_table on 2015-05-05 13:32
 */
...
class Solalmacen extends CommonObject
{
	...
	var $element='sol_almacen';			//!< Id that identify managed objects
	var $table_element='sol_almacen';		//!< Name of table without prefix where object is stored
