 ...
 * @see CommonObject
 */
class Mjobsuser extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'mjobsuser';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_jobs_user';

	/**
	 * @var MjobsuserLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_level)) {
			 $this->fk_level = trim($this->fk_level);
		}
		...
		$sql .= ' '.(! isset($this->fk_level)?'NULL':$this->fk_level).',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mjobsuser", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' fk_level = '.(isset($this->fk_level)?$this->fk_level:"null").',';
