...
class Assets extends CommonObject
{
	...
	public $baja_month;
	public $baja_year;
	public $baja_resolution;
	public $baja_observation;
	public $baja_motive;
	public $baja_amount_act;
	public $baja_amount_depgestion;
	public $amount_sale;
	public $descrip;
	...
	public $fk_product;
	public $useful_life;
	public $useful_life_two;
	public $fk_unit_useful_life_two;
	public $percent;
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->date_day)) {
			 $this->date_day = trim($this->date_day);
		}
		if (isset($this->date_month)) {
			 $this->date_month = trim($this->date_month);
		}
		if (isset($this->date_year)) {
			 $this->date_year = trim($this->date_year);
		}
		...
		if (isset($this->useful_life_reval)) {
			 $this->useful_life_reval = trim($this->useful_life_reval);
		}
		if (isset($this->dep_acum)) {
			 $this->dep_acum = trim($this->dep_acum);
		}
		if (isset($this->fk_low)) {
			 $this->fk_low = trim($this->fk_low);
		}
		if (isset($this->baja_day)) {
			 $this->baja_day = trim($this->baja_day);
		}
		if (isset($this->baja_month)) {
			 $this->baja_month = trim($this->baja_month);
		}
		if (isset($this->baja_year)) {
			 $this->baja_year = trim($this->baja_year);
		}
		if (isset($this->baja_resolution)) {
			 $this->baja_resolution = trim($this->baja_resolution);
		}
		if (isset($this->baja_observation)) {
			 $this->baja_observation = trim($this->baja_observation);
		}
		if (isset($this->baja_motive)) {
			 $this->baja_motive = trim($this->baja_motive);
		}
		if (isset($this->baja_amount_act)) {
			 $this->baja_amount_act = trim($this->baja_amount_act);
		}
		if (isset($this->baja_amount_depgestion)) {
			 $this->baja_amount_depgestion = trim($this->baja_amount_depgestion);
		}
		...
		if (isset($this->useful_life_two)) {
			 $this->useful_life_two = trim($this->useful_life_two);
		}
		if (isset($this->fk_unit_useful_life_two)) {
			 $this->fk_unit_useful_life_two = trim($this->fk_unit_useful_life_two);
		}
		...
		if (isset($this->codcont)) {
			 $this->codcont = trim($this->codcont);
		}
		if (isset($this->codaux)) {
			 $this->codaux = trim($this->codaux);
		}
		if (isset($this->orgfin)) {
			 $this->orgfin = trim($this->orgfin);
		}
		if (isset($this->cod_rube)) {
			 $this->cod_rube = trim($this->cod_rube);
		}
		if (isset($this->fk_departament)) {
			 $this->fk_departament = trim($this->fk_departament);
		}
		if (isset($this->fk_resp)) {
			 $this->fk_resp = trim($this->fk_resp);
		}
		if (isset($this->departament_name)) {
			 $this->departament_name = trim($this->departament_name);
		}
		if (isset($this->resp_name)) {
			 $this->resp_name = trim($this->resp_name);
		}
		...
		$sql.= 'baja_year,';
		$sql.= 'baja_resolution,';
		$sql.= 'baja_observation,';
		$sql.= 'baja_motive,';
		$sql.= 'baja_amount_act,';
		$sql.= 'baja_amount_depgestion,';
		$sql.= 'amount_sale,';
		$sql.= 'descrip,';
		$sql.= 'number_plaque,';
		$sql.= 'trademark,';
		...
		$sql .= ' '.(! isset($this->date_day)?'NULL':$this->date_day).',';
		$sql .= ' '.(! isset($this->date_month)?'NULL':$this->date_month).',';
		$sql .= ' '.(! isset($this->date_year)?'NULL':$this->date_year).',';
		...
		$sql .= ' '.(! isset($this->useful_life_reval)?'NULL':"'".$this->useful_life_reval."'").',';
		$sql .= ' '.(! isset($this->dep_acum)?'NULL':"'".$this->dep_acum."'").',';
		$sql .= ' '.(! isset($this->fk_low)?'NULL':$this->fk_low).',';
		$sql .= ' '.(! isset($this->date_baja) || dol_strlen($this->date_baja)==0?'NULL':"'".$this->db->idate($this->date_baja)."'").',';
		$sql .= ' '.(! isset($this->baja_day)?'NULL':$this->baja_day).',';
		$sql .= ' '.(! isset($this->baja_month)?'NULL':$this->baja_month).',';
		$sql .= ' '.(! isset($this->baja_year)?'NULL':$this->baja_year).',';
		$sql .= ' '.(! isset($this->baja_resolution)?'NULL':"'".$this->db->escape($this->baja_resolution)."'").',';
		$sql .= ' '.(! isset($this->baja_observation)?'NULL':"'".$this->db->escape($this->baja_observation)."'").',';
		$sql .= ' '.(! isset($this->baja_motive)?'NULL':"'".$this->db->escape($this->baja_motive)."'").',';
		$sql .= ' '.(! isset($this->baja_amount_act)?'NULL':"'".$this->baja_amount_act."'").',';
		$sql .= ' '.(! isset($this->baja_amount_depgestion)?'NULL':"'".$this->baja_amount_depgestion."'").',';
		...
		$sql .= ' '.(! isset($this->useful_life_two)?'NULL':"'".$this->useful_life_two."'").',';
		$sql .= ' '.(! isset($this->fk_unit_useful_life_two)?'NULL':$this->fk_unit_useful_life_two).',';
		...
		$sql .= ' '.(! isset($this->codcont)?'NULL':$this->codcont).',';
		$sql .= ' '.(! isset($this->codaux)?'NULL':$this->codaux).',';
		$sql .= ' '.(! isset($this->orgfin)?'NULL':"'".$this->db->escape($this->orgfin)."'").',';
		$sql .= ' '.(! isset($this->cod_rube)?'NULL':"'".$this->db->escape($this->cod_rube)."'").',';
		$sql .= ' '.(! isset($this->fk_departament)?'NULL':$this->fk_departament).',';
		$sql .= ' '.(! isset($this->fk_resp)?'NULL':$this->fk_resp).',';
		$sql .= ' '.(! isset($this->departament_name)?'NULL':"'".$this->db->escape($this->departament_name)."'").',';
		$sql .= ' '.(! isset($this->resp_name)?'NULL':"'".$this->db->escape($this->resp_name)."'").',';
	...
	public function fetch($id, $ref = null)
	{
		...
		$sql .= " t.baja_month,";
		$sql .= " t.baja_year,";
		$sql .= " t.baja_resolution,";
		$sql .= " t.baja_observation,";
		$sql .= " t.baja_motive,";
		$sql .= " t.baja_amount_act,";
		$sql .= " t.baja_amount_depgestion,";
		$sql .= " t.amount_sale,";
		$sql .= " t.descrip,";
		$sql .= " t.number_plaque,";
		$sql .= " t.trademark,";
		...
		$sql .= " t.fk_product,";
		$sql .= " t.useful_life,";
		$sql .= " t.useful_life_two,";
		$sql .= " t.fk_unit_useful_life_two,";
		$sql .= " t.percent,";
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->date_day = $obj->date_day;
				$this->date_month = $obj->date_month;
				$this->date_year = $obj->date_year;
				...
				$this->useful_life_reval = $obj->useful_life_reval;
				$this->dep_acum = $obj->dep_acum;
				$this->fk_low = $obj->fk_low;
				$this->date_baja = $this->db->jdate($obj->date_baja);
				$this->baja_day = $obj->baja_day;
				$this->baja_month = $obj->baja_month;
				$this->baja_year = $obj->baja_year;
				$this->baja_resolution = $obj->baja_resolution;
				$this->baja_observation = $obj->baja_observation;
				$this->baja_motive = $obj->baja_motive;
				$this->baja_amount_act = $obj->baja_amount_act;
				$this->baja_amount_depgestion = $obj->baja_amount_depgestion;
				...
				$this->useful_life_two = $obj->useful_life_two;
				$this->fk_unit_useful_life_two = $obj->fk_unit_useful_life_two;
				...
				$this->codcont = $obj->codcont;
				$this->codaux = $obj->codaux;
				$this->orgfin = $obj->orgfin;
				$this->cod_rube = $obj->cod_rube;
				$this->fk_departament = $obj->fk_departament;
				$this->fk_resp = $obj->fk_resp;
				$this->departament_name = $obj->departament_name;
				$this->resp_name = $obj->resp_name;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				...
				$line->date_day = $obj->date_day;
				$line->date_month = $obj->date_month;
				$line->date_year = $obj->date_year;
				...
				$line->useful_life_reval = $obj->useful_life_reval;
				$line->dep_acum = $obj->dep_acum;
				$line->fk_low = $obj->fk_low;
				$line->date_baja = $this->db->jdate($obj->date_baja);
				$line->baja_day = $obj->baja_day;
				$line->baja_month = $obj->baja_month;
				$line->baja_year = $obj->baja_year;
				$line->baja_resolution = $obj->baja_resolution;
				$line->baja_observation = $obj->baja_observation;
				$line->baja_motive = $obj->baja_motive;
				$line->baja_amount_act = $obj->baja_amount_act;
				$line->baja_amount_depgestion = $obj->baja_amount_depgestion;
				...
				$line->useful_life_two = $obj->useful_life_two;
				$line->fk_unit_useful_life_two = $obj->fk_unit_useful_life_two;
				...
				$line->codcont = $obj->codcont;
				$line->codaux = $obj->codaux;
				$line->orgfin = $obj->orgfin;
				$line->cod_rube = $obj->cod_rube;
				$line->fk_departament = $obj->fk_departament;
				$line->fk_resp = $obj->fk_resp;
				$line->departament_name = $obj->departament_name;
				$line->resp_name = $obj->resp_name;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' date_day = '.(isset($this->date_day)?$this->date_day:"null").',';
		$sql .= ' date_month = '.(isset($this->date_month)?$this->date_month:"null").',';
		$sql .= ' date_year = '.(isset($this->date_year)?$this->date_year:"null").',';
		...
		$sql .= ' useful_life_reval = '.(isset($this->useful_life_reval)?$this->useful_life_reval:"null").',';
		$sql .= ' dep_acum = '.(isset($this->dep_acum)?$this->dep_acum:"null").',';
		$sql .= ' fk_low = '.(isset($this->fk_low)?$this->fk_low:"null").',';
		$sql .= ' date_baja = '.(! isset($this->date_baja) || dol_strlen($this->date_baja) != 0 ? "'".$this->db->idate($this->date_baja)."'" : 'null').',';
		$sql .= ' baja_day = '.(isset($this->baja_day)?$this->baja_day:"null").',';
		$sql .= ' baja_month = '.(isset($this->baja_month)?$this->baja_month:"null").',';
		$sql .= ' baja_year = '.(isset($this->baja_year)?$this->baja_year:"null").',';
		$sql .= ' baja_resolution = '.(isset($this->baja_resolution)?"'".$this->db->escape($this->baja_resolution)."'":"null").',';
		$sql .= ' baja_observation = '.(isset($this->baja_observation)?"'".$this->db->escape($this->baja_observation)."'":"null").',';
		$sql .= ' baja_motive = '.(isset($this->baja_motive)?"'".$this->db->escape($this->baja_motive)."'":"null").',';
		$sql .= ' baja_amount_act = '.(isset($this->baja_amount_act)?$this->baja_amount_act:"null").',';
		$sql .= ' baja_amount_depgestion = '.(isset($this->baja_amount_depgestion)?$this->baja_amount_depgestion:"null").',';
		...
		$sql .= ' useful_life_two = '.(isset($this->useful_life_two)?$this->useful_life_two:"null").',';
		$sql .= ' fk_unit_useful_life_two = '.(isset($this->fk_unit_useful_life_two)?$this->fk_unit_useful_life_two:"null").',';
		...
		$sql .= ' codcont = '.(isset($this->codcont)?$this->codcont:"null").',';
		$sql .= ' codaux = '.(isset($this->codaux)?$this->codaux:"null").',';
		$sql .= ' orgfin = '.(isset($this->orgfin)?"'".$this->db->escape($this->orgfin)."'":"null").',';
		$sql .= ' cod_rube = '.(isset($this->cod_rube)?"'".$this->db->escape($this->cod_rube)."'":"null").',';
		$sql .= ' fk_departament = '.(isset($this->fk_departament)?$this->fk_departament:"null").',';
		$sql .= ' fk_resp = '.(isset($this->fk_resp)?$this->fk_resp:"null").',';
		$sql .= ' departament_name = '.(isset($this->departament_name)?"'".$this->db->escape($this->departament_name)."'":"null").',';
		$sql .= ' resp_name = '.(isset($this->resp_name)?"'".$this->db->escape($this->resp_name)."'":"null").',';
	...
	public function initAsSpecimen()
	{
		...
		$this->baja_month = '';
		$this->baja_year = '';
		$this->baja_resolution = '';
		$this->baja_observation = '';
		$this->baja_motive = '';
		$this->baja_amount_act = '';
		$this->baja_amount_depgestion = '';
		$this->amount_sale = '';
		$this->descrip = '';
		$this->number_plaque = '';
		$this->trademark = '';
		...
		$this->fk_product = '';
		$this->useful_life = '';
		$this->useful_life_two = '';
		$this->fk_unit_useful_life_two = '';
		$this->percent = '';
