...
/**
 * \file    orgman/mlocation.class.php
 * \ingroup orgman
...
class Mlocation extends CommonObject
{
	 ...
	 */
	public $element = 'mlocation';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_location';

	/**
	 * @var MlocationLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mlocation", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
