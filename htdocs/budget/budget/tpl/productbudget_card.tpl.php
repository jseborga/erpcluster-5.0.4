...
dol_include_once('/budget/class/productbudget.class.php');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldwork_hours").'</td><td><input class="flat" type="text" name="work_hours" value="'.GETPOST('work_hours').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldgroup_structure").'</td><td><input class="flat" type="text" name="group_structure" value="'.$object->group_structure.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldunits").'</td><td><input class="flat" type="text" name="units" value="'.$object->units.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcommander").'</td><td><input class="flat" type="text" name="commander" value="'.$object->commander.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprice_productive").'</td><td><input class="flat" type="text" name="price_productive" value="'.$object->price_productive.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprice_improductive").'</td><td><input class="flat" type="text" name="price_improductive" value="'.$object->price_improductive.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldwork_hours").'</td><td><input class="flat" type="text" name="work_hours" value="'.$object->work_hours.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldgroup_structure").'</td><td>'.$object->group_structure.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldformula").'</td><td>'.$object->formula.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldunits").'</td><td>'.$object->units.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcommander").'</td><td>'.$object->commander.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprice_productive").'</td><td>'.$object->price_productive.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprice_improductive").'</td><td>'.$object->price_improductive.'</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldwork_hours").'</td><td>'.$object->work_hours.'</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>'.$object->status.'</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('productbudget'));
