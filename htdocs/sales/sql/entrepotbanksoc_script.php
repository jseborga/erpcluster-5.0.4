...
/**
 *      \file       sales/entrepotbanksoc_script.php
 *		\ingroup    sales
...
// Examples for manipulating class entrepotbanksoc_class
require_once(DOL_DOCUMENT_ROOT."/../sales/entrepotbanksoc.class.php");
$myobject=new Entrepotbanksoc($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."entrepotbanksoc";
