 ...
 *				Initialy built by build_class_from_table on 2014-08-20 15:27
 */
...
class Poaworkflow extends CommonObject
{
	...
	var $element='poaworkflow';			//!< Id that identify managed objects
	var $table_element='poaworkflow';		//!< Name of table without prefix where object is stored
