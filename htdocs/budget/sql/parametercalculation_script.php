...
/**
 *      \file       budget/parametercalculation_script.php
 *		\ingroup    budget
...
// Examples for manipulating class parametercalculation_class
require_once(DOL_DOCUMENT_ROOT."/../budget/parametercalculation.class.php");
$myobject=new Parametercalculation($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."parametercalculation";
