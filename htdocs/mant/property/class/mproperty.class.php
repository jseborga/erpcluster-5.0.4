...
/**
 *  \file       dev/skeletons/mproperty.class.php
 ...
 */
class Mproperty extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='mproperty';			//!< Id that identify managed objects
	var $table_element='mproperty';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."m_property(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."m_property");
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."m_property SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."m_property";
    		$sql.= " WHERE rowid=".$this->id;
     ...
     */
	function select_property($selected='',$htmlname='fk_property',$htmloption='',$maxlength=0,$showempty=0)
    {
        global $conf,$langs;
