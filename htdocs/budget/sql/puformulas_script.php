...
/**
 *      \file       priceunits/puformulas_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class puformulas_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/puformulas.class.php");
$myobject=new Puformulas($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."puformulas";
