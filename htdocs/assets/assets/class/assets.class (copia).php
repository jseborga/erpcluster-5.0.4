 ...
 *				Initialy built by build_class_from_table on 2014-07-10 13:52
 */
 ...
 */
class Assets extends CommonObject_
{
    ...
    function create($user, $notrigger=0)
    {
		...
		$sql.= " ".(! isset($this->item_asset)?'NULL':"'".$this->db->escape($this->item_asset)."'").",";
    ...
    function update($user=0, $notrigger=0)
    {
		...
		$sql.= " item_asset=".(isset($this->item_asset)?"'".$this->db->escape($this->item_asset)."'":"null").",";
     ...
     */
    function select_assets($selected='',$htmlname='fk_asset',$htmloption='',$maxlength=0,$showempty=0,$idnot=0,$required='',$exclude='')
    {
        global $conf,$langs;
