...
class Projetpaiementdet extends CommonObject
{
	 ...
	 */
	public function fetch($id, $ref = null,$fk=0,$fkprojettask=0,$fkobjectdet=0,$nameobjectdet='')
	
	{
		...
		if($fk>0 && $fkprojettask>0 && $fkobjectdet>0 && !empty($nameobjectdet)){
			$sql.= " WHERE t.fk_projet_paiement = ".$fk;
			$sql.= " AND t.fk_projet_task = ".$fkprojettask;
			$sql.= " AND t.fk_objectdet = ".$fkobjectdet;
			$sql.= " AND t.objectdet = '".trim($nameobjectdet)."'";
