...
/**
 *   	\file       priceunits/items_card.php
 *		\ingroup    priceunits
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-10-20 10:05
 */
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_type_item").'</td><td><input class="flat" type="text" name="fk_type_item" value="'.GETPOST('fk_type_item').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldespecification").'</td><td><input class="flat" type="text" name="especification" value="'.GETPOST('especification').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldplane").'</td><td><input class="flat" type="text" name="plane" value="'.GETPOST('plane').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldespecification").'</td><td><input class="flat" type="text" name="especification" value="'.$object->especification.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldplane").'</td><td><input class="flat" type="text" name="plane" value="'.$object->plane.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_type_item").'</td><td>$object->fk_type_item</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldespecification").'</td><td>$object->especification</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldplane").'</td><td>$object->plane</td></tr>';
