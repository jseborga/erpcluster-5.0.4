...
/**
 * \file    salary/pdepartament.class.php
 * \ingroup salary
...
class Pdepartament extends CommonObject
{
	 ...
	 */
	public $element = 'pdepartament';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'p_departament';

	/**
	 * @var PdepartamentLine[] Lines
	 */
	public $lines = array();
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $link = '<a href="'.DOL_URL_ROOT.'/salary/departament/fiche.php?id='.$this->id.'"';
