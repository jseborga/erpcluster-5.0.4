...
$hookmanager->initHooks(array('poaprev'));
...
if (empty($reshook))
{
	...
	$object->fk_poa_activity=GETPOST('fk_poa_activity','int');
	...
	$object->nro_preventive=GETPOST('nro_preventive','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_activity").'</td><td><input class="flat" type="text" name="fk_poa_activity" value="'.GETPOST('fk_poa_activity').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnro_preventive").'</td><td><input class="flat" type="text" name="nro_preventive" value="'.GETPOST('nro_preventive').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_activity").'</td><td><input class="flat" type="text" name="fk_poa_activity" value="'.$object->fk_poa_activity.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnro_preventive").'</td><td><input class="flat" type="text" name="nro_preventive" value="'.$object->nro_preventive.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_activity").'</td><td>$object->fk_poa_activity</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldnro_preventive").'</td><td>$object->nro_preventive</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldactive").'</td><td>$object->active</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('poaprev'));
