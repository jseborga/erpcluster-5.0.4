...
$hookmanager->initHooks(array('pperiod'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldmes").'</td><td><input class="flat" type="text" name="mes" value="'.GETPOST('mes').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldmes").'</td><td><input class="flat" type="text" name="mes" value="'.$object->mes.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldmes").'</td><td>$object->mes</td></tr>';
