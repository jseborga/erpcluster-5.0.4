...
$hookmanager->initHooks(array('poaobjetive'));
...
if (empty($reshook))
{
	...
	$object->fk_poa_strategic=GETPOST('fk_poa_strategic','int');
	...
	$object->expected_result=GETPOST('expected_result','alpha');
	$object->unit=GETPOST('unit','alpha');
	$object->pos=GETPOST('pos','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_strategic").'</td><td><input class="flat" type="text" name="fk_poa_strategic" value="'.GETPOST('fk_poa_strategic').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldexpected_result").'</td><td><input class="flat" type="text" name="expected_result" value="'.GETPOST('expected_result').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpos").'</td><td><input class="flat" type="text" name="pos" value="'.GETPOST('pos').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_strategic").'</td><td><input class="flat" type="text" name="fk_poa_strategic" value="'.$object->fk_poa_strategic.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldperiod_year").'</td><td><input class="flat" type="text" name="period_year" value="'.$object->period_year.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldexpected_result").'</td><td><input class="flat" type="text" name="expected_result" value="'.$object->expected_result.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldunit").'</td><td><input class="flat" type="text" name="unit" value="'.$object->unit.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpos").'</td><td><input class="flat" type="text" name="pos" value="'.$object->pos.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_poa_strategic").'</td><td>$object->fk_poa_strategic</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldperiod_year").'</td><td>$object->period_year</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldexpected_result").'</td><td>$object->expected_result</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldunit").'</td><td>$object->unit</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpos").'</td><td>$object->pos</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('poaobjetive'));
