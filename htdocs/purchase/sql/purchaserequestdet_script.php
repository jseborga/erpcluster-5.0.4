...
/**
 *      \file       purchase/purchaserequestdet_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class purchaserequestdet_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/purchaserequestdet.class.php");
$myobject=new Purchaserequestdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."purchaserequestdet";
