...
/**
 *   	\file       priceunits/puoperator_card.php
 *		\ingroup    priceunits
...
$hookmanager->initHooks(array('puoperator'));
...
if (empty($reshook))
{
	...
	$object->operator=GETPOST('operator','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldoperator").'</td><td><input class="flat" type="text" name="operator" value="'.GETPOST('operator').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldoperator").'</td><td><input class="flat" type="text" name="operator" value="'.$object->operator.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldoperator").'</td><td>$object->operator</td></tr>';
