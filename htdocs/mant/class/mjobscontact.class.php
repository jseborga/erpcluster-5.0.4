...
/**
 * \file    mant/mjobscontact.class.php
 * \ingroup mant
 ...
 * @see CommonObject
 */
class Mjobscontact extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'mjobscontact';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_jobs_contact';

	/**
	 * @var MjobscontactLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mjobscontact", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Mjobscontact($this->db);
