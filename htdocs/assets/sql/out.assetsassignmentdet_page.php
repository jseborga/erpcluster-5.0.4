...
/**
 *   	\file       /assetsassignmentdet_page.php
 *		\ingroup    
...
dol_include_once('//class/assetsassignmentdet.class.php');
...
print_liste_field_titre($langs->trans('fk_asset_assignment'),$_SERVER['PHP_SELF'],'t.fk_asset_assignment','',$param,'',$sortfield,$sortorder);
print_liste_field_titre($langs->trans('fk_asset'),$_SERVER['PHP_SELF'],'t.fk_asset','',$param,'',$sortfield,$sortorder);
...
print '<td>'.$obj->fk_asset_assignment.'</td>';
