...
/**
 *      \file       purchase/purchaserequest_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class purchaserequest_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/purchaserequest.class.php");
$myobject=new Purchaserequest($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."purchaserequest";
