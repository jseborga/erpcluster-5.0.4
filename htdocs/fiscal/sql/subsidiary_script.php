...
/**
 *      \file       fiscal/subsidiary_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class subsidiary_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/subsidiary.class.php");
$myobject=new Subsidiary($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."subsidiary";
