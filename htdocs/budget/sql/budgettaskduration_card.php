...
/**
 *   	\file       budget/budgettaskduration_card.php
 *		\ingroup    budget
...
$hookmanager->initHooks(array('budgettaskduration'));
...
if (empty($reshook))
{
	...
	$object->successor=GETPOST('successor','alpha');
	$object->predecessor=GETPOST('predecessor','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsuccessor").'</td><td><input class="flat" type="text" name="successor" value="'.GETPOST('successor').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpredecessor").'</td><td><input class="flat" type="text" name="predecessor" value="'.GETPOST('predecessor').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldduration").'</td><td><input class="flat" type="text" name="duration" value="'.GETPOST('duration').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsuccessor").'</td><td><input class="flat" type="text" name="successor" value="'.$object->successor.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpredecessor").'</td><td><input class="flat" type="text" name="predecessor" value="'.$object->predecessor.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldduration").'</td><td><input class="flat" type="text" name="duration" value="'.$object->duration.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsuccessor").'</td><td>$object->successor</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldpredecessor").'</td><td>$object->predecessor</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldduration").'</td><td>$object->duration</td></tr>';
