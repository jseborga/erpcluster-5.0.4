...
/**
 *   	\file       poa/partidaproduct_card.php
 *		\ingroup    poa
...
$hookmanager->initHooks(array('partidaproduct'));
...
if (empty($reshook))
{
	...
	$object->code_partida=GETPOST('code_partida','alpha');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_partida").'</td><td><input class="flat" type="text" name="code_partida" value="'.GETPOST('code_partida').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_partida").'</td><td><input class="flat" type="text" name="code_partida" value="'.$object->code_partida.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_partida").'</td><td>$object->code_partida</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldactive").'</td><td>$object->active</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('partidaproduct'));
