...
/**
 *      \file       assets/assetsmov_script.php
 *		\ingroup    assets
...
// Examples for manipulating class assetsmov_class
require_once(DOL_DOCUMENT_ROOT."/../assets/assetsmov.class.php");
$myobject=new Assetsmov($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assetsmov";
