...
/**
 *      \file       budget/budgetgeneral_script.php
 *		\ingroup    budget
...
// Examples for manipulating class budgetgeneral_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budgetgeneral.class.php");
$myobject=new Budgetgeneral($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgetgeneral";
