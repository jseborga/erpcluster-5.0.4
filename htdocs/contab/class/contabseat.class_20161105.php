 ...
 *				Initialy built by build_class_from_table on 2013-12-21 00:42
 */
...
class Contabseat extends CommonObject
{
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->type_numeric)) $this->type_numeric=trim($this->type_numeric);
		if (isset($this->sequential)) $this->sequential=trim($this->sequential);
		if (isset($this->seat_month)) $this->seat_month=trim($this->seat_month);
		if (isset($this->seat_year)) $this->seat_year=trim($this->seat_year);
		...
		$sql.= " ".(! isset($this->sequential)?'NULL':"'".$this->db->escape($this->sequential)."'").",";
    ...
    function update($user=0, $notrigger=0)
    {
		...
		$sql.= " sequential=".(isset($this->sequential)?"'".$this->db->escape($this->sequential)."'":"null").",";
