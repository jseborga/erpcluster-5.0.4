...
/**
 *      \file       purchase/unitconv_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class unitconv_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/unitconv.class.php");
$myobject=new Unitconv($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."unitconv";
