...
/**
 *  \file       dev/skeletons/cunits.class.php
...
class Cunits extends CommonObject
{
	...
	var $element='cunits';			//!< Id that identify managed objects
	var $table_element='c_units';		//!< Name of table without prefix where object is stored
