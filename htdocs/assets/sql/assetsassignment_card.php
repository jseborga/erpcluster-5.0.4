...
/**
 *   	\file       assets/assetsassignment_card.php
 *		\ingroup    assets
...
$hookmanager->initHooks(array('assetsassignment'));
...
if (empty($reshook))
{
	...
	$object->fk_projet_from=GETPOST('fk_projet_from','int');
	$object->fk_user_from=GETPOST('fk_user_from','int');
	$object->fk_property_from=GETPOST('fk_property_from','int');
	...
	$object->type_assignment=GETPOST('type_assignment','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_from").'</td><td><input class="flat" type="text" name="fk_projet_from" value="'.GETPOST('fk_projet_from').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_property_from").'</td><td><input class="flat" type="text" name="fk_property_from" value="'.GETPOST('fk_property_from').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_assignment").'</td><td><input class="flat" type="text" name="type_assignment" value="'.GETPOST('type_assignment').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_from").'</td><td><input class="flat" type="text" name="fk_projet_from" value="'.$object->fk_projet_from.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_property_from").'</td><td><input class="flat" type="text" name="fk_property_from" value="'.$object->fk_property_from.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_property").'</td><td><input class="flat" type="text" name="fk_property" value="'.$object->fk_property.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_assignment").'</td><td><input class="flat" type="text" name="type_assignment" value="'.$object->type_assignment.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_projet_from").'</td><td>$object->fk_projet_from</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_from").'</td><td>$object->fk_user_from</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_property_from").'</td><td>$object->fk_property_from</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_to").'</td><td>$object->fk_user_to</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_property").'</td><td>$object->fk_property</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_assignment").'</td><td>$object->type_assignment</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('assetsassignment'));
