...
/**
 *      \file       monprojet/producttask_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class producttask_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/producttask.class.php");
$myobject=new Producttask($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."producttask";
