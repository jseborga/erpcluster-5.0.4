...
/**
 *      \file       assets/cassetsbeen_script.php
 *		\ingroup    assets
...
// Examples for manipulating class cassetsbeen_class
require_once(DOL_DOCUMENT_ROOT."/../assets/cassetsbeen.class.php");
$myobject=new Cassetsbeen($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cassetsbeen";
