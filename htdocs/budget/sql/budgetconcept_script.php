...
/**
 *      \file       budget/budgetconcept_script.php
 *		\ingroup    budget
...
// Examples for manipulating class budgetconcept_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budgetconcept.class.php");
$myobject=new Budgetconcept($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgetconcept";
