...
/**
 *      \file       finint/requestcashdeplacement_script.php
 *		\ingroup    finint
...
// Examples for manipulating class requestcashdeplacement_class
require_once(DOL_DOCUMENT_ROOT."/../finint/requestcashdeplacement.class.php");
$myobject=new Requestcashdeplacement($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."requestcashdeplacement";
