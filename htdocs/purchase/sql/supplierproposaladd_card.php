...
/**
 *   	\file       purchase/supplierproposaladd_card.php
 *		\ingroup    purchase
...
$hookmanager->initHooks(array('supplierproposaladd'));
...
if (empty($reshook))
{
	...
	$object->fk_supplier_proposal=GETPOST('fk_supplier_proposal','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_supplier_proposal").'</td><td><input class="flat" type="text" name="fk_supplier_proposal" value="'.GETPOST('fk_supplier_proposal').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_supplier_proposal").'</td><td><input class="flat" type="text" name="fk_supplier_proposal" value="'.$object->fk_supplier_proposal.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_supplier_proposal").'</td><td>$object->fk_supplier_proposal</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('supplierproposaladd'));
