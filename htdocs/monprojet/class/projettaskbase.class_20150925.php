 ...
 *				Initialy built by build_class_from_table on 2014-09-29 14:25
 */
...
class Projettaskbase extends CommonObject
{
	...
	var $element='projettaskbase';			//!< Id that identify managed objects
	var $table_element='projettaskbase';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."projet_task_base(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."projet_task_base");
    ...
    function fetch($id)
    {
        ...
        $sql.= " FROM ".MAIN_DB_PREFIX."projet_task_base as t";
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."projet_task_base SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."projet_task_base";
    		$sql.= " WHERE rowid=".$this->id;
