 ...
 *				Initialy built by build_class_from_table on 2014-12-05 09:58
 */
...
class Poapartidapredet extends CommonObject
{
	...
	var $element='poapartidapredet';			//!< Id that identify managed objects
	var $table_element='poapartidapredet';		//!< Name of table without prefix where object is stored
     ...
     *  @return int          	<0 if KO, >0 if OK
     */
    function getsum($fk_poa_partida_pre)
    {
    	global $langs;
        $sql = "SELECT";
