...
/**
 *   	\file       assets/assethistorial_list.php
 *		\ingroup    assets
...
't.pc_ip'=>array('label'=>$langs->trans("Fieldpc_ip"), 'checked'=>1),
...
$search_fk_user_mod='';
    ...
    $permtoread = $user->rights->assethistorial->read;
    $permtodelete = $user->rights->assethistorial->delete;
    $uploaddir = $conf->assethistorial->dir_output;
...
$sql.= " FROM ".MAIN_DB_PREFIX."asset_historial as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."asset_historial_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/assethistorial/card.php?id='.$id);
    exit;
}
