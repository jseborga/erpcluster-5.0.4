 ...
 */
class ModeleContab extends CommonDocGenerator    // This class can't be abstract as there is instance propreties loaded by liste_modeles
{
	var $error='';
 ...
 */
abstract class ModelePDFContab extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleNumRefContab
{
	var $error='';
 ...
 */
function contab_pdf_create($db, $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0, $hookmanager=false)
{
	...
	foreach($dirmodels as $reldir)
	{
    	foreach(array('doc','pdf') as $prefix)
    	{
	        ...
	        $file=dol_buildpath($reldir."contab/core/modules/doc/".$file,0);
    		if (file_exists($file))
    		{
    			$filefound=1;
