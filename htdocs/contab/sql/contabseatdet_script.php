...
/**
 *      \file       contab/contabseatdet_script.php
 *		\ingroup    contab
...
// Examples for manipulating class contabseatdet_class
require_once(DOL_DOCUMENT_ROOT."/../contab/contabseatdet.class.php");
$myobject=new Contabseatdet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."contabseatdet";
