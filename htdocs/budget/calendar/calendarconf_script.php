...
/**
 *      \file       budget/calendarconf_script.php
 *		\ingroup    budget
...
// Examples for manipulating class calendarconf_class
require_once(DOL_DOCUMENT_ROOT."/../budget/calendarconf.class.php");
$myobject=new Calendarconf($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."calendarconf";
