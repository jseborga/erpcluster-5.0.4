...
/**
 *   	\file       orgman/pdepartamentuser_card.php
 *		\ingroup    orgman
...
$object=new Pdepartamentuser($db);
...
$hookmanager->initHooks(array('pdepartamentuser'));
...
if (empty($reshook))
{
	...
	$object->privilege=GETPOST('privilege','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprivilege").'</td><td><input class="flat" type="text" name="privilege" value="'.GETPOST('privilege').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprivilege").'</td><td><input class="flat" type="text" name="privilege" value="'.$object->privilege.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprivilege").'</td><td>$object->privilege</td></tr>';
