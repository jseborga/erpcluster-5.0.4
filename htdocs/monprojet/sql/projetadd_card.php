...
/**
 *   	\file       monprojet/projetadd_card.php
 *		\ingroup    monprojet
...
$hookmanager->initHooks(array('projetadd'));
...
if (empty($reshook))
{
	...
	$object->programmed=GETPOST('programmed','alpha');
	$object->fk_contracting=GETPOST('fk_contracting','int');
	$object->fk_supervising=GETPOST('fk_supervising','int');
	$object->use_resource=GETPOST('use_resource','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprogrammed").'</td><td><input class="flat" type="text" name="programmed" value="'.GETPOST('programmed').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_contracting").'</td><td><input class="flat" type="text" name="fk_contracting" value="'.GETPOST('fk_contracting').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_supervising").'</td><td><input class="flat" type="text" name="fk_supervising" value="'.GETPOST('fk_supervising').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielduse_resource").'</td><td><input class="flat" type="text" name="use_resource" value="'.GETPOST('use_resource').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprogrammed").'</td><td><input class="flat" type="text" name="programmed" value="'.$object->programmed.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_contracting").'</td><td><input class="flat" type="text" name="fk_contracting" value="'.$object->fk_contracting.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_supervising").'</td><td><input class="flat" type="text" name="fk_supervising" value="'.$object->fk_supervising.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielduse_resource").'</td><td><input class="flat" type="text" name="use_resource" value="'.$object->use_resource.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldprogrammed").'</td><td>$object->programmed</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_contracting").'</td><td>$object->fk_contracting</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_supervising").'</td><td>$object->fk_supervising</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielduse_resource").'</td><td>$object->use_resource</td></tr>';
