...
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddate_day").'</td><td><input class="flat" type="text" name="date_day" value="'.GETPOST('date_day').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddate_month").'</td><td><input class="flat" type="text" name="date_month" value="'.GETPOST('date_month').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddate_year").'</td><td><input class="flat" type="text" name="date_year" value="'.GETPOST('date_year').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddate_day").'</td><td><input class="flat" type="text" name="date_day" value="'.$object->date_day.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddate_month").'</td><td><input class="flat" type="text" name="date_month" value="'.$object->date_month.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddate_year").'</td><td><input class="flat" type="text" name="date_year" value="'.$object->date_year.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	if (empty($reshook))
	{
		if ($user->rights->orgman->write)
		{
			print '<div class="inline-block divButAction"><a class="butAction" href="'.$_SERVER["PHP_SELF"].'?id='.$object->id.'&amp;action=edit">'.$langs->trans("Modify").'</a></div>'."\n";
		}

		if ($user->rights->orgman->delete)
		{
