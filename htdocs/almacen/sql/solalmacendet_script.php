...
/**
 *      \file       almacen/solalmacendet_script.php
 *		\ingroup    almacen
...
// Examples for manipulating class solalmacendet_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/solalmacendet.class.php");
$myobject=new Solalmacendet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."solalmacendet";
