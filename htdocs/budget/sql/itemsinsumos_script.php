...
/**
 *      \file       priceunits/itemsinsumos_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class itemsinsumos_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/itemsinsumos.class.php");
$myobject=new Itemsinsumos($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."itemsinsumos";
