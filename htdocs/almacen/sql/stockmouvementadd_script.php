...
/**
 *      \file       almacen/stockmouvementadd_script.php
 *		\ingroup    almacen
...
// Examples for manipulating class stockmouvementadd_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/stockmouvementadd.class.php");
$myobject=new Stockmouvementadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."stockmouvementadd";
