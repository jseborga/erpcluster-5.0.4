...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepot_from").'</td><td>$object->fk_entrepot_from</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_entrepot_to").'</td><td>$object->fk_entrepot_to</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_source").'</td><td>$object->fk_source</td></tr>';
