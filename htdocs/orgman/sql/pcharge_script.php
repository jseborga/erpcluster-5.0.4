...
/**
 *      \file       orgman/pcharge_script.php
 *		\ingroup    orgman
...
// Examples for manipulating class pcharge_class
require_once(DOL_DOCUMENT_ROOT."/../orgman/pcharge.class.php");
$myobject=new Pcharge($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."pcharge";
