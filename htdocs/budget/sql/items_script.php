...
/**
 *      \file       priceunits/items_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class items_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/items.class.php");
$myobject=new Items($db);
