...
class Assetsassignmentdetext extends Assetsassignmentdet
{
	public $array;
	public $aAsset;
		//modificado
	 ...
	 *  @return int             <0 if KO, >0 if OK
	 */
	function getlistassetsassignment($fk_property=0,$status=0)
	{
		global $langs;
		//status 0 pendiente
		//status 1 asignado
	 ...
	 *  @return int          	<0 if KO, >0 if OK
	 */
	function getlistassignment($fk_asset_assignment,$fk_property=0,$status=0)
	{
		global $langs;
		//status 0 pendiente
		//status 1 asignado
	 ...
	 *  @return int          	<0 if KO, >0 if OK
	 */
	function getlistassignment_user($user,$fk_property=0,$status=0)
	{
		global $langs;
		$sql = "SELECT";
		$sql.= " t.rowid,";
	 ...
	 *  @return int          	<0 if KO, >0 if OK
	 */
	function fetch_ult($fk_asset,$status = 1,$limit=1)
	{
		global $langs;
		$sql = "SELECT";
		$sql.= " t.rowid,";
