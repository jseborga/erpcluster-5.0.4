...
/**
 *   	\file       budget/budgettaskadd_card.php
 *		\ingroup    budget
...
$hookmanager->initHooks(array('budgettaskadd'));
...
if (empty($reshook))
{
	...
	$object->complementary=GETPOST('complementary','alpha');
	$object->unit_budget=GETPOST('unit_budget','alpha');
	$object->unit_amount=GETPOST('unit_amount','alpha');
	$object->total_amount=GETPOST('total_amount','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcomplementary").'</td><td><input class="flat" type="text" name="complementary" value="'.GETPOST('complementary').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtotal_amount").'</td><td><input class="flat" type="text" name="total_amount" value="'.GETPOST('total_amount').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcomplementary").'</td><td><input class="flat" type="text" name="complementary" value="'.$object->complementary.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtotal_amount").'</td><td><input class="flat" type="text" name="total_amount" value="'.$object->total_amount.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcomplementary").'</td><td>$object->complementary</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtotal_amount").'</td><td>$object->total_amount</td></tr>';
