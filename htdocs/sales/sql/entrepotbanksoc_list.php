...
/**
 *   	\file       sales/entrepotbanksoc_list.php
 *		\ingroup    sales
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-11-22 22:17
 */
...
dol_include_once('/sales/class/entrepotbanksoc.class.php');
...
$search_numero_ip=GETPOST('search_numero_ip','alpha');
$search_fk_user=GETPOST('search_fk_user','int');
$search_fk_entrepotid=GETPOST('search_fk_entrepotid','int');
$search_fk_socid=GETPOST('search_fk_socid','int');
$search_fk_cajaid=GETPOST('search_fk_cajaid','int');
$search_fk_bankid=GETPOST('search_fk_bankid','int');
$search_fk_banktcid=GETPOST('search_fk_banktcid','int');
...
$hookmanager->initHooks(array('entrepotbanksoclist'));
...
't.numero_ip'=>array('label'=>$langs->trans("Fieldnumero_ip"), 'checked'=>1),
't.fk_user'=>array('label'=>$langs->trans("Fieldfk_user"), 'checked'=>1),
't.fk_entrepotid'=>array('label'=>$langs->trans("Fieldfk_entrepotid"), 'checked'=>1),
't.fk_socid'=>array('label'=>$langs->trans("Fieldfk_socid"), 'checked'=>1),
't.fk_cajaid'=>array('label'=>$langs->trans("Fieldfk_cajaid"), 'checked'=>1),
't.fk_bankid'=>array('label'=>$langs->trans("Fieldfk_bankid"), 'checked'=>1),
't.fk_banktcid'=>array('label'=>$langs->trans("Fieldfk_banktcid"), 'checked'=>1),
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."entrepot_bank_soc_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
//$sql.= " WHERE u.entity IN (".getEntity('mytable',1).")";

if ($search_entity) $sql.= natural_search("entity",$search_entity);
if ($search_numero_ip) $sql.= natural_search("numero_ip",$search_numero_ip);
if ($search_fk_user) $sql.= natural_search("fk_user",$search_fk_user);
if ($search_fk_entrepotid) $sql.= natural_search("fk_entrepotid",$search_fk_entrepotid);
if ($search_fk_socid) $sql.= natural_search("fk_socid",$search_fk_socid);
if ($search_fk_cajaid) $sql.= natural_search("fk_cajaid",$search_fk_cajaid);
if ($search_fk_bankid) $sql.= natural_search("fk_bankid",$search_fk_bankid);
if ($search_fk_banktcid) $sql.= natural_search("fk_banktcid",$search_fk_banktcid);
...
if ($search_numero_ip != '') $params.= '&amp;search_numero_ip='.urlencode($search_numero_ip);
if ($search_fk_user != '') $params.= '&amp;search_fk_user='.urlencode($search_fk_user);
if ($search_fk_entrepotid != '') $params.= '&amp;search_fk_entrepotid='.urlencode($search_fk_entrepotid);
if ($search_fk_socid != '') $params.= '&amp;search_fk_socid='.urlencode($search_fk_socid);
if ($search_fk_cajaid != '') $params.= '&amp;search_fk_cajaid='.urlencode($search_fk_cajaid);
if ($search_fk_bankid != '') $params.= '&amp;search_fk_bankid='.urlencode($search_fk_bankid);
if ($search_fk_banktcid != '') $params.= '&amp;search_fk_banktcid='.urlencode($search_fk_banktcid);
...
if (! empty($arrayfields['t.numero_ip']['checked'])) print_liste_field_titre($arrayfields['t.numero_ip']['label'],$_SERVER['PHP_SELF'],'t.numero_ip','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_entrepotid']['checked'])) print_liste_field_titre($arrayfields['t.fk_entrepotid']['label'],$_SERVER['PHP_SELF'],'t.fk_entrepotid','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_socid']['checked'])) print_liste_field_titre($arrayfields['t.fk_socid']['label'],$_SERVER['PHP_SELF'],'t.fk_socid','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_cajaid']['checked'])) print_liste_field_titre($arrayfields['t.fk_cajaid']['label'],$_SERVER['PHP_SELF'],'t.fk_cajaid','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_bankid']['checked'])) print_liste_field_titre($arrayfields['t.fk_bankid']['label'],$_SERVER['PHP_SELF'],'t.fk_bankid','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_banktcid']['checked'])) print_liste_field_titre($arrayfields['t.fk_banktcid']['label'],$_SERVER['PHP_SELF'],'t.fk_banktcid','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.numero_ip']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_numero_ip" value="'.$search_numero_ip.'" size="10"></td>';
...
if (! empty($arrayfields['t.fk_entrepotid']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_entrepotid" value="'.$search_fk_entrepotid.'" size="10"></td>';
if (! empty($arrayfields['t.fk_socid']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_socid" value="'.$search_fk_socid.'" size="10"></td>';
if (! empty($arrayfields['t.fk_cajaid']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_cajaid" value="'.$search_fk_cajaid.'" size="10"></td>';
if (! empty($arrayfields['t.fk_bankid']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_bankid" value="'.$search_fk_bankid.'" size="10"></td>';
if (! empty($arrayfields['t.fk_banktcid']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_banktcid" value="'.$search_fk_banktcid.'" size="10"></td>';
