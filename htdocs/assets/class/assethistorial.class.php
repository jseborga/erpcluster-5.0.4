...
/**
 * \file    assets/assethistorial.class.php
 * \ingroup assets
...
/**
 * Class Assethistorial
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Assethistorial extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'assethistorial';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'asset_historial';

	/**
	 * @var AssethistorialLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("assethistorial", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Assethistorial($this->db);
