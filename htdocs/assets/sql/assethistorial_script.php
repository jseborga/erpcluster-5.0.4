...
/**
 *      \file       assets/assethistorial_script.php
 *		\ingroup    assets
...
// Examples for manipulating class assethistorial_class
require_once(DOL_DOCUMENT_ROOT."/../assets/assethistorial.class.php");
$myobject=new Assethistorial($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."assethistorial";
