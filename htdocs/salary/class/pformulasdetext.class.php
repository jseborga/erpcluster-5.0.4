<?php
require_once DOL_DOCUMENT_ROOT.'/salary/class/pformulasdet.class.php';

class Pformulasdetext extends Pformulasdet
{
	/**
	...
	function sequen_det($ref_formula)
	{
		...
		$sql = "SELECT";
		$sql.= " t.sequen ";
		$sql.= " FROM ".MAIN_DB_PREFIX."p_formulas_det as t";
