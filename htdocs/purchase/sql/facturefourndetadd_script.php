...
/**
 *      \file       purchase/facturefourndetadd_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class facturefourndetadd_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/facturefourndetadd.class.php");
$myobject=new Facturefourndetadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."facturefourndetadd";
