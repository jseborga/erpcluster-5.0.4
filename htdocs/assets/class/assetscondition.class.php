...
/**
 * \file    assets/assetscondition.class.php
 * \ingroup assets
...
/**
 * Class Assetscondition
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Assetscondition extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'assetscondition';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'assets_condition';

	/**
	 * @var AssetsconditionLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("assetscondition", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Assetscondition($this->db);
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Assetscondition") . '</u>';
        $label.= '<br>';
