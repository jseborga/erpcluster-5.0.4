...
/**
 *      \file       assets/cassetspatrim_script.php
 *		\ingroup    assets
...
// Examples for manipulating class cassetspatrim_class
require_once(DOL_DOCUMENT_ROOT."/../assets/cassetspatrim.class.php");
$myobject=new Cassetspatrim($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cassetspatrim";
