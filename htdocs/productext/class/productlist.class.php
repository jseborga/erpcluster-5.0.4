...
/**
 * \file    fabrication/productlist.class.php
 * \ingroup fabrication
...
class Productlist extends CommonObject
{
	 ...
	 */
	public $element = 'productlist';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'product_list';

	/**
	 * @var ProductlistLine[] Lines
	 */
	public $lines = array();
	...
	public $entity;
	public $fk_product_father;
	public $fk_unit_father;
	public $fk_product_son;
	public $fk_unit_son;
	public $qty_father;
	public $qty_son;
	public $statut;
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_product_father)) {
			 $this->fk_product_father = trim($this->fk_product_father);
		}
		if (isset($this->fk_unit_father)) {
			 $this->fk_unit_father = trim($this->fk_unit_father);
		}
		if (isset($this->fk_product_son)) {
			 $this->fk_product_son = trim($this->fk_product_son);
		}
		if (isset($this->fk_unit_son)) {
			 $this->fk_unit_son = trim($this->fk_unit_son);
		}
		if (isset($this->qty_father)) {
			 $this->qty_father = trim($this->qty_father);
		}
		if (isset($this->qty_son)) {
			 $this->qty_son = trim($this->qty_son);
		}
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("productlist", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ProductlistLine();

				$line->id = $obj->rowid;
				
				$line->entity = $obj->entity;
				$line->fk_product_father = $obj->fk_product_father;
				$line->fk_unit_father = $obj->fk_unit_father;
				$line->fk_product_son = $obj->fk_product_son;
				$line->fk_unit_son = $obj->fk_unit_son;
				$line->qty_father = $obj->qty_father;
				$line->qty_son = $obj->qty_son;
