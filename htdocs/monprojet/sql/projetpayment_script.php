...
/**
 *      \file       monprojet/projetpayment_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projetpayment_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projetpayment.class.php");
$myobject=new Projetpayment($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projetpayment";
