...
if (!$user->rights->almacen->inv->kard || !$user->rights->almacen->inv->inv) accessforbidden();
...
llxHeader("",$langs->trans("Managementwarehouse"),$help_url);


print '<div><p>'.$langs->trans('Consultations').'</p></div>';
