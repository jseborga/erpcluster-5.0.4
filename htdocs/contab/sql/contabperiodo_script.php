...
/**
 *      \file       contab/contabperiodo_script.php
 *		\ingroup    contab
...
// Examples for manipulating class contabperiodo_class
require_once(DOL_DOCUMENT_ROOT."/../contab/contabperiodo.class.php");
$myobject=new Contabperiodo($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."contabperiodo";
