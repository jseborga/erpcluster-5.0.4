...
/**
 *   	\file       budget/budgetgeneral_list.php
 *		\ingroup    budget
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-11-07 11:14
 */
...
$search_second_currency=GETPOST('search_second_currency','alpha');
...
$hookmanager->initHooks(array('budgetgenerallist'));
...
't.second_currency'=>array('label'=>$langs->trans("Fieldsecond_currency"), 'checked'=>1),
't.decimal_quant'=>array('label'=>$langs->trans("Fielddecimal_quant"), 'checked'=>1),
't.decimal_pu'=>array('label'=>$langs->trans("Fielddecimal_pu"), 'checked'=>1),
't.decimal_total'=>array('label'=>$langs->trans("Fielddecimal_total"), 'checked'=>1),
...
$search_second_currency='';
$search_decimal_quant='';
$search_decimal_pu='';
$search_decimal_total='';
...
$sql.= " FROM ".MAIN_DB_PREFIX."budget_general as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."budget_general_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_second_currency) $sql.= natural_search("second_currency",$search_second_currency);
if ($search_decimal_quant) $sql.= natural_search("decimal_quant",$search_decimal_quant);
if ($search_decimal_pu) $sql.= natural_search("decimal_pu",$search_decimal_pu);
if ($search_decimal_total) $sql.= natural_search("decimal_total",$search_decimal_total);
...
if ($search_second_currency != '') $params.= '&amp;search_second_currency='.urlencode($search_second_currency);
if ($search_decimal_quant != '') $params.= '&amp;search_decimal_quant='.urlencode($search_decimal_quant);
if ($search_decimal_pu != '') $params.= '&amp;search_decimal_pu='.urlencode($search_decimal_pu);
if ($search_decimal_total != '') $params.= '&amp;search_decimal_total='.urlencode($search_decimal_total);
...
if (! empty($arrayfields['t.second_currency']['checked'])) print_liste_field_titre($arrayfields['t.second_currency']['label'],$_SERVER['PHP_SELF'],'t.second_currency','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.decimal_quant']['checked'])) print_liste_field_titre($arrayfields['t.decimal_quant']['label'],$_SERVER['PHP_SELF'],'t.decimal_quant','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.decimal_pu']['checked'])) print_liste_field_titre($arrayfields['t.decimal_pu']['label'],$_SERVER['PHP_SELF'],'t.decimal_pu','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.decimal_total']['checked'])) print_liste_field_titre($arrayfields['t.decimal_total']['label'],$_SERVER['PHP_SELF'],'t.decimal_total','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.second_currency']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_second_currency" value="'.$search_second_currency.'" size="10"></td>';
if (! empty($arrayfields['t.decimal_quant']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_decimal_quant" value="'.$search_decimal_quant.'" size="10"></td>';
if (! empty($arrayfields['t.decimal_pu']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_decimal_pu" value="'.$search_decimal_pu.'" size="10"></td>';
if (! empty($arrayfields['t.decimal_total']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_decimal_total" value="'.$search_decimal_total.'" size="10"></td>';
