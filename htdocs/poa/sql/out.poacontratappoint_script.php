...
/**
 *      \file       dev/skeletons/poacontratappoint_script.php
 *		\ingroup    mymodule
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/poacontratappoint.class.php");
$myobject=new Poacontratappoint($db);
