...
/**
 *      \file       fiscal/ctypefacture_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class ctypefacture_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/ctypefacture.class.php");
$myobject=new Ctypefacture($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."ctypefacture";
