...
/**
 *      \file       priceunits/puproceduredet_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class puproceduredet_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/puproceduredet.class.php");
$myobject=new Puproceduredet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."puproceduredet";
