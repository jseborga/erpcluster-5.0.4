...
require_once DOL_DOCUMENT_ROOT.'/almacen/unitsproduct/class/unitsproduct.class.php';
...
if ($removecat > 0)
{
  if ($user->rights->almacen->creer)
    {
      require_once DOL_DOCUMENT_ROOT.'/almacen/unitsproduct/class/unitsproduct.class.php';
      $object = new Unitsproduct($db);
      $result = $object->fetch($id, $ref);
      $elementtype = 'unitsproduct';
    }
  $objup = new Unitsproduct($db);
  $result=$objup->fetch($removecat);
  $result=$objup->del_type($object,$elementtype);
}
