...
/**
 *      \file       budget/budgettaskproductivity_script.php
 *		\ingroup    budget
...
// Examples for manipulating class budgettaskproductivity_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budgettaskproductivity.class.php");
$myobject=new Budgettaskproductivity($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgettaskproductivity";
