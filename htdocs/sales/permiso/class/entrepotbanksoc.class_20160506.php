 ...
 *				Initialy built by build_class_from_table on 2015-09-24 19:37
 */
...
class Entrepotbanksoc extends CommonObject
{
	...
	var $table_element='entrepotbanksoc';		//!< Name of table without prefix where object is stored
