...
/**
 *      \file       almacen/solalmacen_script.php
 *		\ingroup    almacen
...
// Examples for manipulating class solalmacen_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/solalmacen.class.php");
$myobject=new Solalmacen($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."solalmacen";
