...
/**
 * \file    finint/requestcashdet.class.php
 * \ingroup finint
...
/**
 * Class Requestcashdet
 *
 * Put here description of your class
 * @see CommonObject
 */
class Requestcashdet extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'requestcashdet';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'request_cash_det';

	/**
	 * @var RequestcashdetLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_request)) {
			 $this->fk_request = trim($this->fk_request);
		}
		...
		$sql .= ' '.(! isset($this->fk_request)?'NULL':$this->fk_request).',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->fk_request = $obj->fk_request;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new RequestcashdetLine();

				$line->id = $obj->rowid;
				
				$line->fk_request = $obj->fk_request;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' fk_request = '.(isset($this->fk_request)?$this->fk_request:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Requestcashdet($this->db);
