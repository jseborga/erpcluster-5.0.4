...
/**
 *      \file       budget/budgettaskduration_script.php
 *		\ingroup    budget
...
// Examples for manipulating class budgettaskduration_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budgettaskduration.class.php");
$myobject=new Budgettaskduration($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgettaskduration";
