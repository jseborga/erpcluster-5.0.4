...
/**
 *      \file       almacen/ctypemouvement_script.php
 *		\ingroup    almacen
...
// Examples for manipulating class ctypemouvement_class
require_once(DOL_DOCUMENT_ROOT."/../almacen/ctypemouvement.class.php");
$myobject=new Ctypemouvement($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."ctypemouvement";
