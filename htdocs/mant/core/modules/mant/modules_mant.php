 ...
 */
abstract class ModelePDFMant extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleMant extends CommonDocGenerator
{
	var $error='';
...
abstract class ModeleNumRefMant
{
	var $error='';
 ...
 */
function mant_pdf_create($db, $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0, $hookmanager=false)
{
	...
	foreach($dirmodels as $reldir)
	{
    	foreach(array('doc','pdf') as $prefix)
    	{
	        ...
	        $file=dol_buildpath($reldir."mant/core/modules/doc/".$file,0);
    		if (file_exists($file))
    		{
    			$filefound=1;
