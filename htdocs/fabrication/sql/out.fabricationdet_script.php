...
/**
 *      \file       dev/skeletons/fabricationdet_script.php
 *		\ingroup    mymodule othermodule1 othermodule2
 *      \brief      This file is an example for a command line script
 *					Initialy built by build_class_from_table on 2016-09-01 18:56
 */
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/fabricationdet.class.php");
$myobject=new Fabricationdet($db);
