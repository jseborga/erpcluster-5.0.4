...
class Projettasktimedoc extends CommonObject
{
	...
	/* Var string name of table without prefx where object is father*/
	 ...
	 *  @return int          	<0 if KO, >0 if OK
	 */
	function getsum($id,$fk_payment=0,$statut=1,$fk_requestitem=0)
	{
	  global $langs;
	  $sql = "SELECT";
	  ...
	  if ($fk_requestitem)
	    $sql.= " AND t.fk_request_item = ".$fk_request_item;
