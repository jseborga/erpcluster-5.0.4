...
class SupplierProposalext extends SupplierProposal
{
	...
	function fetch_linesadd($only_product=0)
	{
		...
		$sql = 'SELECT l.rowid, l.fk_supplier_proposal, l.fk_product, l.fk_parent_line, l.product_type, l.fk_supplier_proposal, l.label as custom_label, l.description, l.price, l.qty, l.tva_tx,';
		...
		$sql.= ' la.fk_object, la.object, la.fk_fabrication, la.fk_fabricationdet, la.fk_projet, la.fk_projet_task, la.fk_jobs, la.fk_jobsdet, la.fk_structure, la.fk_poa, la.partida, la.amount_ice, la.discount, ';
		$sql.= ' p.ref as product_ref, p.description as product_desc, p.fk_product_type, p.label as product_label,';
		$sql.= ' p.weight, p.weight_units, p.volume, p.volume_units';
		$sql.= ' FROM '.MAIN_DB_PREFIX.'supplier_proposaldet as l';
		$sql.= ' LEFT JOIN '.MAIN_DB_PREFIX.'supplier_proposaldet_add as la ON la.fk_supplier_proposaldet = l.rowid';
