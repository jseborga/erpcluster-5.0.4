 ...
 * Copyright (C) 2014-2015 Ramiro Queso  <ramiroques@gmail.com.net>
 * 
...
/**
 *  \file       dev/skeletons/poastructure.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2014-06-05 13:25
 */
...
class Poastructure extends CommonObject
{
	...
	var $element='poa_structure';			//!< Id that identify managed objects
	var $table_element='poa_structure';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."poa_structure(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."poa_structure");
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."poa_structure SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."poa_structure";
    		$sql.= " WHERE rowid=".$this->id;
    ...
    function getlist($fk_father)
    {
	  ...
	  $num = $this->db->num_rows($resql);
	      ...
	      while ($i < $num)
		{
		  ...
		  // $this->array[$obj->rowid]['id']    = $obj->rowid;
		  // $this->array[$obj->rowid]['entity'] = $obj->entity;
		  // $this->array[$obj->rowid]['gestion'] = $obj->gestion;
		  // $this->array[$obj->rowid]['fk_father'] = $obj->fk_father;
		  // $this->array[$obj->rowid]['ref'] = $obj->ref;
		  // $this->array[$obj->rowid]['label'] = $obj->label;
		  // $this->array[$obj->rowid]['pseudonym'] = $obj->pseudonym;
		  // $this->array[$obj->rowid]['pos'] = $obj->pos;
		  // $this->array[$obj->rowid]['fk_area'] = $obj->fk_area;
		  // $this->array[$obj->rowid]['weighting'] = $obj->weighting;
		  // $this->array[$obj->rowid]['version'] = $obj->version;
		  // $this->array[$obj->rowid]['statut'] = $obj->statut;
		  $i++;
                }
	      return $array;
            }
	  ...
	  while ($res1 == True)
	      ...
	      if (count($this->array)>0)
		{
		  foreach ((array) $this->array AS $k => $fk_father)
		    {
		      echo '<br>i '.$k.' f '.$fk_father;
		      $aArray[$fk_father][$k] = $k;
		      echo '<br>enviado dos  '.$k;
		      echo ' res2 '.$resx = $this->get_search($rowid,$k,$aArray);
		    }
		  $res1 = 0;
		}
	      else
