...
/**
 * \file    budget/puformulasdet.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Puformulasdet extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'puformulasdet';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'pu_formulas_det';

	/**
	 * @var PuformulasdetLine[] Lines
	 */
	public $lines = array();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Puformulasdet($this->db);
