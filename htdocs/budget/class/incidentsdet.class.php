...
/**
 * \file    budget/incidentsdet.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Incidentsdet extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'incidentsdet';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'incidents_det';

	/**
	 * @var IncidentsdetLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("incidentsdet", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Incidentsdet($this->db);
