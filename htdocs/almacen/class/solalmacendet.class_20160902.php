 ...
 *				Initialy built by build_class_from_table on 2016-09-01 17:59
 */
...
class Solalmacendet extends CommonObject
{
	...
	var $table_element='sol_almacendet';	//!< Name of table without prefix where object is stored
			...
			if ($this->db->num_rows($resql))
			{
				...
				while ($i < min($num,$limit))
				{
					...
					array(
						...
						'fk_fabricationdet' => $obj->fk_fabricationdet,
						'qty'           => $obj->qty,
