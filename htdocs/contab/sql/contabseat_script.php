...
/**
 *      \file       contab/contabseat_script.php
 *		\ingroup    contab
...
// Examples for manipulating class contabseat_class
require_once(DOL_DOCUMENT_ROOT."/../contab/contabseat.class.php");
...
$sql.= " FROM ".MAIN_DB_PREFIX."contabseat";
