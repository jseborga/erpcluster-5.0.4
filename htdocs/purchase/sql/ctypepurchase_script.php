...
/**
 *      \file       purchase/ctypepurchase_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class ctypepurchase_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/ctypepurchase.class.php");
$myobject=new Ctypepurchase($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."ctypepurchase";
