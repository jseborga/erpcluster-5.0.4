...
require_once DOL_DOCUMENT_ROOT.'/fiscal/class/fournisseur.factureadd.class.php';
require_once DOL_DOCUMENT_ROOT.'/fiscal/class/html.formadd.class.php';
...
if ($action == 'create')
{
    ...
    */
    ...
    // type tva
    print '<tr><td>'.$langs->trans('Typetva').'</td><td colspan="2">';
    print $form->load_type_tva('type_tva', -1, $seller, $buyer);
