...
/**
 *      \file       orgman/cpartida_script.php
 *		\ingroup    orgman
...
// Examples for manipulating class cpartida_class
require_once(DOL_DOCUMENT_ROOT."/../orgman/cpartida.class.php");
$myobject=new Cpartida($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cpartida";
