...
/**
 *   	\file       priceunits/puproceduredet_card.php
 *		\ingroup    priceunits
...
$hookmanager->initHooks(array('puproceduredet'));
...
if (empty($reshook))
{
	...
	$object->fk_pu_procedure=GETPOST('fk_pu_procedure','int');
	$object->sequen=GETPOST('sequen','int');
	$object->ref_procedure=GETPOST('ref_procedure','alpha');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_pu_procedure").'</td><td><input class="flat" type="text" name="fk_pu_procedure" value="'.GETPOST('fk_pu_procedure').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_procedure").'</td><td><input class="flat" type="text" name="ref_procedure" value="'.GETPOST('ref_procedure').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_pu_procedure").'</td><td><input class="flat" type="text" name="fk_pu_procedure" value="'.$object->fk_pu_procedure.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_procedure").'</td><td><input class="flat" type="text" name="ref_procedure" value="'.$object->ref_procedure.'"></td></tr>';
...
if ($id && (empty($action) || $action == 'view' || $action == 'delete'))
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_pu_procedure").'</td><td>$object->fk_pu_procedure</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldsequen").'</td><td>$object->sequen</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_procedure").'</td><td>$object->ref_procedure</td></tr>';
