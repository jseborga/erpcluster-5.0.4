...
$search_status='';
    ...
    $permtoread = $user->rights->ctypetvadet->read;
    $permtodelete = $user->rights->ctypetvadet->delete;
    $uploaddir = $conf->ctypetvadet->dir_output;
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/ctypetvadet/card.php?id='.$id);
    exit;
}
