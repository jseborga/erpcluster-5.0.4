...
/**
 * \file    budget/puvariables.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Puvariables extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'puvariables';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'pu_variables';

	/**
	 * @var PuvariablesLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("puvariables", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new PuvariablesLine($this->db);
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Puvariables($this->db);
...
/**
 * Class PuvariablesLine
 */
class PuvariablesLine extends CommonObjectLine
{
	/**
	 * @var int ID
	 */
