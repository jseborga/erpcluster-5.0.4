 ...
 *				Initialy built by build_class_from_table on 2014-08-18 13:23
 */
...
class Poaworkflowdet extends CommonObject
{
	...
	var $element='poa_workflow_det';			//!< Id that identify managed objects
	var $table_element='poa_workflow_det';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
		...
		$sql.= " ".(! isset($this->code_procedure)?'NULL':"'".$this->code_procedure."'").",";
    ...
    function update($user=0, $notrigger=0)
    {
		...
		$sql.= " code_procedure=".(isset($this->code_procedure)?$this->code_procedure:"null").",";
     ...
     *  @return int          	<0 if KO, >0 if OK
     */
	function getlist($fk_poa_workflow,$last=0)
    {
      global $langs;
      $sql = "SELECT";
      $sql.= " t.rowid,";
