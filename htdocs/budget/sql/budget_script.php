...
// Examples for manipulating class budget_class
require_once(DOL_DOCUMENT_ROOT."/../budget/budget.class.php");
$myobject=new Budget($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budget";
