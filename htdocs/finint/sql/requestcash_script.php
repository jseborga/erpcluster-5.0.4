...
/**
 *      \file       finint/requestcash_script.php
 *		\ingroup    finint
...
// Examples for manipulating class requestcash_class
require_once(DOL_DOCUMENT_ROOT."/../finint/requestcash.class.php");
$myobject=new Requestcash($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."requestcash";
