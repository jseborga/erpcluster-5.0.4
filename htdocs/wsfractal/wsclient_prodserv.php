...
$WS_DOL_URL = DOL_MAIN_URL_ROOT.'/wsfractal/server_productorservice.php';
//$WS_DOL_URL = 'http://localhost:8080/';	// To test with Soapui mock. If not a page, should end with /

$nameservice = GETPOST('nameservice');
$login = GETPOST('login');
$pass = GETPOST('pass');
if ($nameservice == 'getProductOrService') $WS_METHOD2 = 'getProductOrService';
if ($nameservice == 'getListOfProductsOrServices') $WS_METHOD3 = 'getListOfProductsOrServices';
