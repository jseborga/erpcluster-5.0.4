...
/**
 *      \file       monprojet/projetpaiement_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class projetpaiement_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/projetpaiement.class.php");
$myobject=new Projetpaiement($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."projetpaiement";
