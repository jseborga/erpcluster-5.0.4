...
/**
 * \file    orgman/cpartida.class.php
 * \ingroup orgman
 ...
 * @see CommonObject
 */
class Cpartida extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'cpartida';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'c_partida';

	/**
	 * @var CpartidaLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null,$period_year = 0)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("cpartida", 1) . ")";
		}
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Partida") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->code;
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Label') . ':</b> ' . $this->label;

        $url = DOL_URL_ROOT.'/orgman/partida/'.'card.php?id='.$this->id;
