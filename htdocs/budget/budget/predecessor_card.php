...
/**
 *   	\file       budget/budgettaskpredecessor_card.php
 *		\ingroup    budget
...
$hookmanager->initHooks(array('budgettaskpredecessor'));
...
if (empty($reshook))
{
	...
	$object->fk_task_predecessor=GETPOST('fk_task_predecessor','int');
	$object->type_link=GETPOST('type_link','alpha');
	$object->free_time=GETPOST('free_time','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_task_predecessor").'</td><td><input class="flat" type="text" name="fk_task_predecessor" value="'.GETPOST('fk_task_predecessor').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_link").'</td><td><input class="flat" type="text" name="type_link" value="'.GETPOST('type_link').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfree_time").'</td><td><input class="flat" type="text" name="free_time" value="'.GETPOST('free_time').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_task_predecessor").'</td><td><input class="flat" type="text" name="fk_task_predecessor" value="'.$object->fk_task_predecessor.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_link").'</td><td><input class="flat" type="text" name="type_link" value="'.$object->type_link.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfree_time").'</td><td><input class="flat" type="text" name="free_time" value="'.$object->free_time.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_task_predecessor").'</td><td>$object->fk_task_predecessor</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_link").'</td><td>$object->type_link</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfree_time").'</td><td>$object->free_time</td></tr>';
