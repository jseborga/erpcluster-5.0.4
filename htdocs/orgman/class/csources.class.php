...
/**
 * \file    orgman/csources.class.php
 * \ingroup orgman
 ...
 * @see CommonObject
 */
class Csources extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'csources';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'c_sources';

	/**
	 * @var CsourcesLine[] Lines
	 */
	public $lines = array();
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Foundingsource") . '</u>';
        $label.= '<div width="100%">';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->code;

        $link = '<a href="'.DOL_URL_ROOT.'/orgman/sources/list.php?id='.$this->id.'"';
