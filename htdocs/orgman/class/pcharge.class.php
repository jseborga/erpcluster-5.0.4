...
class Pcharge extends CommonObject
{
	 ...
	 */
	public $element = 'pcharge';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'p_charge';

	/**
	 * @var PchargeLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
			$sql .= " AND entity IN (" . getEntity("pcharge", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
