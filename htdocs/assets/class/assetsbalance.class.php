...
/**
 * \file    assets/assetsbalance.class.php
 * \ingroup assets
 ...
 * @see CommonObject
 */
class Assetsbalance extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'assetsbalance';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'assets_balance';

	/**
	 * @var AssetsbalanceLine[] Lines
	 */
	public $lines = array();
	...
	public $date_end = '';
	public $date_ini_day;
	public $date_ini_month;
	public $date_ini_year;
	public $date_mig_day;
	public $date_mig_month;
	public $date_mig_year;
	public $date_mig = '';
	...
	public $doc_reval;
	public $detail;
	public $date_reval_day;
	public $date_reval_month;
	public $date_reval_year;
	public $date_reval = '';
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->date_ini_day)) {
			 $this->date_ini_day = trim($this->date_ini_day);
		}
		if (isset($this->date_ini_month)) {
			 $this->date_ini_month = trim($this->date_ini_month);
		}
		if (isset($this->date_ini_year)) {
			 $this->date_ini_year = trim($this->date_ini_year);
		}
		if (isset($this->date_mig_day)) {
			 $this->date_mig_day = trim($this->date_mig_day);
		}
		if (isset($this->date_mig_month)) {
			 $this->date_mig_month = trim($this->date_mig_month);
		}
		if (isset($this->date_mig_year)) {
			 $this->date_mig_year = trim($this->date_mig_year);
		}
		...
		if (isset($this->coste_mig)) {
			 $this->coste_mig = trim($this->coste_mig);
		}
		...
		if (isset($this->doc_reval)) {
			 $this->doc_reval = trim($this->doc_reval);
		}
		if (isset($this->detail)) {
			 $this->detail = trim($this->detail);
		}
		if (isset($this->date_reval_day)) {
			 $this->date_reval_day = trim($this->date_reval_day);
		}
		if (isset($this->date_reval_month)) {
			 $this->date_reval_month = trim($this->date_reval_month);
		}
		if (isset($this->date_reval_year)) {
			 $this->date_reval_year = trim($this->date_reval_year);
		}
		...
		$sql .= ' '.(! isset($this->date_ini_day)?'NULL':$this->date_ini_day).',';
		$sql .= ' '.(! isset($this->date_ini_month)?'NULL':$this->date_ini_month).',';
		$sql .= ' '.(! isset($this->date_ini_year)?'NULL':$this->date_ini_year).',';
		$sql .= ' '.(! isset($this->date_mig_day)?'NULL':$this->date_mig_day).',';
		$sql .= ' '.(! isset($this->date_mig_month)?'NULL':$this->date_mig_month).',';
		$sql .= ' '.(! isset($this->date_mig_year)?'NULL':$this->date_mig_year).',';
		$sql .= ' '.(! isset($this->date_mig) || dol_strlen($this->date_mig)==0?'NULL':"'".$this->db->idate($this->date_mig)."'").',';
		...
		$sql .= ' '.(! isset($this->coste_mig)?'NULL':"'".$this->coste_mig."'").',';
		...
		$sql .= ' '.(! isset($this->doc_reval)?'NULL':"'".$this->db->escape($this->doc_reval)."'").',';
		$sql .= ' '.(! isset($this->detail)?'NULL':"'".$this->db->escape($this->detail)."'").',';
		$sql .= ' '.(! isset($this->date_reval_day)?'NULL':$this->date_reval_day).',';
		$sql .= ' '.(! isset($this->date_reval_month)?'NULL':$this->date_reval_month).',';
		$sql .= ' '.(! isset($this->date_reval_year)?'NULL':$this->date_reval_year).',';
	...
	public function fetch($id, $ref = null, $fk=0)
	{
		...
		$sql .= " t.date_end,";
		$sql .= " t.date_ini_day,";
		$sql .= " t.date_ini_month,";
		$sql .= " t.date_ini_year,";
		$sql .= " t.date_mig_day,";
		$sql .= " t.date_mig_month,";
		$sql .= " t.date_mig_year,";
		$sql .= " t.date_mig,";
		$sql .= " t.factor_update,";
		$sql .= " t.time_consumed,";
		...
		$sql .= " t.doc_reval,";
		$sql .= " t.detail,";
		$sql .= " t.date_reval_day,";
		$sql .= " t.date_reval_month,";
		$sql .= " t.date_reval_year,";
		$sql .= " t.date_reval,";
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("assetsbalance", 1) . ")";
		}
		if (null !== $ref && $fk>0) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->date_ini_day = $obj->date_ini_day;
				$this->date_ini_month = $obj->date_ini_month;
				$this->date_ini_year = $obj->date_ini_year;
				$this->date_mig_day = $obj->date_mig_day;
				$this->date_mig_month = $obj->date_mig_month;
				$this->date_mig_year = $obj->date_mig_year;
				$this->date_mig = $this->db->jdate($obj->date_mig);
				...
				$this->doc_reval = $obj->doc_reval;
				$this->detail = $obj->detail;
				$this->date_reval_day = $obj->date_reval_day;
				$this->date_reval_month = $obj->date_reval_month;
				$this->date_reval_year = $obj->date_reval_year;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND', $filterstatic='', $lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				...
				$line->date_ini_day = $obj->date_ini_day;
				$line->date_ini_month = $obj->date_ini_month;
				$line->date_ini_year = $obj->date_ini_year;
				$line->date_mig_day = $obj->date_mig_day;
				$line->date_mig_month = $obj->date_mig_month;
				$line->date_mig_year = $obj->date_mig_year;
				$line->date_mig = $this->db->jdate($obj->date_mig);
				...
				$line->doc_reval = $obj->doc_reval;
				$line->detail = $obj->detail;
				$line->date_reval_day = $obj->date_reval_day;
				$line->date_reval_month = $obj->date_reval_month;
				$line->date_reval_year = $obj->date_reval_year;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' date_ini_day = '.(isset($this->date_ini_day)?$this->date_ini_day:"null").',';
		$sql .= ' date_ini_month = '.(isset($this->date_ini_month)?$this->date_ini_month:"null").',';
		$sql .= ' date_ini_year = '.(isset($this->date_ini_year)?$this->date_ini_year:"null").',';
		$sql .= ' date_mig_day = '.(isset($this->date_mig_day)?$this->date_mig_day:"null").',';
		$sql .= ' date_mig_month = '.(isset($this->date_mig_month)?$this->date_mig_month:"null").',';
		$sql .= ' date_mig_year = '.(isset($this->date_mig_year)?$this->date_mig_year:"null").',';
		$sql .= ' date_mig = '.(! isset($this->date_mig) || dol_strlen($this->date_mig) != 0 ? "'".$this->db->idate($this->date_mig)."'" : 'null').',';
		...
		$sql .= ' coste_mig = '.(isset($this->coste_mig)?$this->coste_mig:"null").',';
		...
		$sql .= ' doc_reval = '.(isset($this->doc_reval)?"'".$this->db->escape($this->doc_reval)."'":"null").',';
		$sql .= ' detail = '.(isset($this->detail)?"'".$this->db->escape($this->detail)."'":"null").',';
		$sql .= ' date_reval_day = '.(isset($this->date_reval_day)?$this->date_reval_day:"null").',';
		$sql .= ' date_reval_month = '.(isset($this->date_reval_month)?$this->date_reval_month:"null").',';
		$sql .= ' date_reval_year = '.(isset($this->date_reval_year)?$this->date_reval_year:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Assetsbalance($this->db);
	...
	public function initAsSpecimen()
	{
		...
		$this->detail = '';
		$this->date_reval_day = '';
		$this->date_reval_month = '';
		$this->date_reval_year = '';
		$this->date_reval = '';
		$this->fk_user_create = '';
		$this->fk_user_mod = '';
		$this->datec = '';
