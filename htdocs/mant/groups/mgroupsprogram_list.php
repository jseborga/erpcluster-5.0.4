...
/**
 *   	\file       mant/mgroupsprogram_list.php
 *		\ingroup    mant
...
't.fk_parent_previous'=>array('label'=>$langs->trans("Fieldfk_parent_previous"), 'checked'=>1),
't.fk_type_repair'=>array('label'=>$langs->trans("Fieldfk_type_repair"), 'checked'=>1),
...
$search_fk_group='';
$search_fk_parent_previous='';
$search_fk_type_repair='';
$search_accountant='';
$search_description='';
...
$search_active='';
    ...
    $permtoread = $user->rights->mgroupsprogram->read;
    $permtodelete = $user->rights->mgroupsprogram->delete;
    $uploaddir = $conf->mgroupsprogram->dir_output;
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/mgroupsprogram/card.php?id='.$id);
    exit;
}
