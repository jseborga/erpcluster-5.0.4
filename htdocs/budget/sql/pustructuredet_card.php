...
/**
 *   	\file       budget/pustructuredet_card.php
 *		\ingroup    budget
...
$hookmanager->initHooks(array('pustructuredet'));
...
if (empty($reshook))
{
	...
	$object->ref_structure=GETPOST('ref_structure','alpha');
	...
	$object->status_print=GETPOST('status_print','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_structure").'</td><td><input class="flat" type="text" name="ref_structure" value="'.GETPOST('ref_structure').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_structure").'</td><td><input class="flat" type="text" name="ref_structure" value="'.$object->ref_structure.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_structure").'</td><td>$object->ref_structure</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus_print").'</td><td>$object->status_print</td></tr>';
