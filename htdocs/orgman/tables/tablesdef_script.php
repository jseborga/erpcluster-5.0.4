...
/**
 *      \file       orgman/tablesdef_script.php
 *		\ingroup    orgman
...
// Examples for manipulating class tablesdef_class
require_once(DOL_DOCUMENT_ROOT."/../orgman/tablesdef.class.php");
$myobject=new Tablesdef($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."tablesdef";
