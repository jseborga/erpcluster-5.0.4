...
/**
 * \file    codprueba/cclasfin.class.php
 * \ingroup codprueba
 ...
 * @see CommonObject
 */
class Cclasfin extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'cclasfin';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'c_clasfin';

	/**
	 * @var CclasfinLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
			$sql .= " AND entity IN (" . getEntity("cclasfin", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='',$action='')
	{
		...
		/* cambios Laiwett*/
		$url = DOL_URL_ROOT.'/orgman/institutional/'.'list.php?id='.$this->id.($action?$action:'');
