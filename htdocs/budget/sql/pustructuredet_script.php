...
/**
 *      \file       budget/pustructuredet_script.php
 *		\ingroup    budget
...
// Examples for manipulating class pustructuredet_class
require_once(DOL_DOCUMENT_ROOT."/../budget/pustructuredet.class.php");
$myobject=new Pustructuredet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."pustructuredet";
