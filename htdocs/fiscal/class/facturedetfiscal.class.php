...
/**
 * \file    fiscal/facturedetfiscal.class.php
 * \ingroup fiscal
...
/**
 * Class Facturedetfiscal
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Facturedetfiscal extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'facturedetfiscal';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'facturedet_fiscal';

	/**
	 * @var FacturedetfiscalLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null,$fk=0)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("facturedetfiscal", 1) . ")";
		}
		if (null !== $ref && $fk > 0) {
			$sql .= ' AND t.code_tva = ' . '\'' . $ref . '\'';
			$sql .= ' AND t.fk_facturedet = ' . $fk;
		} else {
			$sql .= ' AND t.rowid = ' . $id;
		}
...
echo $sql;
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Facturedetfiscal($this->db);
