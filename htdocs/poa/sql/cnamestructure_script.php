...
/**
 *      \file       poa/cnamestructure_script.php
 *		\ingroup    poa
...
// Examples for manipulating class cnamestructure_class
require_once(DOL_DOCUMENT_ROOT."/../poa/cnamestructure.class.php");
$myobject=new Cnamestructure($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cnamestructure";
