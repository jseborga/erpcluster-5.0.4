...
/**
 *      \file       singlesess/usersession_script.php
 *		\ingroup    singlesess
...
// Examples for manipulating class usersession_class
require_once(DOL_DOCUMENT_ROOT."/../singlesess/usersession.class.php");
$myobject=new Usersession($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."usersession";
