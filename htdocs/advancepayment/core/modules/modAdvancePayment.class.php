...
class modAdvancePayment extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 592000;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->description = "Módulo de anticipos a proveedores y clientes";
		...
		$this->picto='advancepayment@advancepayment';
		...
		$this->config_page_url = array("advance.php@advancepayment");
		...
		$this->tabs = array();
		$this->tabs = array(
			'supplier_order:+advancepayment:Advancepayments:advancepayment@advancepayment:$user->rights->advancepayment->fourn->lire:/advancepayment/fourn/advancefourn.php?id=__ID__',
			'purchase_order:+advancepayment:Advancepayments:advancepayment@advancepayment:$user->rights->advancepayment->fourn->lire:/advancepayment/fourn/advancefourn.php?id=__ID__',);


		if (! isset($conf->advancepayment) || ! isset($conf->advancepayment->enabled))
		{
        ...
        */
		...
		$this->rights[$r][1] = 'Advancepayment';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'lire';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Read advancepayment fourn';
		//$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'fourn';
		$this->rights[$r][5] = 'lire';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Create advancepayment fourn';
		//$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'fourn';
		...
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Modify advancepayment fourn';
		//$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'fourn';
		$this->rights[$r][5] = 'mod';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Delete advancepayment fourn';
		//$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'fourn';
		$this->rights[$r][5] = 'del';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Validate advancepayment fourn';
		//$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'fourn';
		$this->rights[$r][5] = 'val';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Create pdf advancepayment fourn';
		//$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'fourn';
		$this->rights[$r][5] = 'creerdoc';
		$r++;
		$this->rights[$r][0] = $this->numero + $r;
		$this->rights[$r][1] = 'Delete pdf advancepayment fourn';
		//$this->rights[$r][2] = 'a';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'fourn';
		...
		$this->menu[$r]=array(	'fk_menu'=>'',			        
			'type'=>'top',			        
			'titre'=>'Advancepayments',
			'mainmenu'=>'advancepayment',
			'leftmenu'=>'advancepayment',
			'url'=>'/advancepayment/index.php',
			'langs'=>'advancepayment@advancepayment',	    
			'position'=>100,
			'enabled'=>'$conf->advancepayment->enabled',	
			'perms'=>'$user->rights->advancepayment->lire',	
			'target'=>'',
			'user'=>0);
		$r++;
		$this->menu[$r]=array(	'fk_menu'=>'r=0',	
			...
			'mainmenu'=>'advancepayment',
			'leftmenu'=>'fourn',
			'url'=>'/advancepayment/fourn/list.php',
			'langs'=>'advancepayment@advancepayment',	
			'position'=>100,
			'enabled'=>'$conf->advancepayment->enabled',
			'perms'=>'$user->rights->advancepayment->fourn->lire',
			'target'=>'',
			'user'=>0);		

		$r++;
		$this->menu[$r]=array('fk_menu'=>'fk_mainmenu=advancepayment,fk_leftmenu=fourn',	
			'type'=>'left',		
			'titre'=>'Newadvancefourn',
			'mainmenu'=>'advancepayment',
			'leftmenu'=>'fourn',
			'url'=>'/advancepayment/fourn/card.php?action=create',
			'langs'=>'advancepayment@advancepayment',	
			'position'=>100,
			'enabled'=>'$conf->advancepayment->enabled',
			'perms'=>'$user->rights->advancepayment->fourn->creer',
			'target'=>'',
			'user'=>0);		
	*/
	...
	public function init($options='')
	{
		...
		$this->_load_tables('/advancepayment/sql/');
