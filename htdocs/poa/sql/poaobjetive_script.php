...
/**
 *      \file       poa/poaobjetive_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poaobjetive_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poaobjetive.class.php");
$myobject=new Poaobjetive($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poaobjetive";
