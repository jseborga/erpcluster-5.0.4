...
<?php if ($object->type_element == 'facture_fourn') { ?>
...
<tr <?php echo $bcnd[$var]; ?>>
	...
	<?php if (!$conf->global->PRICE_TAXES_INCLUDED) { ?>
	<td align="right">
		<input type="number" min="0.00001" step="any" size="5" name="price_ht" id="<?php echo ($conf->global->PRICE_TAXES_INCLUDED?'price_htx':'price_ht'); ?>" class="flat len80" value="<?php echo (isset($_POST["price_ht"])?$_POST["price_ht"]:''); ?>" required >
	</td>
	<?php } else { ?>

	<td align="right">
		<input type="number" min="0.00001" step="any" size="5" name="price_ttc" id="<?php echo ($conf->global->PRICE_TAXES_INCLUDED?'price_ttcx':'price_ttc'); ?>" class="flat len80" value="<?php echo (isset($_POST["price_ttc"])?$_POST["price_ttc"]:''); ?>" required >
	</td>
	<?php }?>
	<td>
