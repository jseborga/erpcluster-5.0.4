...
/**
 * \file    sales/expeditiondetadd.class.php
 * \ingroup sales
...
/**
 * Class Expeditiondetadd
 *
 * Put here description of your class
 * @see CommonObject
 */
class Expeditiondetadd extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'expeditiondetadd';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'expeditiondet_add';

	/**
	 * @var ExpeditiondetaddLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		$sql .= ' '.(! isset($this->fk_expeditiondet)?'NULL':$this->fk_expeditiondet).',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Expeditiondetadd($this->db);
