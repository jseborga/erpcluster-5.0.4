...
/**
 *   	\file       purchase/facturefourndetfiscal_list.php
 *		\ingroup    purchase
...
$search_status='';
    ...
    $permtoread = $user->rights->facturefourndetfiscal->read;
    $permtodelete = $user->rights->facturefourndetfiscal->delete;
    $uploaddir = $conf->facturefourndetfiscal->dir_output;
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."facture_fourn_det_fiscal_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/facturefourndetfiscal/card.php?id='.$id);
    exit;
}
