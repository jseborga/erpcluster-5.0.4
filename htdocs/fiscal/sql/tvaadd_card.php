...
$hookmanager->initHooks(array('tvaadd'));
...
if (empty($reshook))
{
	...
	$object->fk_type_tva=GETPOST('fk_type_tva','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_type_tva").'</td><td><input class="flat" type="text" name="fk_type_tva" value="'.GETPOST('fk_type_tva').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_type_tva").'</td><td><input class="flat" type="text" name="fk_type_tva" value="'.$object->fk_type_tva.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_type_tva").'</td><td>$object->fk_type_tva</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('tvaadd'));
