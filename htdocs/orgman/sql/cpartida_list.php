...
$search_active='';
    ...
    $permtoread = $user->rights->cpartida->read;
    $permtodelete = $user->rights->cpartida->delete;
    $uploaddir = $conf->cpartida->dir_output;
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
    ...
    $id = $obj->rowid;
    header("Location: ".DOL_URL_ROOT.'/cpartida/card.php?id='.$id);
    exit;
}
