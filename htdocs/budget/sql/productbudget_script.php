...
/**
 *      \file       budget/productbudget_script.php
 *		\ingroup    budget
 *      \brief      This file is an example for a command line script
 *					Initialy built by build_class_from_table on 2016-11-07 11:56
 */
...
// Examples for manipulating class productbudget_class
require_once(DOL_DOCUMENT_ROOT."/../budget/productbudget.class.php");
$myobject=new Productbudget($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."productbudget";
