...
/**
 *      \file       priceunits/budgettask_script.php
 *		\ingroup    priceunits
...
// Examples for manipulating class budgettask_class
require_once(DOL_DOCUMENT_ROOT."/../priceunits/budgettask.class.php");
$myobject=new Budgettask($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."budgettask";
