...
/**
 * \file    contab/contabtransaction.class.php
 * \ingroup contab
...
/**
 * Class Contabtransaction
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Contabtransaction extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'contabtransaction';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'contab_transaction';

	/**
	 * @var ContabtransactionLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		$sql .= ' '.(! isset($this->bits)?'NULL':"'".$this->db->escape($this->bits)."'").',';
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ContabtransactionLine();
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' bits = '.(isset($this->bits)?"'".$this->db->escape($this->bits)."'":"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Contabtransaction($this->db);
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $maxlen=24, $morecss='')
	{
        ...
        $label = '<u>' . $langs->trans("Contabtransaction") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = DOL_URL_ROOT.'/contab/transaction/'.'card.php?id='.$this->id;
