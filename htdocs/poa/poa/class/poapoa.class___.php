 ...
 *				Initialy built by build_class_from_table on 2014-04-02 13:59
 */
...
class Poapoa extends CommonObject
{
     ...
     */
    function select_poa($selected='',$htmlname='fk_poa',$htmloption='',$maxlength=0,$showempty=0,$fk_structure='')
    {
        global $conf,$langs;
        ...
        $sql = "SELECT c.rowid, c.label as label, ";
