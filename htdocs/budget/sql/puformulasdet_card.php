...
/**
 *   	\file       priceunits/puformulasdet_card.php
 *		\ingroup    priceunits
...
$hookmanager->initHooks(array('puformulasdet'));
...
if (empty($reshook))
{
	...
	$object->ref_formula=GETPOST('ref_formula','alpha');
	$object->fk_operator=GETPOST('fk_operator','int');
	$object->type=GETPOST('type','alpha');
	$object->changefull=GETPOST('changefull','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_formula").'</td><td><input class="flat" type="text" name="ref_formula" value="'.GETPOST('ref_formula').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_operator").'</td><td><input class="flat" type="text" name="fk_operator" value="'.GETPOST('fk_operator').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldchangefull").'</td><td><input class="flat" type="text" name="changefull" value="'.GETPOST('changefull').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_formula").'</td><td><input class="flat" type="text" name="ref_formula" value="'.$object->ref_formula.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldchangefull").'</td><td><input class="flat" type="text" name="changefull" value="'.$object->changefull.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_formula").'</td><td>$object->ref_formula</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_operator").'</td><td>$object->fk_operator</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype").'</td><td>$object->type</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldchangefull").'</td><td>$object->changefull</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	if (empty($reshook))
	{
		if ($user->rights->priceunits->write)
		{
			print '<div class="inline-block divButAction"><a class="butAction" href="'.$_SERVER["PHP_SELF"].'?id='.$object->id.'&amp;action=edit">'.$langs->trans("Modify").'</a></div>'."\n";
		}

		if ($user->rights->priceunits->delete)
		{
