...
/**
 * \file    assistance/membervacation.class.php
 * \ingroup assistance
 ...
 * @see CommonObject
 */
class Membervacation extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'membervacation';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'member_vacation';

	/**
	 * @var MembervacationLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->days_used)) {
			 $this->days_used = trim($this->days_used);
		}
		...
		$sql .= ' '.(! isset($this->days_used)?'NULL':$this->days_used).',';
	 ...
	 */
	public function fetch($id, $fk=0, $year=0)
	{
		dol_syslog(__METHOD__, LOG_DEBUG);
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND', $filterstatic='', $lView=false)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("membervacation", 1) . ")";
		}
		if (count($sqlwhere) > 0) {
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' days_used = '.(isset($this->days_used)?$this->days_used:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Membervacation($this->db);
