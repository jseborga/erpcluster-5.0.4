...
/**
 * \file    contab/contabspendingaccount.class.php
 * \ingroup contab
...
class Contabspendingaccount extends CommonObject
{
	 ...
	 */
	public $element = 'contabspendingaccount';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'contab_spending_account';

	/**
	 * @var ContabspendingaccountLine[] Lines
	 */
	public $lines = array();
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ContabspendingaccountLine();
...
/**
 * Class ContabspendingaccountLine
 */
class ContabspendingaccountLine
{
	/**
