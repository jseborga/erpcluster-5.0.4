...
/**
 *   	\file       purchase/commandefournisseuradd_card.php
 *		\ingroup    purchase
...
$hookmanager->initHooks(array('commandefournisseuradd'));
...
if (empty($reshook))
{
	...
	$object->fk_commande_fournisseur=GETPOST('fk_commande_fournisseur','int');
	$object->object=GETPOST('object','alpha');
	$object->fk_object=GETPOST('fk_object','int');
	$object->fk_departament=GETPOST('fk_departament','int');
	$object->ref_contrat=GETPOST('ref_contrat','alpha');
	$object->term=GETPOST('term','int');
	$object->ref_term=GETPOST('ref_term','int');
	$object->type=GETPOST('type','alpha');
	$object->advance=GETPOST('advance','int');
	$object->order_proceed=GETPOST('order_proceed','int');
	$object->designation_fiscal=GETPOST('designation_fiscal','int');
	$object->designation_supervisor=GETPOST('designation_supervisor','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_commande_fournisseur").'</td><td><input class="flat" type="text" name="fk_commande_fournisseur" value="'.GETPOST('fk_commande_fournisseur').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_contrat").'</td><td><input class="flat" type="text" name="ref_contrat" value="'.GETPOST('ref_contrat').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldterm").'</td><td><input class="flat" type="text" name="term" value="'.GETPOST('term').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_term").'</td><td><input class="flat" type="text" name="ref_term" value="'.GETPOST('ref_term').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldadvance").'</td><td><input class="flat" type="text" name="advance" value="'.GETPOST('advance').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldorder_proceed").'</td><td><input class="flat" type="text" name="order_proceed" value="'.GETPOST('order_proceed').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddesignation_fiscal").'</td><td><input class="flat" type="text" name="designation_fiscal" value="'.GETPOST('designation_fiscal').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddesignation_supervisor").'</td><td><input class="flat" type="text" name="designation_supervisor" value="'.GETPOST('designation_supervisor').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_commande_fournisseur").'</td><td><input class="flat" type="text" name="fk_commande_fournisseur" value="'.$object->fk_commande_fournisseur.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_contrat").'</td><td><input class="flat" type="text" name="ref_contrat" value="'.$object->ref_contrat.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldterm").'</td><td><input class="flat" type="text" name="term" value="'.$object->term.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_term").'</td><td><input class="flat" type="text" name="ref_term" value="'.$object->ref_term.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype").'</td><td><input class="flat" type="text" name="type" value="'.$object->type.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldadvance").'</td><td><input class="flat" type="text" name="advance" value="'.$object->advance.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldorder_proceed").'</td><td><input class="flat" type="text" name="order_proceed" value="'.$object->order_proceed.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddesignation_fiscal").'</td><td><input class="flat" type="text" name="designation_fiscal" value="'.$object->designation_fiscal.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddesignation_supervisor").'</td><td><input class="flat" type="text" name="designation_supervisor" value="'.$object->designation_supervisor.'"></td></tr>';
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_commande_fournisseur").'</td><td>$object->fk_commande_fournisseur</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_contrat").'</td><td>$object->ref_contrat</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldterm").'</td><td>$object->term</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldref_term").'</td><td>$object->ref_term</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype").'</td><td>$object->type</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldadvance").'</td><td>$object->advance</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldorder_proceed").'</td><td>$object->order_proceed</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddesignation_fiscal").'</td><td>$object->designation_fiscal</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fielddesignation_supervisor").'</td><td>$object->designation_supervisor</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('commandefournisseuradd'));
