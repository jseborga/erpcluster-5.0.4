...
/**
 * \file    contab/accountingaccountadd.class.php
 * \ingroup contab
...
/**
 * Class Accountingaccountadd
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Accountingaccountadd extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'accountingaccountadd';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'accounting_account_add';

	/**
	 * @var AccountingaccountaddLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		$sql .= ' '.(! isset($this->cta_class)?'NULL':"'".$this->db->escape($this->cta_class)."'").',';
	...
	public function fetch($id, $fk=0)
	{
		...
		$sql.= ' WHERE 1 = 1';
		if ($fk>0) {
			$sql .= ' AND t.fk_accounting_account = '.$fk;
		} else {
			$sql .= ' AND t.rowid = ' . $id;
		}
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND', $filterstatic='', $lView=false)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("accountingaccountadd", 1) . ")";
		}
		if (count($sqlwhere) > 0) {
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new AccountingaccountaddLine();
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' cta_class = '.(isset($this->cta_class)?"'".$this->db->escape($this->cta_class)."'":"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Accountingaccountadd($this->db);
...
/**
 * Class AccountingaccountaddLine
 */
class AccountingaccountaddLine
{
	/**
