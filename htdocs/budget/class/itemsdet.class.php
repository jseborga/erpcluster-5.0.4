...
/**
 * \file    budget/itemsdet.class.php
 * \ingroup budget
 ...
 * @see CommonObject
 */
class Itemsdet extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'itemsdet';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'items_det';

	/**
	 * @var ItemsdetLine[] Lines
	 */
	public $lines = array();
