...
/**
 *      \file       fiscal/ctypetva_script.php
 *		\ingroup    fiscal
...
// Examples for manipulating class ctypetva_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/ctypetva.class.php");
$myobject=new Ctypetva($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."ctypetva";
