...
/**
 *   	\file       budget/typeitem_list.php
 *		\ingroup    budget
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-10-04 13:53
 */
...
$hookmanager->initHooks(array('typeitemlist'));
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."type_item_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
