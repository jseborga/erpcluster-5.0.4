...
/**
 *      \file       contab/cscurrencytype_script.php
 *		\ingroup    contab
...
// Examples for manipulating class cscurrencytype_class
require_once(DOL_DOCUMENT_ROOT."/../contab/cscurrencytype.class.php");
$myobject=new Cscurrencytype($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."cscurrencytype";
