 ...
 */
class pdf_planilla extends ModelePDFSalary
{
	var $db;
	var $name;
	var $description;
  ...
  function __construct($db)
  {
  	...
  	$this->db = $db;
  	$this->name = "planilla";
  	$this->description = $langs->trans('PDFPlanillaDescription');
	...
	if ($this->page_largeur < 346) // To work with US executive format
	{
		$this->posxgas-=20;
		$this->posxing-=20;
		$this->posxfac-=20;
  ...
  function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0,$hookmanager=false,$aList=array())
  {
	...
	// Definition of $dir and $file
  		...
  		else
  		{
  			...
  			$dir = $conf->salary->dir_output . "/planilla";
		...
		$heightforfooter = $this->marge_basse+90 ;	// Height reserved to output the footer (value include bottom margin)
...
$this->error=$langs->trans("ErrorUnknown");
  ...
  function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop=0, $hidebottom=0)
  {
	...
	//$this->printRect($pdf,$this->marge_gauche, $tab_top, $this->page_largeur-$this->marge_gauche-$this->marge_droite, $tab_height, $hidetop, $hidebottom);	// Rect prend une longueur en 3eme param et 4eme param
  	...
  	if($type_page==0)
  	{
  		$this->printRect($pdf,$this->marge_gauche, $tab_top, $this->page_hauteur-$this->marge_gauche-$this->marge_droite, $tab_height-10, $hidetop, $hidebottom);
