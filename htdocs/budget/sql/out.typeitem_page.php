...
/**
 *   	\file       /typeitem_page.php
 *		\ingroup    
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2015-11-25 08:58
 */
...
dol_include_once('//class/typeitem.class.php');
...
$hookmanager->initHooks(array('typeitem'));
...
print_liste_field_titre($langs->trans('fk_user_mod'),$_SERVER['PHP_SELF'],'t.fk_user_mod','',$param,'',$sortfield,$sortorder);
print_liste_field_titre($langs->trans('detail'),$_SERVER['PHP_SELF'],'t.detail','',$param,'',$sortfield,$sortorder);
print_liste_field_titre($langs->trans('gestion'),$_SERVER['PHP_SELF'],'t.gestion','',$param,'',$sortfield,$sortorder);
