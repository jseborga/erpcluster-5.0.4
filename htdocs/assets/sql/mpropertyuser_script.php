...
/**
 *      \file       assets/mpropertyuser_script.php
 *		\ingroup    assets
...
// Examples for manipulating class mpropertyuser_class
require_once(DOL_DOCUMENT_ROOT."/../assets/mpropertyuser.class.php");
$myobject=new Mpropertyuser($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."mpropertyuser";
