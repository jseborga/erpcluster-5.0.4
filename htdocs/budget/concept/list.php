...
/**
 *   	\file       budget/budgetconcept_list.php
 *		\ingroup    budget
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-11-22 14:17
 */
...
$hookmanager->initHooks(array('budgetconceptlist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."budget_concept as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."budget_concept_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
