...
/**
 *      \file       finint/accountuser_script.php
 *		\ingroup    finint
...
// Examples for manipulating class accountuser_class
require_once(DOL_DOCUMENT_ROOT."/../finint/accountuser.class.php");
$myobject=new Accountuser($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."accountuser";
