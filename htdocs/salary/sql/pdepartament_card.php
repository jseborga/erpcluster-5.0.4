...
/**
 *   	\file       salary/pdepartament_card.php
 *		\ingroup    salary
...
$hookmanager->initHooks(array('pdepartament'));
...
if (empty($reshook))
{
	...
	$object->fk_user_resp=GETPOST('fk_user_resp','int');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_resp").'</td><td><input class="flat" type="text" name="fk_user_resp" value="'.GETPOST('fk_user_resp').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_resp").'</td><td><input class="flat" type="text" name="fk_user_resp" value="'.$object->fk_user_resp.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_user_resp").'</td><td>$object->fk_user_resp</td></tr>';
