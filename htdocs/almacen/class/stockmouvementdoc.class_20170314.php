 ...
 *				Initialy built by build_class_from_table on 2016-08-21 16:28
 */
...
class Stockmouvementdoc extends CommonObject
{
	...
	//var $element='stockmouvementdoc';			//!< Id that identify managed objects
	//var $table_element='stockmouvementdoc';	//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->fk_entrepot_from)) $this->fk_entrepot_from=trim($this->fk_entrepot_from);
		if (isset($this->fk_entrepot_to)) $this->fk_entrepot_to=trim($this->fk_entrepot_to);
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."stock_mouvement_doc(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."stock_mouvement_doc");
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."stock_mouvement_doc SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."stock_mouvement_doc";
    		$sql.= " WHERE rowid=".$this->id;
