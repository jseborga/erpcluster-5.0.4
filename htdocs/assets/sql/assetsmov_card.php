...
/**
 *   	\file       assets/assetsmov_card.php
 *		\ingroup    assets
...
dol_include_once('/assets/class/assetsmov.class.php');
...
$hookmanager->initHooks(array('assetsmov'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldstatus").'</td><td>$object->status</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('assetsmov'));
