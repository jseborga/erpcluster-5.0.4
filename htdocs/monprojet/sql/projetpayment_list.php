...
/**
 *   	\file       monprojet/projetpayment_list.php
 *		\ingroup    monprojet
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-02-08 13:19
 */
...
dol_include_once('/monprojet/class/projetpayment.class.php');
...
$hookmanager->initHooks(array('projetpaymentlist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."projet_payment as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."projet_payment_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
