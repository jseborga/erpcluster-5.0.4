...
/**
 *   	\file       budget/budgettaskproductivity_card.php
 *		\ingroup    budget
...
$hookmanager->initHooks(array('budgettaskproductivity'));
...
if (empty($reshook))
{
	...
	$object->fk_budget_task_resource=GETPOST('fk_budget_task_resource','int');
...
if ($action == 'create')
{
	...
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_budget_task_resource").'</td><td><input class="flat" type="text" name="fk_budget_task_resource" value="'.GETPOST('fk_budget_task_resource').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_parameter").'</td><td><input class="flat" type="text" name="code_parameter" value="'.GETPOST('code_parameter').'"></td></tr>';
...
if (($id || $ref) && $action == 'edit')
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_budget_task_resource").'</td><td><input class="flat" type="text" name="fk_budget_task_resource" value="'.$object->fk_budget_task_resource.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_parameter").'</td><td><input class="flat" type="text" name="code_parameter" value="'.$object->code_parameter.'"></td></tr>';
...
if ($id && (empty($action) || $action == 'view' || $action == 'delete'))
{
	...
	// print '<tr><td class="fieldrequired">'.$langs->trans("Label").'</td><td><input class="flat" type="text" size="36" name="label" value="'.$label.'"></td></tr>';
	// 
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_budget_task_resource").'</td><td>$object->fk_budget_task_resource</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldcode_parameter").'</td><td>$object->code_parameter</td></tr>';
