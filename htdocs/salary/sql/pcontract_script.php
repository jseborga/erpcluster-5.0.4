...
/**
 *      \file       salary/pcontract_script.php
 *		\ingroup    salary
...
// Examples for manipulating class pcontract_class
require_once(DOL_DOCUMENT_ROOT."/../salary/pcontract.class.php");
$myobject=new Pcontract($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."pcontract";
