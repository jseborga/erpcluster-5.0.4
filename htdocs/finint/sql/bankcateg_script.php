...
/**
 *      \file       finint/bankcateg_script.php
 *		\ingroup    finint
...
// Examples for manipulating class bankcateg_class
require_once(DOL_DOCUMENT_ROOT."/../finint/bankcateg.class.php");
$myobject=new Bankcateg($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."bankcateg";
