...
/**
 *      \file       purchase/facturedetfiscal_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class facturedetfiscal_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/facturedetfiscal.class.php");
$myobject=new Facturedetfiscal($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."facturedetfiscal";
