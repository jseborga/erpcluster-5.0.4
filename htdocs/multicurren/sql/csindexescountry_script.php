...
/**
 *      \file       multicurren/csindexescountry_script.php
 *		\ingroup    multicurren
...
// Examples for manipulating class csindexescountry_class
require_once(DOL_DOCUMENT_ROOT."/../multicurren/csindexescountry.class.php");
$myobject=new Csindexescountry($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."csindexescountry";
