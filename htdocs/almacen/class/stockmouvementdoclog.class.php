...
/**
 * \file    almacen/stockmouvementdoclog.class.php
 * \ingroup almacen
...
/**
 * Class Stockmouvementdoclog
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Stockmouvementdoclog extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'stockmouvementdoclog';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'stock_mouvement_doc_log';

	/**
	 * @var StockmouvementdoclogLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("stockmouvementdoclog", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND', $filterstatic='', $lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new StockmouvementdoclogLine();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Stockmouvementdoclog($this->db);
...
/**
 * Class StockmouvementdoclogLine
 */
class StockmouvementdoclogLine
{
	/**
