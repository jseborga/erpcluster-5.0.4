 ...
 *				Initialy built by build_class_from_table on 2015-02-06 11:39
 */
...
class Poacontratappoint extends CommonObject
{
    ...
    function create($user, $notrigger=0)
    {
		...
		if (isset($this->date_appoint)) $this->date_appoint=trim($this->date_appoint);
		...
		$sql.= " ".(! isset($this->date_appoint)?'NULL':"'".$this->date_appoint."'").",";
    ...
    function fetch($id)
    {
        ...
        if ($resql)
        {
            if ($this->db->num_rows($resql))
            {
				...
				$this->date_appoint = $obj->date_appoint;
    ...
    function update($user=0, $notrigger=0)
    {
		...
		$sql.= " date_appoint=".(isset($this->date_appoint)?$this->date_appoint:"null").",";
		  ...
		  while ($i < $num)
		    {
		      ...
		      $objnew->date_appoint = $obj->date_appoint;
