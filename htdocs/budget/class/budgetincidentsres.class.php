...
/**
 * \file    budget/budgetincidentsres.class.php
 * \ingroup budget
...
/**
 * Class Budgetincidentsres
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Budgetincidentsres extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'budgetincidentsres';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'budget_incidents_res';

	/**
	 * @var BudgetincidentsresLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("budgetincidentsres", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new BudgetincidentsresLine();
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Budgetincidentsres($this->db);
