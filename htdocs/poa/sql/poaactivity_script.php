...
/**
 *      \file       poa/poaactivity_script.php
 *		\ingroup    poa
...
// Examples for manipulating class poaactivity_class
require_once(DOL_DOCUMENT_ROOT."/../poa/poaactivity.class.php");
$myobject=new Poaactivity($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."poaactivity";
