...
/**
 *      \file       monprojet/productprojet_script.php
 *		\ingroup    monprojet
...
// Examples for manipulating class productprojet_class
require_once(DOL_DOCUMENT_ROOT."/../monprojet/productprojet.class.php");
$myobject=new Productprojet($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."productprojet";
