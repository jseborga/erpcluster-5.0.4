...
/**
 *      \file       purchase/supplierproposaldetadd_script.php
 *		\ingroup    purchase
...
// Examples for manipulating class supplierproposaldetadd_class
require_once(DOL_DOCUMENT_ROOT."/../purchase/supplierproposaldetadd.class.php");
$myobject=new Supplierproposaldetadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."supplierproposaldetadd";
