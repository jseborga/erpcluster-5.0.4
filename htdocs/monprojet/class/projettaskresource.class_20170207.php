...
/**
 * \file    monprojet/projettaskresource.class.php
 * \ingroup monprojet
...
/**
 * Class Projettaskresource
 *
 * Put here description of your class
 * @see CommonObject
 */
class Projettaskresource extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'projettaskresource';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'projet_task_resource';

	/**
	 * @var ProjettaskresourceLine[] Lines
	 */
	public $lines = array();
	...
	public $fk_user_mod;
	public $group_resource;
	public $type_resource;
	public $fk_product;
	public $fk_product_projet;
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_objectdet)) {
			 $this->fk_objectdet = trim($this->fk_objectdet);
		}
		if (isset($this->objectdet)) {
			 $this->objectdet = trim($this->objectdet);
		}
		...
		if (isset($this->group_resource)) {
			 $this->group_resource = trim($this->group_resource);
		}
		if (isset($this->type_resource)) {
			 $this->type_resource = trim($this->type_resource);
		}
		if (isset($this->fk_product)) {
			 $this->fk_product = trim($this->fk_product);
		}
		if (isset($this->fk_product_projet)) {
			 $this->fk_product_projet = trim($this->fk_product_projet);
		}
		...
		$sql .= ' '.(! isset($this->date_resource) || dol_strlen($this->date_resource)==0?'NULL':"'".$this->db->idate($this->date_resource)."'").',';
		$sql .= ' '.(! isset($this->fk_object)?'NULL':$this->fk_object).',';
		$sql .= ' '.(! isset($this->object)?'NULL':"'".$this->db->escape($this->object)."'").',';
		$sql .= ' '.(! isset($this->fk_objectdet)?'NULL':$this->fk_objectdet).',';
		$sql .= ' '.(! isset($this->objectdet)?'NULL':"'".$this->db->escape($this->objectdet)."'").',';
		$sql .= ' '.(! isset($this->fk_user_create)?'NULL':$this->fk_user_create).',';
		$sql .= ' '.$user->id.',';
		$sql .= ' '.(! isset($this->group_resource)?'NULL':"'".$this->db->escape($this->group_resource)."'").',';
		$sql .= ' '.(! isset($this->type_resource)?'NULL':"'".$this->db->escape($this->type_resource)."'").',';
		$sql .= ' '.(! isset($this->fk_product)?'NULL':$this->fk_product).',';
		$sql .= ' '.(! isset($this->fk_product_projet)?'NULL':$this->fk_product_projet).',';
	...
	public function fetch($id, $ref = null)
	{
		...
		if ($resql) {
			...
			if ($numrows) {
				...
				$this->date_resource = $this->db->jdate($obj->date_resource);
				$this->fk_object = $obj->fk_object;
				$this->object = $obj->object;
				$this->fk_objectdet = $obj->fk_objectdet;
				$this->objectdet = $obj->objectdet;
				$this->fk_user_create = $obj->fk_user_create;
				$this->fk_user_mod = $obj->fk_user_mod;
				$this->group_resource = $obj->group_resource;
				$this->type_resource = $obj->type_resource;
				$this->fk_product = $obj->fk_product;
				$this->fk_product_projet = $obj->fk_product_projet;
	...
	public function fetchAll($sortorder='', $sortfield='', $limit=0, $offset=0, array $filter = array(), $filtermode='AND',$filterstatic='',$lView=false)
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				$line = new ProjettaskresourceLine();
				...
				$line->date_resource = $this->db->jdate($obj->date_resource);
				$line->fk_object = $obj->fk_object;
				$line->object = $obj->object;
				$line->fk_objectdet = $obj->fk_objectdet;
				$line->objectdet = $obj->objectdet;
				$line->fk_user_create = $obj->fk_user_create;
				$line->fk_user_mod = $obj->fk_user_mod;
				$line->group_resource = $obj->group_resource;
				$line->type_resource = $obj->type_resource;
				$line->fk_product = $obj->fk_product;
				$line->fk_product_projet = $obj->fk_product_projet;
	...
	public function update(User $user, $notrigger = false)
	{
		...
		$sql .= ' date_resource = '.(! isset($this->date_resource) || dol_strlen($this->date_resource) != 0 ? "'".$this->db->idate($this->date_resource)."'" : 'null').',';
		$sql .= ' fk_object = '.(isset($this->fk_object)?$this->fk_object:"null").',';
		$sql .= ' object = '.(isset($this->object)?"'".$this->db->escape($this->object)."'":"null").',';
		$sql .= ' fk_objectdet = '.(isset($this->fk_objectdet)?$this->fk_objectdet:"null").',';
		$sql .= ' objectdet = '.(isset($this->objectdet)?"'".$this->db->escape($this->objectdet)."'":"null").',';
		$sql .= ' fk_user_create = '.(isset($this->fk_user_create)?$this->fk_user_create:"null").',';
		$sql .= ' fk_user_mod = '.$user->id.',';
		$sql .= ' group_resource = '.(isset($this->group_resource)?"'".$this->db->escape($this->group_resource)."'":"null").',';
		$sql .= ' type_resource = '.(isset($this->type_resource)?"'".$this->db->escape($this->type_resource)."'":"null").',';
		$sql .= ' fk_product = '.(isset($this->fk_product)?$this->fk_product:"null").',';
		$sql .= ' fk_product_projet = '.(isset($this->fk_product_projet)?$this->fk_product_projet:"null").',';
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Projettaskresource($this->db);
