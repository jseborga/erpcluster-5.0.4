...
/**
 *   	\file       purchase/unitconv_card.php
 *		\ingroup    purchase
...
$hookmanager->initHooks(array('unitconv'));
...
if (empty($reshook))
{
	...
	$object->fk_unit_ext=GETPOST('fk_unit_ext','int');
	$object->fk_unit=GETPOST('fk_unit','int');
	$object->fc=GETPOST('fc','alpha');
	$object->type_fc=GETPOST('type_fc','alpha');
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_unit_ext").'</td><td><input class="flat" type="text" name="fk_unit_ext" value="'.GETPOST('fk_unit_ext').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfc").'</td><td><input class="flat" type="text" name="fc" value="'.GETPOST('fc').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_fc").'</td><td><input class="flat" type="text" name="type_fc" value="'.GETPOST('type_fc').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_unit_ext").'</td><td><input class="flat" type="text" name="fk_unit_ext" value="'.$object->fk_unit_ext.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfc").'</td><td><input class="flat" type="text" name="fc" value="'.$object->fc.'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_fc").'</td><td><input class="flat" type="text" name="type_fc" value="'.$object->type_fc.'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_unit_ext").'</td><td>$object->fk_unit_ext</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_unit").'</td><td>$object->fk_unit</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfc").'</td><td>$object->fc</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldtype_fc").'</td><td>$object->type_fc</td></tr>';
