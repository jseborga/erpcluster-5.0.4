...
/**
 * \file    mant/mworkrequestuser.class.php
 * \ingroup mant
...
/**
 * Class Mworkrequestuser
 *
 * Put here description of your class
 *
 * @see CommonObject
 */
class Mworkrequestuser extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'mworkrequestuser';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'm_work_request_user';

	/**
	 * @var MworkrequestuserLine[] Lines
	 */
	public $lines = array();
	...
	public function fetch($id, $ref = null)
	{
		...
		if (! empty($conf->multicompany->enabled)) {
		    $sql .= " AND entity IN (" . getEntity("mworkrequestuser", 1) . ")";
		}
		if (null !== $ref) {
			$sql .= ' AND t.ref = ' . '\'' . $ref . '\'';
		} else {
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Mworkrequestuser($this->db);
