...
/**
 *  \file       dev/skeletons/poaprevseg.class.php
 *  \ingroup    mymodule othermodule1 othermodule2
 *  \brief      This file is an example for a CRUD class file (Create/Read/Update/Delete)
 *				Initialy built by build_class_from_table on 2015-06-01 10:27
 */
 ...
 */
class Poaprevseg extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='poa_prev_seg';			//!< Id that identify managed objects
	var $table_element='poa_prev_seg';		//!< Name of table without prefix where object is stored
    ...
    function create($user, $notrigger=0)
    {
        ...
        // Insert request
		$sql = "INSERT INTO ".MAIN_DB_PREFIX."poa_prev_seg(";
		...
		if (! $error)
        {
            $this->id = $this->db->last_insert_id(MAIN_DB_PREFIX."poa_prev_seg");
    ...
    function fetch($id,$fk_prev=0)
    {
        ...
        $sql.= " FROM ".MAIN_DB_PREFIX."poa_prev_seg as t";
	if ($fk_prev)
    ...
    function update($user=0, $notrigger=0)
    {
        ...
        // Update request
        $sql = "UPDATE ".MAIN_DB_PREFIX."poa_prev_seg SET";
	...
	function delete($user, $notrigger=0)
	{
		...
		if (! $error)
		{
    		$sql = "DELETE FROM ".MAIN_DB_PREFIX."poa_prev_seg";
    		$sql.= " WHERE rowid=".$this->id;
