...
/**
 *   	\file       assets/mpropertyuser_list.php
 *		\ingroup    assets
...
dol_include_once('/assets/class/mpropertyuser.class.php');
...
$hookmanager->initHooks(array('mpropertyuserlist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."m_property_user as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."m_property_user_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_fk_property != '') $params.= '&amp;search_fk_property='.urlencode($search_fk_property);
