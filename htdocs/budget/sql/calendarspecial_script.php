...
/**
 *      \file       budget/calendarspecial_script.php
 *		\ingroup    budget
...
// Examples for manipulating class calendarspecial_class
require_once(DOL_DOCUMENT_ROOT."/../budget/calendarspecial.class.php");
$myobject=new Calendarspecial($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."calendarspecial";
