...
/**
 *   	\file       priceunits/puformulas_list.php
 *		\ingroup    priceunits
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2016-10-05 14:20
 */
...
dol_include_once('/priceunits/class/puformulas.class.php');
...
$hookmanager->initHooks(array('puformulaslist'));
...
$sql.= " FROM ".MAIN_DB_PREFIX."pu_formulas as t";
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."pu_formulas_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
