 ...
 *					Initialy built by build_class_from_table on 2017-05-05 15:12
 */
...
$hookmanager->initHooks(array('ctypetva'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldactive").'</td><td>$object->active</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('ctypetva'));
