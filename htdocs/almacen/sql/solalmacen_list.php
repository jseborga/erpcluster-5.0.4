...
/**
 *   	\file       almacen/solalmacen_list.php
 *		\ingroup    almacen
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2017-03-13 12:28
 */
...
dol_include_once('/almacen/class/solalmacen.class.php');
...
$hookmanager->initHooks(array('solalmacenlist'));
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."sol_almacen_extrafields as ef on (u.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_fk_fabrication != '') $params.= '&amp;search_fk_fabrication='.urlencode($search_fk_fabrication);
