...
// Examples for manipulating class tvaadd_class
require_once(DOL_DOCUMENT_ROOT."/../fiscal/tvaadd.class.php");
$myobject=new Tvaadd($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."tvaadd";
